...
4. Ausführliche Terminologie, Zeichensetzung und Verfahrensregeln finden Sie unter [reference.md](reference.md)
...
Vollständige Satzzeichen und Terminologieregeln finden Sie unter [reference.md](reference.md).
