...
1. Klicken und ziehen Sie ein Berichts-Widget an eine neue Position auf der Seite.
   ...
   ![Widget „Bericht verschieben“](assets/moving-report-widget.png)

1. (Optional) Um die Länge und Breite eines Berichts-Widgets anzupassen, klicken Sie auf das Symbol **Resize** ![Resize icon](assets/resize-icon.png) in der rechten unteren Ecke des Widgets und halten Sie es gedrückt. Passen Sie dann die Größe nach Bedarf an.
