...
title: Verwenden von Arbeitsflächen-Dashboards
description: Verwenden von Arbeitsflächen-Dashboards
author: Courtney
...
1. Klicken Sie auf den Namen eines vorhandenen Dashboards, um es zu öffnen.
   ![Öffnen eines Dashboards](assets/open-dashboard.png)
1. Suchen Sie den Tabellenbericht, den Sie anpassen möchten.
1. Wählen Sie eine der folgenden Optionen, um den Bericht anzupassen:
