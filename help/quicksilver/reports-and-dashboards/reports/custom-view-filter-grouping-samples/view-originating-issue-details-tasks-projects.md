...
Weitere Informationen finden Sie auch unter [Anzeigen: Informationen zu ursprünglichen Problemen in Aufgaben- und Projektlisten anzeigen](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md).
