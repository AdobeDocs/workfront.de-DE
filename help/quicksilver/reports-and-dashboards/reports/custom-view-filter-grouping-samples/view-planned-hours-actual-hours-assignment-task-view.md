...
description: In dieser Aufgabenansicht werden die Gesamtanzahl der geplanten Stunden einer Aufgabe, die Anzahl der für jeden Bevollmächtigten zugewiesenen Stunden, die Gesamtzahl der tatsächlichen Stunden und die Anzahl der tatsächlichen Stunden, die von jedem Bevollmächtigten protokolliert wurden, angezeigt.
...
In dieser Aufgabenansicht werden die Gesamtanzahl der geplanten Stunden einer Aufgabe, die Anzahl der für jeden Bevollmächtigten zugewiesenen Stunden, die Gesamtzahl der tatsächlichen Stunden und die Anzahl der tatsächlichen Stunden, die von jedem Bevollmächtigten protokolliert wurden, angezeigt.

![multi_assignment_budget_vs_current_for_tasks.png](assets/multi-assignment-budget-vs-actual-for-tasks-350x66.png)
