...
1. Entfernen Sie den Text im Feld **Textmodus bearbeiten** und ersetzen Sie ihn durch den folgenden Code:
   ...
   In diesem Beispiel zeigen die Zeilen „Column.1.“ den Wert im Feld „Custom URL“ als Link zum Abschnitt „Übersicht **der Aufgabe an;**.2.“ zeigt den Wert an, der im **URL-Feld** der Aufgabe gespeichert ist.
