...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Berechtigungen für eine vorhandene Ansicht verwalten</p> <p>Berechtigung zum Hinzufügen von Spalten zu einem Bericht verwalten</p> <p>Informationen zum Anfordern von zusätzlichem Zugriff finden Sie unter <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Zugriff auf Objekte anfordern </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Im **In dieser Spalte anzeigen** eingeben, beginnen Sie mit der Eingabe eines der folgenden Feldnamen und wählen Sie es aus, wenn es in der Liste angezeigt wird:
   ...
   * *Symbole anzeigen * (nur in Dokumentansichten).
   ...
   Eine Vorlagenansicht enthält beide **Statussymbole** und **Flags** -Felder. In diesem Fall enthalten die beiden Spalten identische Symbole.\
   Dokumentansichten enthalten eine **Symbole anzeigen** -Feld.

1. Klicken **Ansicht speichern**.
1. (Optional) Geben Sie einen neuen Namen für Ihre Ansicht an und klicken Sie auf **Ansicht speichern**.\
   Dadurch wird die **Statussymbole** in Ihre Ansicht.
...
1. (Optional) Klicken Sie auf ein Symbol, um zum Bereich des Objekts zu gelangen, das durch das Symbol dargestellt wird.\
   ...
   Eine vollständige Liste der Attribute für jedes Symbol finden Sie in der [Übersicht über Statussymbole und -flags](#overview-of-status-icons-and-flags) Abschnitt.
...
<table style="table-layout:auto"> 
 ...
 <thead> 
  <tr> 
   <th><strong>Statussymbol oder -kennzeichnung</strong> </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Gibt an, dass offene Probleme im Projekt oder in der Aufgabe vorliegen.</td> 
  ...
  <tr> 
   ...
   <td> <p>Gibt an, dass der Fortschrittsstatus einer Aufgabe einer der folgenden ist:</p> 
    ...
    </ul> <p>Informationen zum Fortschrittsstatus von Aufgaben finden Sie unter <a href="../../../manage-work/tasks/task-information/task-progress-status.md" class="MCXref xref">Übersicht über den Task Progress Status</a>.</p> </td> 
   <td>Aufgaben</td> 
  ...
  <tr> 
   ...
   <td>Gibt an, dass sich die Aufgabe derzeit auf dem kritischen Pfad befindet. <br>Informationen zu Aufgaben auf einem kritischen Pfad des Projekts finden Sie unter <a href="../../../manage-work/tasks/manage-tasks/critical-path.md" class="MCXref xref">Überblick über das Projekt - Kritischer Pfad</a>.</td> 
   <td>Aufgaben</td> 
   <td>Klicken Sie auf , um die Aufgabe zu öffnen.</td> 
   <td> </td> 
  </tr> 
  ...
  <tr> 
   ...
   <td>Gibt an, dass eine Ausgabe in Rechnung gestellt werden kann.<br>Informationen zu Ausgaben finden Sie unter <a href="../../../manage-work/projects/project-finances/manage-project-expenses.md" class="MCXref xref">Verwalten von Projektausgaben </a>.</td> 
   <td>Ausgaben</td> 
   <td>Nicht verfügbar</td> 
   <td> </td> 
  </tr> 
  <tr> 
   ...
   <td> Gibt an, dass eine Ausgabe rückzahlbar ist.<br>Informationen zu Ausgaben finden Sie unter <a href="../../../manage-work/projects/project-finances/manage-project-expenses.md" class="MCXref xref">Verwalten von Projektausgaben </a>.</td> 
   <td>Ausgaben</td> 
   <td>Nicht verfügbar</td> 
   <td> </td> 
  </tr> 
  <tr> 
   ...
   <td> Gibt an, dass eine Erstattung erfolgt ist.<br>Informationen zu Ausgaben finden Sie unter <a href="../../../manage-work/projects/project-finances/manage-project-expenses.md" class="MCXref xref">Verwalten von Projektausgaben </a>.</td> 
   <td>Ausgaben</td> 
   <td>Nicht verfügbar</td> 
   <td> </td> 
  </tr> 
