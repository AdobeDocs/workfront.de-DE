...
title: Überblick über Integrationen von Adobe Experience Manager Assets
description: Durch die Integration zwischen Workfront und Experience Manager Assets oder Assets Essentials können Organisationen Content Velocity und Time-to-Market beschleunigen, indem sie die Arbeitsabläufe und die Verwaltung digitaler Assets eng miteinander verknüpfen.
author: Courtney
...
# Überblick über Integrationen von Adobe Experience Manager Assets
...
* Verwenden Sie die Content Advisor-Funktion von Experience Manager Assets. Mit Content Advisor können Sie
   * Hochladen von Inhalten zur Suche nach ähnlichen Assets
   * Anzeigen von Schnelldetails zu einem Asset
   * Zugriff auf Inhaltsfragmente
   * Erkunden von Sammlungen
   * Und mehr. Weitere Informationen finden Sie in der Dokumentation zu [Experience Manager Assets Content Advisor].
...
1. [Konfigurieren der Asset-Metadatenzuordnung zwischen Adobe Workfront und Experience Manager Assets](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/assets/integrations/configure-asset-metadata-mapping).
