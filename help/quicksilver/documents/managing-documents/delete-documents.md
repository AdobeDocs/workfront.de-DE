...
description: Sie können hochgeladene Dokumente löschen. Wenn Sie Zugriff auf bestimmte Dokumente erhalten, können Sie diese ebenfalls löschen.
author: Courtney
...
Sie können hochgeladene Dokumente löschen. Wenn Sie Zugriff auf bestimmte Dokumente erhalten, können Sie diese ebenfalls löschen.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Zugriff auf Dokumente bearbeiten Die Berechtigung Löschen wurde aktiviert</p> <p>Hinweis: Wenn Sie immer noch keinen Zugriff haben, fragen Sie Ihren Workfront-Administrator, ob er zusätzliche Zugriffsbeschränkungen für Ihre Zugriffsebene festlegt. Informationen dazu, wie ein Workfront-Administrator Ihre Zugriffsebene ändern kann, finden Sie unter <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Benutzerdefinierte Zugriffsebenen erstellen oder ändern</a>.</p> </td> 
  </tr> 
  <tr> 
