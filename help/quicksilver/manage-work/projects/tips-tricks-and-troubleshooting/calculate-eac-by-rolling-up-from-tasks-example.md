...
## EAC-Methode: Aggregieren von Aufgaben oder Unteraufgaben
...
1. **CPI für Projekt** = .13, berechnet wie folgt:\
   **CPI für Projekt** = *IF* Tatsächliche Stunden > 0 *DANN*
...
1. **CPI für Aufgabe 2** = .1, berechnet wie folgt:\
   **CPI für Aufgabe 2** = *IF* Tatsächliche Stunden > 0 *DANN*
...
1. **CPI für Aufgabe 3** = 0,38\
   **CPI für Aufgabe 3** = *IF* Tatsächliche Stunden > 0 *DANN*
...
1. **CPI für Aufgabe 1** = .25, berechnet wie folgt:\
   **CPI für Aufgabe 1** = *IF* Tatsächliche Stunden > 0 *DANN*
...
1. **EAC***für Aufgabe 1** = 13.400,00 USD\
   **CPI-Arbeit*** für Aufgabe 1** = WENN tatsächliche Arbeitskosten &lt;> 0 DANN
   ...
   **CPI-Arbeit***für Aufgabe 1** = .04

   **EAC Labour*** für Aufgabe 1** = *IF* CPI_Labour &lt;> 0 *THEN*
   ...
   **EAC Labour***für Aufgabe 1** = 500.00/.04\
