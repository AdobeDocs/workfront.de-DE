...
Weitere Informationen zu den oben genannten Voraussetzungen finden Sie unter [Konfigurieren Sie die [!DNL Workfront] und [!DNL Frame.io] Integration](/help/quicksilver/administration-and-setup/configure-integrations/configure-wf-and-frame.md).
...
1. Geben Sie einen Namen für Ihre Vorlage ein und drücken Sie dann die Eingabetaste **Eingabe** , um den Namen zu speichern.
1. Klicken Sie im linken Bereich auf **Vorlagendetails**.
1. Im **Vorlagenzuordnung** -Abschnitt, stellen Sie sicher, dass Sie eine Gruppe angeben. Wenn Sie keine Gruppe hinzufügen, wird die standardmäßige Projektgruppe hinzugefügt und das Projekt in Frame.io wird unter dem entsprechenden Standardteam in Frame.io erstellt.
...
1. Klicks **Beginnen mit dem Hinzufügen von Vorlagenaufgaben** , um Ihrer Vorlage schnell Aufgaben hinzuzufügen. Sie können später weitere Einstellungen konfigurieren.

   Oder

   Klicks **Neue Vorlagenaufgabe** , um jeweils eine Aufgabe hinzuzufügen und zusätzliche Einstellungen zu konfigurieren.
   ![](assets/add-tasks-to-template.png)
1. Fügen Sie einen Aufgabennamen hinzu.
1. Im **Zuweisungen** -Bereich, Benutzer oder Teams zuweisen. Wenn Sie einen Frame.io-fähigen Benutzer entweder einzeln oder in einem Team zuweisen, erhalten diese Mitarbeiter Zugriff auf das Frame.io-Projekt und werden per E-Mail über die Aufgabe im Frame.io-Projekt benachrichtigt. Von dieser E-Mail aus können sie dem Projekt Frame.io beitreten und mit der Arbeit beginnen.
...
Workfront verfügt über robuste Projektverwaltungsfunktionen. Es wird empfohlen, [Bearbeiten von Projektvorlagen](/help/quicksilver/manage-work/projects/create-and-manage-templates/edit-templates.md) Artikel zum Konfigurieren der folgenden Bereiche der Vorlage:
...
1. Klicks **Neues Projekt aus Vorlage**.
...
1. Passen Sie die gewünschten Projekteinstellungen an und klicken Sie auf **Projekt erstellen**.
...
1. Ändern Sie in der Projektüberschrift das Projekt von **Planung** nach **Aktuell**.

Nachdem das Projekt erstellt wurde und Kreative abgeschlossene Assets hochladen, können Sie dem Asset in Workfront einen Arbeitsablauf für Überprüfung und Genehmigung zuweisen. Weitere Informationen finden Sie unter [Erstellen von Dokumentüberprüfungs- oder Genehmigungsanfragen](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md). <!-- name may need to change -->
...
1. Klicks **Neues Projekt**.
1. Geben Sie einen Namen für Ihr Projekt ein und drücken Sie dann die Eingabetaste **Eingabe** , um den Namen zu speichern.
...
1. Klicks **Hinzufügen von Aufgaben beginnen** , um Ihrem Projekt schnell Aufgaben hinzuzufügen. Sie können später weitere Einstellungen konfigurieren.

   Oder

   Klicks **Neue Aufgabe** , um jeweils eine Aufgabe hinzuzufügen und zusätzliche Einstellungen zu konfigurieren.
...
Workfront verfügt über robuste Projektverwaltungsfunktionen. Es wird empfohlen, [Projekte bearbeiten](/help/quicksilver/manage-work/projects/manage-projects/edit-projects.md) Artikel zum Konfigurieren der folgenden Bereiche des Projekts:
...
Weitere Informationen finden Sie unter [Erstellen von Dokumentüberprüfungs- oder Genehmigungsanfragen](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md). <!-- name may need to change -->