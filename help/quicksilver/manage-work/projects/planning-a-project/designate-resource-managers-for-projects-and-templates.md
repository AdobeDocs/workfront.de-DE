...
>[!NOTE]
>
>Resource Manager ist keine Aufgabe. Es handelt sich um ein Feld, das für ein Projekt oder eine Vorlage verfügbar ist, das bzw. die Sie manuell aktualisieren können.
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Um Ressourcen-Manager mehreren Projekten gleichzeitig hinzuzufügen, navigieren Sie zu einer Liste von Projekten, wählen Sie die Projekte aus, für die Sie einen oder mehrere Ressourcen-Manager bestimmen möchten, und klicken Sie dann auf **Bearbeiten**.
      ...
      Vorhandene Ressourcen-Manager werden nicht aus den Projekten entfernt, die Sie bearbeiten. Alle Benutzer, die Sie auf diese Weise hinzufügen, werden zusätzlich zu vorhandenen Ressourcen-Managern als Ressourcen-Manager im Projekt hinzugefügt.
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Um Ressourcen-Manager mehreren Vorlagen gleichzeitig hinzuzufügen, gehen Sie zu einer Liste von Vorlagen, wählen Sie die Vorlagen aus, für die Sie einen oder mehrere Ressourcen-Manager bestimmen möchten, und klicken Sie auf **Bearbeiten**.

      Vorhandene Ressourcen-Manager werden nicht aus den bearbeiteten Vorlagen entfernt. Alle Benutzer, die Sie auf diese Weise hinzufügen, werden zusätzlich zu vorhandenen Ressourcen-Managern als Ressourcen-Manager in der Vorlage hinzugefügt.
