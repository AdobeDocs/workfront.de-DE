...
1. Doppelklicken Sie auf den Wert im **Leistungsindex-Methode** -Feld, um es zu bearbeiten.
1. Wählen Sie aus den folgenden Optionen in **Leistungsindex-Methode** -Feld:
