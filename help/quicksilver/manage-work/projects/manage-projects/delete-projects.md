...
1. Wählen Sie das Projekt aus, das Sie löschen möchten, und klicken Sie auf **Löschen** oben in der Liste.

1. Klicken **Ja, löschen** , um den Löschvorgang zu bestätigen.
...
1. Klicken Sie auf **Mehr** icon ![](assets/qs-more-menu.png).

1. Klicken **Projekt löschen**.
