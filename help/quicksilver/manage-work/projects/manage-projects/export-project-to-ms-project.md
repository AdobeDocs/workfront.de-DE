...
title: Projekt in ein Microsoft-Projekt exportieren
...
# Projekt in ein Microsoft-Projekt exportieren
...
>* Es wird empfohlen, die Anzahl der Projektübertragungen von einer Anwendung zur anderen zu begrenzen. 
>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Anzeigen oder höherer Zugriff auf Projekte</p> <p><b>NOTIZ</b>
...
## Projekt aus Workfront in Microsoft-Projekt exportieren

Sie können ein Projekt aus Workfront von der Projektseite oder von einer Projektliste oder einem Bericht exportieren.

1. Wechseln Sie zu dem Projekt, das Sie exportieren möchten, und klicken Sie auf die Schaltfläche **Mehr** icon ![](assets/qs-more-menu.png) rechts neben dem Projektnamen

   ![](assets/project-level-more-drop-down-expanded-nwe-350x516.png)

   Oder

   Wechseln Sie zu einer Projektliste oder einem Bericht und wählen Sie ein Projekt aus. Klicken Sie dann auf das Symbol Mehr . ![](assets/qs-more-menu.png) oben in der Liste.

   ![](assets/more-menu-expanded-in-a-list-one-project-selected-nwe.png)

1. Klicken **MS-Projekt exportieren**.

   Das Projekt wird als XML-Datei auf Ihren Computer heruntergeladen und kann in das Microsoft-Projekt importiert werden. 
