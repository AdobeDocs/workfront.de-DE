...
>[!NOTE]
>
>Vorlagenaufgaben, die mehreren Vorlagen angehören, können nicht stapelweise bearbeitet werden. Sie können nur Vorlagenaufgaben bearbeiten, die zur gleichen Vorlage gehören.
...
1. (Optional) Um mehrere Vorlagenaufgaben stapelweise zu bearbeiten, wählen Sie mehrere Vorlagenaufgaben aus und klicken Sie dann oben in der Vorlagenliste auf **Bearbeiten** .
1. (Bedingt) Um beschränkte Informationen zu einer Vorlagenaufgabe zu bearbeiten, klicken Sie im linken Bereich auf **Vorlagenaufgaben-Details** und navigieren Sie dann zu den Bereichen des Detailabschnitts, um Informationen für jeden Bereich zu bearbeiten.
1. (Optional) Klicken Sie auf das Symbol **Alle** reduzieren ![](assets/collapse-all-icon.png) , um alle Bereiche zu reduzieren.
...
1. (Bedingt) Um alle Informationen zur Vorlagenaufgabe zu bearbeiten, klicken Sie auf das Menü **Mehr** Menü ![](assets/qs-more-icon-on-an-object.png) neben dem Namen der Vorlagenaufgabe und dann auf **Bearbeiten**.
   ...
   Das Feld **Vorlagenaufgabe bearbeiten** wird angezeigt.
...
1. Aktualisieren Sie Folgendes:
     ...
     <tr> 
      ...
      <td> <p>Die zukünftige Aufgabe, die mit dieser Vorlage erstellt wird, hat diesen Durationstyp. <br>Der Dauer-Typ gibt die Beziehung zwischen Folgendem an:</p> <p>- Anzahl der Ressourcen, die einer Aufgabe zugewiesen sind</p> <p>- der zum Abschließen der Aufgabe erforderliche Gesamtaufwand</p> <p>- die Gesamtdauer der Aufgabe. </p> <p>Mit den Ereignistypen können Sie konsistente Ressourcenzuweisungen entsprechend den Anforderungen der Aufgabe festlegen. Weitere Informationen zum Dauer-Typ einer Aufgabe finden Sie unter <a href="../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md" class="MCXref xref">Übersicht über Aufgabendauer und -dauer</a>.</p> <p>Wählen Sie aus den folgenden Optionen aus:</p> 
       <ul> 
        ...
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Aufwandsorientierter </span> </p> </li> 
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Einfach</span> <br> </p> </li> 
       </ul> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>Dauer</strong> </td> 
      <td> <p>Geben Sie die Dauer der künftigen Aufgaben in Minuten, Stunden, Tagen, Wochen oder Monaten an. Für die zukünftige Aufgabe, die mit dieser Vorlage erstellt wird, wird die hier angegebene Dauer verwendet.</p> <p>Workfront misst die Dauer standardmäßig in Tagen. Dies ist die Zeitspanne, in der die Aufgabe unvollständig bleibt, bevor sie abgeschlossen werden muss. Sie können die Dauer einer Aufgabe nicht angeben, wenn der <strong>Dauer-Typ</strong> der Aufgabe <strong>einfach</strong> ist oder wenn die <strong>Aufgabenbegrenzung</strong> <strong>Feste Datumswerte</strong> ist.</p> <p><b>WICHTIG</b></p> <p>Die Dauer ist normalerweise die Zeit zwischen dem geplanten Start und dem geplanten Abschlussdatum einer Vorlagenaufgabe. Aus diesem Grund wirkt sich sie auf die Zeitleiste der Vorlage aus. Dadurch wird der Timeline des künftigen Projekts festgelegt, das anhand der Vorlage erstellt wird. </p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>Geplante Stunden</strong> </td> 
      <td> <p>Geben Sie die Anzahl der geplanten Stunden für die zukünftige Aufgabe des mit dieser Vorlage erstellten Projekts an. Dies ist die tatsächliche Zeit, die die Bevollmächtigten der Aufgabe benötigen würden, um sie abzuschließen. Sie können die Anzahl der geplanten Stunden für eine Aufgabe nur angeben, wenn der <strong>Dauer-Typ</strong> auf <strong>Berechnete Zuweisung</strong> eingestellt ist. </p> </td> 
     </tr>
   ...
   <tr> 
      ...
      <td> <p>Die Aufgabe für das Projekt, das mit dieser Vorlage erstellt wurde, hat diese Einschränkung. Aufgabenbegrenzungen bestimmen, wann eine Aufgabe abgeschlossen werden muss. </p> <p>Wählen Sie aus den folgenden Optionen aus:</p> 
       <ul> 
        <li><strong>Feste Datumswerte</strong>. Geben Sie einen <strong>geplanten Start</strong> und ein <strong> geplantes Abschlussdatum an.</strong></li> 
        <li><strong>Muss am </strong> beginnen. Geben Sie ein <strong>geplantes Startdatum an.</strong></li> 
        <li><strong>Muss am </strong> enden. Geben Sie ein <strong>geplantes Abschlussdatum</strong> an.</li> 
        <li><strong>Sobald wie möglich</strong> </li> 
        <li><strong>So spät wie möglich</strong> </li> 
        <li style="font-weight: bold;"><strong>früheste verfügbare Zeit</strong> </li> 
        <li style="font-weight: bold;"><strong>Neueste verfügbare Zeit</strong> </li> 
        <li>Starten Sie nicht später als . Geben Sie ein <strong>geplantes Startdatum</strong> an.</li> 
        <li><strong>Anfang nicht früher als</strong>. Geben Sie ein <strong>geplantes Startdatum</strong> an.</li> 
        <li><strong>Beenden Sie nicht später als</strong>. Geben Sie ein <strong>geplantes Abschlussdatum</strong> an.</li> 
        <li><strong>Beenden Sie nicht früher als</strong>. Geben Sie ein <strong>geplantes Abschlussdatum</strong> an.</li> 
     ...
     <tr> 
      ...
      <td> <p>Geben Sie den Kostentyp für die zukünftige Aufgabe an. Auf diese Weise wird bestimmt, wie die Kosten für die Aufgabe basierend auf der Anzahl der Stunden für die Aufgaben berechnet werden. </p> <p>Wählen Sie aus den folgenden Optionen aus:</p> 
       <ul> 
        ...
        <li> <p style="font-weight: normal;"><span>Stündlich korrigiert</span> </p> </li> 
        <li> <p style="font-weight: normal;"><span>Benutzer stündlich</span> </p> </li> 
        <li> <p style="font-weight: normal;"><span>Stündliche Rolle</span> </p> </li> 
       </ul> <p>Weitere Informationen zu Tracking-Kosten finden Sie unter <a href="../../../manage-work/projects/project-finances/track-costs.md" class="MCXref xref">Tracking-Kosten</a>.</p> </td> 
     </tr> 
     <tr> 
      ...
      <td> <p>Geben Sie den Umsatztyp für die zukünftige Aufgabe an. Auf diese Weise wird bestimmt, wie der Umsatz aus der Aufgabe basierend auf der Anzahl der Stunden für die Aufgaben berechnet wird.</p> <p style="font-weight: normal;">Wählen Sie aus den folgenden Optionen aus: </p> 
       ...
       </ul> <p>Weitere Informationen zum Tracking von Umsätzen finden Sie unter <a href="../../../manage-work/projects/project-finances/billing-and-revenue-overview.md" class="MCXref xref">Übersicht über Rechnungsstellung und Umsatz</a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. Aktualisieren Sie Folgendes:
   ...
   <p>Sie müssen einen Meilensteinpfad mit einer Vorlage verknüpfen, damit dieses Feld angezeigt wird. Weitere Informationen finden Sie unter <a href="../create-and-manage-templates/edit-templates.md">Bearbeiten von Projektvorlagen</a>.</p> 
     ...
     <tr> 
      <td role="rowheader"><strong>Tracking-Modus</strong> </td> 
      <td> <p>Geben Sie an, wie der Fortschrittsstatus der künftigen Aufgabe verfolgt werden soll. </p> <p>Wählen Sie aus den folgenden Optionen aus:</p> 
       <ul> 
        ...
        <li> <p><strong>Annahme zur Zeit</strong> </p> </li> 
        <li> <p><strong>Verspätete Warnungen ignorieren</strong> </p> </li> 
     ...
     <tr> 
      ...
      <td> <p>Wählen Sie den Validierungsprozess aus, den Sie mit der Vorlagenaufgabe verbinden möchten. Ihr Workfront-Administrator muss Aufgabengenehmigungsprozesse auf Systemebene definieren, bevor Sie sie mit Vorlagenaufgaben verknüpfen können. <span>Ein Benutzer mit administrativem Zugriff auf Genehmigungsprozesse kann auch gruppenspezifische Validierungsprozesse erstellen.</span> Weitere Informationen zum Erstellen von Genehmigungsprozessen finden Sie unter <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-approval-processes.md" class="MCXref xref">Erstellen eines Genehmigungsprozesses für Arbeitselemente</a>.</p> <p>Beachten Sie beim Hinzufügen von Validierungsprozessen Folgendes: </p> 
       ...
       <li> <p>Wenn für eine der Vorlagenaufgaben ein Genehmigungsprozess für die einmalige Verwendung angehängt ist, wird dieser durch den von Ihnen ausgewählten Validierungsprozess auf Systemebene <span>oder Gruppenebene</span> ersetzt. </p> </li> 
       </ul> </li> 
       </ul> </td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>Erinnerungsbenachrichtigungen</strong> </td> 
...
1. Klicken Sie auf **Zuweisung hinzufügen** , um der Vorlagenaufgabe einen neuen Bevollmächtigten hinzuzufügen. Sie können einer Aufgabe Benutzer, Rollen oder Teams zuweisen. Sie können mehrere Zuweisungen für eine Aufgabe haben. Den künftigen Aufgaben werden dieselben Ressourcen zugewiesen, wenn sie mit dieser Vorlagenaufgabe erstellt werden.
1. (Optional) Wenn Sie mehrere Bevollmächtigte haben, wählen Sie das Optionsfeld **Inhaber** aus, um anzugeben, welcher Benutzer oder welche Rolle als Aufgabenbesitzer oder Primärer Bevollmächtigter gilt. Workfront kennzeichnet die erste Benutzer- oder Auftragsrolle, die Sie einer Vorlagenaufgabe als Inhaber oder Primärer Bevollmächtigter zuweisen.
1. (Bedingt und optional) Wenn Ihre Aufgabenbegrenzung &quot;Berechnete Arbeit&quot;oder &quot;Aufwand gesteuert&quot;ist, geben Sie für jeden Bevollmächtigten den Wert **Zuordnung %** (Zuordnungsprozentsatz) an. Dies ist die Zeit ab dem Zeitplan des Bevollmächtigten, die er für diese Aufgabe verbringen kann. Wenn Sie den Zuordnungsprozentsatz für einen Verantwortlichen ändern, ändern sich die geplanten Stunden einer Aufgabe.
1. (Bedingt und optional) Wenn die Aufgabenbegrenzung einfach ist, geben Sie die **Stunden** für jeden Verantwortlichen an

   Oder

   Geben Sie die Gesamtanzahl der **geplanten Stunden** für die Vorlagenaufgabe an. Dadurch werden die Gesamtstunden gleichmäßig auf alle Bevollmächtigten verteilt.

1. (Bedingt und optional) Wenn die Aufgabenbegrenzung einfach ist, geben Sie die **Dauer** der Vorlagenaufgabe in Tagen an. Dies wird zur Dauer der Aufgabe, die mit dieser Vorlage erstellt wird.
1. (Optional) Wählen Sie eine Rolle aus dem Dropdownmenü **Rolle des Bevollmächtigten** aus. Dies ist die Rolle, die der Bevollmächtigte bei dieser künftigen Aufgabe übernehmen kann. Im Dropdown-Menü werden nur die mit jedem Bevollmächtigten in seinem Profil verknüpften Vorgangsrollen angezeigt.
1. (Optional) Fahren Sie je nach den zu ändernden Informationen mit der Bearbeitung der folgenden Abschnitte fort.
...
1. (Bedingt und optional) Wenn Sie ein benutzerdefiniertes Formular an die Vorlagenaufgabe angehängt haben, bearbeiten Sie alle Felder im Formular. Sie müssen alle erforderlichen Felder angeben, bevor Sie die Vorlagenaufgabe speichern können.
   ...
   >Weitere Informationen zum Festlegen von Aufgabenberechtigungen finden Sie unter [Freigeben einer Aufgabe](../../../workfront-basics/grant-and-request-access-to-objects/share-a-task.md).\
