...
1. (Optional) Klicken Sie auf **Projektinfo bearbeiten**. 
   ...
   Weitere Informationen zum Bearbeiten der Felder im Abschnitt Projektinformationen des Business Case finden Sie im Abschnitt [Projektinformationen](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md#project-info) im Artikel [Überblick über die Bereiche des Business Case](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md).
...
1. (Optional) Klicken Sie **„Ausgaben bearbeiten**.

   Weitere Informationen zur Bearbeitung des Abschnitts „Ausgaben“ des Business Case finden Sie im Abschnitt [Ausgaben](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md#expenses) im Artikel [Überblick über die Bereiche des Business Case](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md).

1. (Optional) Verwenden Sie den Bereich Ressourcenbudgetierung , um Ihre Ressourcen zu budgetieren und die budgetierten Lohnkosten abzurufen, die mit den Aufgabengebieten im Projekt verknüpft sind. Weitere Informationen finden Sie unter [Budgetressourcen im Business Case](../../../manage-work/projects/define-a-business-case/budget-resources-in-business-case.md).
...
1. **** (Optional) Wählen Sie **Dropdown** Menü **diesem Projekt eine Scorecard hinzufügen** aus.
...
1. (Optional) Nach Abschluss des Business Case können Sie eine Kopie davon in eine PDF-Datei exportieren. Weitere Informationen zum Exportieren des Business Case in eine PDF-Datei finden Sie im Abschnitt „Exportieren des Business Case“ im Artikel [Überblick über die Bereiche des Business Case](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md).
