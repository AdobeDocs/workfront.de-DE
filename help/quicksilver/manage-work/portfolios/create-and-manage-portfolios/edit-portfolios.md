...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[!UICONTROL Bearbeiten] Zugriff auf [!UICONTROL Portfolios]</p>  </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Objektberechtigungen</td> 
   <td> <p>[!UICONTROL Manage]-Berechtigungen für ein Portfolio</p>
   <p>[!UICONTROL Verwalten] Berechtigungen für die Projekte im Portfolio, um sie zum Portfolio hinzuzufügen oder daraus zu entfernen</p>  </td> 
  </tr> 
 </tbody> 
</table>
...
1. Erwägen Sie, Informationen in einem der folgenden Abschnitte anzugeben:
   ...
   * [Kommentar](#comment)
   ...
   >[!TIP]
   >
   >Um benutzerdefinierte Felder für mehrere Portfolios gleichzeitig neu zu berechnen, wählen Sie mehrere Portfolios in einer Liste aus und klicken Sie oben in der Liste auf das Menü **Mehr** ![Mehr](assets/more-icon.png) und anschließend **Ausdrücke neu berechnen**.
