...
1. Stellen Sie sicher, dass Sie das [!UICONTROL Gantt-Diagramm] so konfiguriert haben, dass die entsprechenden Informationen angezeigt werden, bevor Sie es exportieren.
   ...
   * Filtern, Ansichten und Gruppierungen nach Bedarf in der Aufgabenliste. Alle Filter und Gruppierungen, die in der Listenansicht ausgewählt sind, werden beim Anzeigen des [!UICONTROL Gantt-Diagramms] beibehalten. Ansichten werden im exportierten [!UICONTROL Gantt-Diagramm] nur innerhalb der Liste angezeigt, die neben dem [!UICONTROL Gantt-Diagramm] auf der ersten Seite angezeigt wird. Ansichten werden nicht im [!UICONTROL Gantt-Diagramm] selbst angezeigt.
   ...
   * Konfigurationsoptionen im [!UICONTROL Gantt-Diagramm]. Sie können beispielsweise festlegen, dass Meilensteine, Datumsangaben, [!UICONTROL Grundlinien] oder [!UICONTROL Prozent abgeschlossen] im [!UICONTROL Gantt-Diagramm] angezeigt werden.
...
1. Klicken Sie auf das Druckersymbol.\
   Das Dialogfeld **[!UICONTROL Nach PDF exportieren]** wird angezeigt.\
   ![export_gantt_UI.png](assets/exported-gantt-ui-350x225.png)

1. Wählen Sie aus, ob Sie nur das, was Sie sehen, oder das gesamte [!UICONTROL Gantt-Diagramm] exportieren möchten:
...
1. Wenn die PDF gedruckt wird, nachdem sie auf PDF exportiert wurde, wählen Sie im Dropdown-Menü **[!UICONTROL Seitengröße]** die gewünschte Papiergröße aus.\
   Sie können **[!UICONTROL Letter]**, **[!UICONTROL Legal]**, **[!UICONTROL Ledger]**, **[!UICONTROL A1]**, **[!UICONTROL A2]**, **[!UICONTROL A3]** (nur für einige Sprachen verfügbar) oder **[!UICONTROL A4]** auswählen.
