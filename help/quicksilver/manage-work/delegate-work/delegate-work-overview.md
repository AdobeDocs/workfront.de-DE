...
* Für die folgenden Lizenztypen gibt es Ausnahmen:
   ...
   * Antragsteller können keine Arbeit an andere delegieren. Sie können keine Arbeitselemente in ihrer [!UICONTROL Startseite] area
