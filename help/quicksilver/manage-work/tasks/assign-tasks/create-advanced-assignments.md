...
* Fügen Sie Abrechnungs- und Kostensatzinformationen auf Zuordnungsebene hinzu.
* Überprüfen Sie für jede Zuweisung die folgenden Details: Geplante Stunden, Gesamtkosten und Gesamtumsatz.
...
>Weitere Informationen zum alten Erlebnis finden Sie unter [Erstellen erweiterter Zuweisungen - alle anderen Pakete](#create-advanced-assignments--all-other-packages) unten.
...
1. Überprüfen Sie die Informationen zur Aufgabendauer nach Bedarf. Diese Felder sind alle schreibgeschützt unter Erweiterte Zuweisungen, und Sie können sie in der Aufgabe aktualisieren.
   ...
   >[!NOTE]
   >
   >Wenn eine Datenspalte, die Sie anzeigen möchten, nicht angezeigt wird, können Sie sie hinzufügen. Siehe [Hinzufügen und Entfernen von Spalten in der Liste „Erweiterte Zuweisungen](#add-and-remove-columns-on-the-advanced-assignments-list) unten.
