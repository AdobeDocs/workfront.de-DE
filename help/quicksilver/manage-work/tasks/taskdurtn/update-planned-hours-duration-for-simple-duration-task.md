...
Weitere Informationen zur Inline-Bearbeitung von Informationen finden Sie unter [Inline-Bearbeitungselemente in einer Liste in Adobe Workfront](../../../workfront-basics/navigate-workfront/use-lists/inline-edit-objects.md).
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Klicken Sie auf **Mehr** icon ![](assets/qs-more-icon-on-an-object.png) Klicken Sie neben dem Namen der Aufgabe auf **Bearbeiten**, dann **Zuweisungen**.
   * Klicken Sie auf **Zugeordnet zu** oder den Namen der Zuweisungen im Bereich &quot;Zuweisungen&quot;der Aufgabenüberschrift und klicken Sie auf **Erweitert**.

1. Geben Sie einen Gesamtwert für die **Geplante Stunden** für alle Zuweisungen, z. B. 10 Stunden. Die Gesamtzahl der geplanten Stunden wird gleichmäßig auf alle Ressourcen verteilt, die der Aufgabe zugewiesen sind.
...
1. Geben Sie einen Wert für die Aufgabe ein **Dauer**, z. B. 2 Tage.
