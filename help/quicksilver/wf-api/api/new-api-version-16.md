      ...
      <td>
        <ul>
          <li>
            ...
            <p>Diese Aktion gibt einen booleschen Wert zurück, der beschreibt, ob der Kunde die Option zur automatischen Aktualisierung von Lizenzinhabern des Beitragenden deaktiviert hat.</p>
         </li>
        </ul>
      </td>
    </tr>  </tbody>
