...
title: Aktionen, die nach der Installation eines Blueprint ausgeführt werden müssen
description: In diesem Artikel wird beschrieben, wie Sie nach der Installation eines Blueprints in  [!DNL Adobe Workfront]  vorgehen sollten, um den Blueprint für Ihre Systembenutzer vollständig bereitzustellen.
author: Courtney
...
In diesem Artikel wird beschrieben, wie Sie nach der Installation eines Blueprints in [!DNL Adobe Workfront] vorgehen sollten, um den Blueprint für Ihre Systembenutzer vollständig bereitzustellen.
...
Dieser Abschnitt enthält Empfehlungen zu den Projektvorlagen, die mit Ihren Entwürfen installiert werden.
...
Im Installationsprozess wird die Projektvorlage mit keinen benutzerdefinierten Formularen verknüpft. Wenn Ihre Projekte oder Aufgaben bestimmte Formulare oder Felder ausfüllen müssen, um Konsistenz in der Berichterstellung zu gewährleisten, oder wenn Ihr digitales Anfrageformular Felder enthält, die auf Projektebene beibehalten werden müssen, empfehlen wir, die Vorlage oder die Vorlagenaufgaben mit diesen Formularen zu verknüpfen. Weitere Informationen finden Sie unter [Benutzerdefiniertes Formular zu einem Objekt hinzufügen](../../workfront-basics/work-with-custom-forms/add-a-custom-form-to-an-object.md).
...
Im Installationsprozess wird die Projektvorlage nicht mit einem Meilensteinpfad verknüpft. Wenden Sie einen Meilensteinpfad auf die Vorlage an und wenden Sie Meilensteine auf wichtige Aufgaben in der Vorlage an, um Ihre Meilensteinberichterstattungsanforderungen zu unterstützen. Weitere Informationen finden Sie unter [Meilensteine mit Aufgaben verknüpfen](../../manage-work/tasks/manage-tasks/associate-milestones-with-tasks.md).

### Vorlage für Ihr Team bereitstellen {#roll-out-the-template-to-your-team}

Bereiten Sie Schulungsmaterialien sowohl für die Arbeitsmanager vor, die diese Vorlage verwenden, als auch für die einzelnen Mitwirkenden, die die Arbeit innerhalb der Projektvorlage ausführen.
...
Wenn die Projektmappe einer Arbeit ähnelt, die Sie bereits in [!DNL Workfront] ausgeführt haben, sollten Sie überprüfen, ob die Arbeit wie erwartet in vorhandene Berichte und Dashboards eingespeist wird. Wenn sie nicht in Ihre vorhandenen Berichte einfließen, ergreifen Sie Maßnahmen, um Filter zu aktualisieren oder neue Berichte zu erstellen.

## Empfehlungen zur Organisationsstruktur {#organizational-structure-recommendations}

Dieser Abschnitt enthält Empfehlungen zu den organisatorischen Strukturelementen, die mit Ihren Entwürfen installiert werden.

### Firmen

Nach der Installation eines Plans, der ein Unternehmen umfasst:
...
Dieser Abschnitt enthält Empfehlungen für die Dashboards und Berichte, die mit einem Blueprint installiert wurden.

### Aktualisieren Sie die neu erstellten Dashboards, um Berichte hinzuzufügen/zu entfernen
...
Einige Berichte, die in einem Dashboard-Entwurf enthalten sind, enthalten benutzerdefinierte Datenfelder in der Ansicht, dem Filter oder der Gruppierung des Berichts. In einigen Fällen enthält die Blaupause auch ein Formular, mit dem diese Felder verknüpft sind. Meistens werden die benutzerdefinierten Felder jedoch nicht auf ein benutzerdefiniertes Formular angewendet. Damit die Spalten, Filter oder Gruppierungen ordnungsgemäß funktionieren, müssen diese Felder Formularen zugeordnet werden, die mit einem Benutzer-, Projekt-, Vorgang- oder anderen Objektdatensatz verbunden sind. Weitere Informationen finden Sie unter [Erstellen eines benutzerdefinierten Formulars](/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form.md).
