...
>[!IMPORTANT]
>
>Ihr IT-Team sollte sicherstellen, dass eingehende E-Mails von `notifications@my.workfront.com` wird im System Ihres Unternehmens nicht blockiert.
>
...
Informationen zum Konfigurieren der Firewall Ihres Unternehmens zum Öffnen der Kommunikation zwischen Ihrer Umgebung und den Adobe Workfront-Servern finden Sie unter [Konfigurieren der Zulassungsliste Ihrer Firewall](../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md).
...
1. Im **E-Mail-Zulassungsliste** Bereich, wählen Sie **Aktivieren der Domain-Zulassungsliste** Klicken Sie auf **Domäne hinzufügen**.
1. Geben Sie in das angezeigte Feld eine Domäne ein, die Sie zulassen möchten, z. B. `ourcompany.com`Klicken Sie auf **Domäne hinzufügen**.
