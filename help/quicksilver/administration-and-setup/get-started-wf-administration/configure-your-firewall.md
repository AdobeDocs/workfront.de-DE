...
>
>Informationen zum Konfigurieren Ihrer Zulassungsliste, wenn Ihr Unternehmen in die Adobe Admin Console integriert wurde, finden Sie unter [Domänen, die für Adobe Apps und Services zulässig sein sollen](https://helpx.adobe.com/enterprise/kb/network-endpoints.html).
>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">So verwenden Sie den AWS-E-Mail-Dienst</td> 
   <td> 
    <ul> 
     <li>54.240.60.174</li> 
     <li>54.240.60.175</li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">So greifen Sie über Workfront Ascent auf Workfront-Schulungsressourcen zu</td> 
   <td> 
    <ul> 
     <li>18.223.140.34</li> 
     <li>3.13.223.30</li> 
  ...
  <tr> 
   <td role="rowheader">So erhalten Sie E-Mail-Benachrichtigungen von Workfront Ascent</td> 
   <td> 
    <ul> 
     <li>23.251.227.75</li> 
     <li>23.251.227.76</li> 
