...
Nach der Installation des [!UICONTROL Workfront for AEM Assets]-Connectors (wie unter [Installieren des [!UICONTROL Workfront for AEM Assets]-Connector-Pakets](#install-the-workfront-for-aem-assets-connector-package) beschrieben) und der Konfiguration von [!UICONTROL AEM Assets] (wie unter [Konfigurieren von [!UICONTROL AEM Assets] für die Integration mit [!DNL Workfront]](#configure-aem-assets-to-integrate-with-workfront) beschrieben) müssen Sie [!DNL Workfront] konfigurieren, um Dokumente zwischen [!DNL Workfront] und [!DNL AEM Assets] zu verknüpfen.
