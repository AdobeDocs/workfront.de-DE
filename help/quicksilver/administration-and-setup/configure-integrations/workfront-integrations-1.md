  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <ul>
     <li>Verwenden Sie Workfront-Genehmigungsvorlagen, um Genehmigungs-Workflows zu definieren. </li>
     <li>Überprüfen von Adobe Express-Entwurfsinhalten im Proofing Viewer. </li>
     <li>Siehe Überprüfen von Entscheidungen in Adobe Express zur endgültigen Genehmigung und Veröffentlichung. </li>
     </ul>
   </ul>
     <p>Weitere Informationen finden Sie unter <a href="/help/quicksilver/workfront-integrations-and-apps/review-and-approval-integrations/wf-proof-and-express.md" class="MCXref xref"> der Integration von Adobe Express und Workfront Proof</a>.</p> 
   ...
   <td>Die Integration muss für Ihre Konten vom Adobe-Produkt-Team aktiviert werden. Weitere Informationen finden Sie unter <a href="/help/quicksilver/workfront-integrations-and-apps/review-and-approval-integrations/wf-proof-and-express.md" class="MCXref xref"> der Integration von Adobe Express und Workfront Proof</a>.</td> 
  </tr>
 <tr> 
   ...
   <td> 
    <ul> 
     ...
     <ul>
     <li>Verwenden Sie Workfront-Genehmigungsvorlagen, um Genehmigungs-Workflows zu definieren. </li>
     <li>Überprüfen von GenStudio-Entwurfsinhalten im Proofing Viewer. </li>
     <li>Siehe Überprüfen von Entscheidungen in GenStudio zur endgültigen Genehmigung und Veröffentlichung. </li>
     </ul>
   </ul>
     <p>Weitere Informationen finden Sie unter <a href="/help/quicksilver/workfront-integrations-and-apps/review-and-approval-integrations/wf-proof-and-genstudio.md" class="MCXref xref">Erste Schritte mit der Proofing- und GenStudio for Performance Marketing-Integration</a>.</p> 
     </td>  <td><ul><li>Sie müssen über Lizenzen für Workfront und GenStudio for Performance Marketing verfügen.</li><li>Ihre Workfront-Instanz muss auf dem einheitlichen Adobe-Erlebnis basieren.</li><li>Workfront und GenStudio for Performance Marketing müssen in derselben IMS-Organisation bereitgestellt werden.</li></ul></td> 
   <td>Die Integration kann im Workfront-Setup-Bereich aktiviert werden, sobald alle Anforderungen erfüllt sind. Weitere Informationen finden Sie unter <a href="/help/quicksilver/workfront-integrations-and-apps/review-and-approval-integrations/wf-proof-and-genstudio.md" class="MCXref xref">Erste Schritte mit der Proofing- und GenStudio for Performance Marketing-Integration</a>. </td> 
  </tr>
  <tr> 
