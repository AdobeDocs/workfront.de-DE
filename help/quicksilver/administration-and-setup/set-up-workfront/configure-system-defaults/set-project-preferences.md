...
<tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <span class="preview">Der Bereich Benutzerdefinierte Quartale wurde aus dem Abschnitt Projektvoreinstellungen in der Vorschau-Umgebung entfernt.</span> 
   <span class="preview">Weitere Informationen finden Sie unter <a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/enable-custom-quarters-projects.md" class="MCXref xref" data-mc-variable-override="">Benutzerdefinierte Quartale aktivieren</a>.</p></span>
   <p>Konfigurieren Sie in der Produktionsumgebung benutzerdefinierte jährliche Quartale für die Benutzer, die an Projekten arbeiten werden. Benutzerdefinierte Quartale sind in der Regel Quartale, die nicht der herkömmlichen Aufschlüsselung von Quartalen während eines Kalenderjahres entsprechen. Sie können mehrere benutzerdefinierte Quartale hinzufügen.   <p><b>HINWEIS</b>: </p><p>[!DNL Workfront] Administratoren können die Voreinstellungen für [!UICONTROL Benutzerdefinierte Quartale] nicht entsperren und Gruppenadministratoren können diese Einstellungen nicht auf Gruppenebene bearbeiten.</p> </td> 
  </tr> 
 </tbody> 
</table>
