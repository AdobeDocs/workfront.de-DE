...
>* Diese Voreinstellung regelt auch, ob Benutzende Bilder an Kommentare zu Objekten anhängen können, die den Adobe-Cloud-Speicher verwenden. Angehängte Bilder werden im Adobe Cloud-Speicher gespeichert.
