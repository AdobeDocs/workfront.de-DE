...
description: Sie können die Arbeitswochen Ihrer Benutzer mit Zeitplänen definieren. Sie können einen Zeitplan mit einem Benutzer oder einem Projekt verknüpfen. Dies ermöglicht Folgendes [!DNL Workfront] zur Berechnung der Zeitpläne und der Benutzerverfügbarkeit.
author: Lisa, Alina
...
Als [!DNL Adobe Workfront] Administrator können Sie Ihre Arbeitswoche mit Zeitplänen definieren. Sie können einen Zeitplan mit einem Benutzer oder einem Projekt verknüpfen. Dies ermöglicht Folgendes [!DNL Workfront] zur Berechnung der Zeitpläne und der Benutzerverfügbarkeit.
...
1. Klicks **[!UICONTROL Zeitpläne]**.
1. Klicks **[!UICONTROL Neuer Zeitplan]**.
...
1. (Optional) Wählen Sie **[!UICONTROL Standardzeitplan]** , um diesen Zeitplan als Ihren Standard zu kennzeichnen.
   ...
   Sie müssen mindestens einen Zeitplan in [!DNL Workfront]. Wenn Sie nur eine haben, wird sie als Standardzeitplan festgelegt.
...
1. Im **[!UICONTROL Details]** Geben Sie die folgenden Informationen ein:
   ...
   <table style="table-layout:auto">
    ...
    <tr>
     ...
     <p>Wenn Sie den Zeitplan mit einem Benutzer verknüpfen, empfehlen wir, dass die Zeitzone des Zeitplans mit der des Benutzers übereinstimmt. Informationen zu den Zeitzonen des Benutzers finden Sie unter <a href="../../../administration-and-setup/add-users/create-and-manage-users/edit-a-users-profile.md" class="MCXref xref">Bearbeiten Sie das Profil eines Benutzers.
     </td>
    </tr>
   </table>


1. Im **[!UICONTROL Ausnahmen]** auf, geben Sie eventuelle Ausnahmen vom Zeitplan an.
...
1. Geben Sie die Start- und Endzeit für die partiellen Tagesausnahmen ein.
   ...
   ![Unvollständiger Tagesausschluss](assets/partial-day-exception-on-schedules.png)

1. Klicks **[!UICONTROL Speichern]** Klicken Sie auf **[!UICONTROL Speichern] Änderungen**.
