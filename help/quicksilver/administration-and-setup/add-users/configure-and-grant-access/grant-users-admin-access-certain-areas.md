...
1. Aktivieren Sie im Abschnitt **Administratorzugriff für** zulassen die Kontrollkästchen, um den erforderlichen Administratorzugriff zu gewähren.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>Erstellen und verwalten Sie Erinnerungsbenachrichtigungen in Workfront.<br>Ohne diesen Zugriff sind Benutzer auf das Empfangen und Anzeigen von Benachrichtigungen beschränkt.</td> 
     </tr> 
     <tr> 
