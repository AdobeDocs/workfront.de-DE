...
# Gewähren von Zugriff auf Projekte
...
## Zugriff auf Projekte nach Lizenztyp

Informationen dazu, was Benutzer in den einzelnen Zugriffsebenen mit Projekten tun können, finden Sie im Abschnitt [Projekte](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md#projects) im Artikel [Funktionalität für jeden Objekttyp verfügbar](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md).
