...
1. Klicken Sie auf das Zahnradsymbol ![](assets/gear-icon-settings.png) auf **Ansicht** oder **Bearbeiten** rechts neben den Portfolios, und wählen Sie dann die Fähigkeiten aus, die Sie unter **Einstellungen anpassen**.
