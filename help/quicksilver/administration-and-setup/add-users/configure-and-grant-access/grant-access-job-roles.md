...
1. Klicken Sie auf das Zahnradsymbol ![](assets/gear-icon-settings.png) der Schaltfläche **Anzeigen** oder **Bearbeiten** rechts neben „Aufgabengebiete“ und wählen Sie dann unter **Einstellungen optimieren** die Funktionen aus, die Sie gewähren möchten.
   ...
   Benutzer mit **Anzeigen**-Zugriff können vorhandene Aufgabengebiete anzeigen und optional Abrechnungssätze für Aufgabengebiete, Kostensätze und allgemeine Finanzen anzeigen.
   ...
   * Aufgabengebiet, Abrechnungssätze, Kostensätze und allgemeine Finanzen anzeigen
   * Aufgabengebiet, Abrechnungssätze, Kostensätze und allgemeine Finanzen bearbeiten
