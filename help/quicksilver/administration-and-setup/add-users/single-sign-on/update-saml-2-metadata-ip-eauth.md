...
1. Klicks **Anwendung hinzufügen** Klicken Sie auf **Neue App erstellen**.
...
1. Klicks **Nächste**.
1. Select, **Ich bin Okta-Kunde und verwende eine interne App** Klicken Sie auf **Beenden**.
...
1. Laden Sie die Metadaten des Identitätsanbieters für Ihre Okta-Instanz herunter:
   ...
   1. Im **Anmelden** Registerkarte, klicken **Identity Provider-Metadaten**.
