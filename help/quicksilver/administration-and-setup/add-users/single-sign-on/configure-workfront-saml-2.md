...
>
>Da nun alle Organisationen in die Adobe Admin Console integriert sind, ist das Verfahren nicht mehr verfügbar.
>
>Informationen zum Zuordnen von Benutzerattributen in Organisationen, die in die Adobe Admin Console integriert wurden, finden Sie [Zuordnen von Benutzerattributen](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/map-user-attributes.md#map-user-attributes-in-the-adobe-unified-experience) im Artikel Zuordnen von Benutzerattributen .
