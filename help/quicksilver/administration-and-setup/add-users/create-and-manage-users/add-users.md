...
Als Adobe-Administrator können Sie Benutzende in Adobe Workfront hinzufügen, indem Sie sie in der Adobe Admin Console zu Ihrem Workfront-Produktprofil hinzufügen. Anweisungen finden Sie unter [Verwalten von Benutzern in der Adobe Admin Console](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/admin-console.md).
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Deaktivieren Sie **Einladungs-E-Mail an diese Person senden** und geben Sie dann ein **Kennwort** für die Person ein und bestätigen Sie es im Feld **Kennwort bestätigen**. Sie müssen dieses Kennwort für Benutzer außerhalb von Workfront freigeben.
   ...
   >
   >* Da Ihr Unternehmen in die Admin Console integriert wurde und Sie einen Benutzer über Workfront hinzufügen, haben Sie keine Möglichkeit, eine E-Mail-Einladung zu senden.
   >
   >   Bestehende Adobe-Benutzende erhalten möglicherweise eine E-Mail, in der sie darauf hingewiesen werden, dass Workfront verfügbar ist. Dies ist eine Voreinstellung, die von dem oder der Adobe-Admin für das Produkt gesteuert wird.
