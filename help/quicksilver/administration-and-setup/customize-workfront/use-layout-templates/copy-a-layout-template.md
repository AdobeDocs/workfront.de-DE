...
1. Geben Sie im angezeigten Bildschirm einen neuen **Name der Layout-Vorlage** und (optional) a **Beschreibung** verwendet werden.

1. Weisen Sie die Vorlage den Benutzern zu, die sie benötigen, wie unter [Benutzer einer Layoutvorlage zuweisen](../../../administration-and-setup/customize-workfront/use-layout-templates/assign-users-to-layout-template.md).
