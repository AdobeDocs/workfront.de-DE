...
>* Informationen zum Anpassen von Terminologieübersetzungen in andere Sprachen als Englisch finden Sie unter [Konfigurieren einer benutzerdefinierten Lokalisierung](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/configure-custom-localization.md).
...
## Anpassen der Terminologie der Benutzeroberfläche
