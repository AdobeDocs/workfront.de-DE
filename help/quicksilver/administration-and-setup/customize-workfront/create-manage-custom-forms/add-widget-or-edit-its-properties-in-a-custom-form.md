...
1. Beginnen Sie mit der Arbeit an einem benutzerdefinierten Formular, wie in [Erstellen oder Bearbeiten eines benutzerdefinierten Formulars](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md) beschrieben.
1. Führen Sie bei geöffneter Registerkarte **Feld hinzufügen** einen der folgenden Schritte aus:

   * Wenn Sie ein neues Widget hinzufügen, wählen Sie **Bild**, **PDF** oder **Video** aus, um es am unteren Rand des Formulars hinzuzufügen, oder ziehen Sie es an die gewünschte Stelle im Formular.

     ![](assets/add-widget.png)


   * Wenn Sie ein Widget hinzufügen möchten, das bereits einem anderen benutzerdefinierten Formular hinzugefügt wurde, klicken Sie auf **Feldbibliothek** und dann auf den Namen des Widgets in der angezeigten Liste. Weitere Informationen finden Sie unter [Wiederverwenden eines benutzerdefinierten Felds oder Widgets in einem benutzerdefinierten Formular](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md).
...
1. Wenn Sie Ihr benutzerdefiniertes Formular auf andere Weise weiter erstellen möchten, führen Sie einen der folgenden Artikel aus:
   ...
   * [Verwenden Sie ein benutzerdefiniertes Feld oder Widget in einem benutzerdefinierten Formular erneut](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
...
1. Beginnen Sie mit der Arbeit an einem benutzerdefinierten Formular, wie in [Erstellen oder Bearbeiten eines benutzerdefinierten Formulars](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md) beschrieben.
1. Wählen Sie bei geöffneter Registerkarte **Feld hinzufügen** die Option **Adobe XD** aus.
1. Geben Sie eine der folgenden Eigenschaften für das Widget ein oder bearbeiten Sie sie:
...
1. Gehen Sie zum Video im Bereich &quot;Dokumente&quot;und generieren Sie einen Testversand dafür, wie unter [Erstellen eines interaktiven Testversands für eine Website oder andere Webinhalte](../../../review-and-approve-work/proofing/creating-proofs-within-workfront/generate-interactive-proof-for-website-or-other-web-content.md) beschrieben.
