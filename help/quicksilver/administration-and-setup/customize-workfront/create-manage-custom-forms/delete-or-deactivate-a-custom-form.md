...
1. Wählen Sie das benutzerdefinierte Formular aus und klicken Sie dann auf ![Löschsymbol](assets/delete-icon.png).
1. Wenn Sie das benutzerdefinierte Formular und alle zugehörigen Daten in Objekten, an die es angehängt war, wirklich dauerhaft löschen möchten, klicken Sie auf **Ja, löschen**.
