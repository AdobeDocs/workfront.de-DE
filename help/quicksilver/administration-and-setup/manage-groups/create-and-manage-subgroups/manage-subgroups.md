   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Wenn Sie die neue Untergruppe aus der angezeigten Gruppe eine Ebene nach unten erstellen möchten, klicken Sie auf <strong>Untergruppe hinzufügen</strong>.</p> <p>Wenn Sie die neue Untergruppe unter einer anderen Untergruppe in der Liste erstellen möchten, wählen Sie diese Untergruppe aus und klicken Sie auf <strong>Hinzufügen von s</strong><strong>Untergruppe</strong>.</p> <p>Informationen zu den Optionen zum Konfigurieren der Untergruppe finden Sie in der Tabelle unter <a href="../../../administration-and-setup/manage-groups/create-and-manage-subgroups/create-a-subgroup.md" class="MCXref xref">Erstellen einer Untergruppe</a>.</p> <p>Eine Gruppierungshierarchie darf 15 Ebenen nicht überschreiten, eine einzelne Ebene kann jedoch eine unbegrenzte Anzahl paralleler Gruppen aufweisen.</p> </td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td> <p>Wählen Sie die zu bearbeitende Untergruppe aus und klicken Sie auf das Symbol Bearbeiten . <img src="assets/edit-icon.png">.</p> <p>Informationen zu den Optionen zum Konfigurieren der Untergruppe finden Sie in der Tabelle unter <a href="../../../administration-and-setup/manage-groups/create-and-manage-groups/create-a-group.md" class="MCXref xref">Gruppe erstellen</a>.</p> </td> 
     </tr> 
     <tr> 
      ...
      <td> 
       <ol> 
        ...
        <li value="2">Klicken Sie auf das Symbol Exportieren . <img src="assets/export.png">und wählen Sie das gewünschte Dateiformat aus.</li> 
       </ol> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">Eine Untergruppe kopieren, um eine neue Gruppe der obersten Ebene zu erstellen</td> 
      <td> <p>(Nur für Workfront-Administratoren verfügbar.) Wenn Sie eine Untergruppe kopieren, wird sie zu einer übergeordneten Gruppe. Alle Gruppenmitglieder und Untergruppen werden damit kopiert. Die Gruppenmitglieder behalten ihre Zuweisungen in der ursprünglichen Gruppe bei.</p> <p>Weitere Informationen zum Kopieren einer Untergruppe finden Sie unter <a href="#about-copying-a-subgroup" class="MCXref xref">Über das Kopieren einer Untergruppe</a> in diesem Artikel.</p> 
       <ol> 
        <li value="1">Wählen Sie eine Untergruppe aus und klicken Sie auf das Symbol Kopieren . <img src="assets/copy-icon.png"> , um eine neue Gruppe der obersten Ebene zu erstellen, die auf der ausgewählten Gruppe basiert.</li> 
     ...
     <tr> 
      ...
      <td> <p><b>WICHTIG</b>: Wenn Sie eine Gruppe oder Untergruppe löschen, müssen Sie die Benutzer, Arbeitselemente und alle Untergruppen, die dieser Gruppe derzeit zugewiesen sind, beibehalten. Um sicherzustellen, dass die Objekte erhalten bleiben, müssen Sie die Objekte der Gruppe im folgenden Schritt einer anderen Gruppe zuweisen.</p> 
       <ol> 
        <li value="1">Wählen Sie die Untergruppe aus und klicken Sie auf das Symbol Löschen . <img src="assets/delete.png">.</li> 
        <li value="2">Im <strong>Gruppe löschen</strong> wird angezeigt, indem Sie mit der Eingabe beginnen und dann den Namen der Gruppe auswählen, in die Sie die Mitglieder, Arbeitselemente und Untergruppen der Gruppe verschieben möchten, die Sie löschen möchten.</li> 
        <li value="3">Klicken <strong>Löschen</strong>.</li> 
       </ol> </td> 
     </tr> 
    </tbody> 
   </table>
...
>[!TIP]
>
>Wenn Sie eine Gruppe deaktivieren, der Untergruppen untergeordnet sind, werden diese ebenfalls inaktiv. Wenn Sie möchten, dass einer von ihnen aktiv ist, können Sie diese Anweisungen verwenden, um ihn aus der übergeordneten Gruppe zu entfernen und ihn dann erneut zu aktivieren.
>
...
1. Wählen Sie die übergeordnete Gruppe der Gruppe aus, die Sie als Gruppe der obersten Ebene erstellen möchten, und klicken Sie dann auf das Symbol Bearbeiten ![](assets/edit-icon.png).
1. Im **Gruppe bearbeiten** Feld, das angezeigt wird, unter **Gruppenmitglieder und Gruppenadministratoren** eingeben, beginnen Sie mit der Eingabe des Namens der Untergruppe, der Sie eine Gruppe der obersten Ebene zuweisen möchten, und klicken Sie dann auf das X rechts von ihrem Namen, sobald es erscheint.
