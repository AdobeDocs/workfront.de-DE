...
1. Klicken Sie im linken Bereich auf **Unternehmen** um die mit der Gruppe verbundenen Unternehmen und gegebenenfalls die ihr gegebenenfalls untergeordneten Gruppen aufzulisten.
1. (Optional) Um ein Unternehmen hinzuzufügen, klicken Sie auf **Firma hinzufügen** und konfigurieren Sie dann das Unternehmen mithilfe der unten aufgeführten Optionen. Klicken Sie abschließend auf **Unternehmen erstellen**.
