...
Informationen zu anderen Methoden zum Verwalten einer Gruppe finden Sie unter [Gruppe erstellen](../../../administration-and-setup/manage-groups/create-and-manage-groups/create-a-group.md).

Informationen dazu, wie Sie eine Gruppe deaktivieren oder reaktivieren können, finden Sie unter [Gruppe deaktivieren oder reaktivieren](../../../administration-and-setup/manage-groups/create-and-manage-groups/deactivate-or-reactivate-a-group.md).
