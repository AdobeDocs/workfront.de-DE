...
title: Liste von Gruppen exportieren
...
1. Wenn Sie die gesamte Gruppe von Gruppen exportieren möchten, die Sie verwalten, klicken Sie auf das Symbol Exportieren . ![](assets/export.png).
   ...
   Um einige der von Ihnen verwalteten Gruppen zu exportieren, wählen Sie diese Gruppen aus und klicken Sie auf das Symbol Exportieren . ![](assets/export.png).
