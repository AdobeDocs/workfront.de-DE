...
title: Eine Liste von Gruppen exportieren
...
# Eine Liste von Gruppen exportieren
...
1. Wenn Sie die gesamte Gruppe von Gruppen exportieren möchten, die Sie verwalten, klicken Sie auf das Symbol Exportieren ![](assets/export.png).

   Oder

   Um einige der von Ihnen verwalteten Gruppen zu exportieren, wählen Sie diese Gruppen aus und klicken Sie dann auf das Symbol Exportieren ![](assets/export.png) .

1. Wählen Sie das Dateiformat für die exportierte Liste aus.
