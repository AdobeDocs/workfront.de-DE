...
* Video [!DNL Autodesk Animator Flic]
* [!DNL Autodesk RLE]
...
* Video [!DNL CD Graphics]
* [!DNL Chinese AVS] Video ([!DNL AVS1-P2], [!DNL JiZhun])
* [!DNL Cinepak]
* [!DNL Cirrus Logic AccuPak]
* [!DNL Creative Labs Video Blaster Webcam]
* [!DNL Creative YUV] (CYUV)
* Video [!DNL Delphine Software International CIN]
...
* [!DNL GoToMeeting]-Codec (v1 und v2)
* [!DNL H.261]
* [!DNL H.263], [!DNL H.263+]
...
* [!DNL Intel Indeo 5]
* [!DNL Interplay C93]
* Video [!DNL Interplay MVE]
* Video-Codec von [!DNL Karl Morton]
* [!DNL Kega Game Video]
...
* Video [!DNL Motion Pixels]
* [!DNL Motion Wavelets]
* [!DNL Moyea Flash to Video Converter]
* Video [!DNL MPEG-1]
* Video [!DNL MPEG-2]
* [!DNL MPEG-4 part 2]
* [!DNL MPEG-4 part 2] ([!DNL Microsoft] 1-3)
* [!DNL MPEG-PES]
* [!DNL MSS2]
* [!DNL MSU Screen Capture Lossless Codec]
* Video [!DNL Nintendo Gamecube THP]
...
* [!DNL On2 VP7]
* Video [!DNL Power VideoWorks]
* [!DNL ProRes 422]
* [!DNL Psygnosis YOP] Video
* [!DNL Q-team QPEG]
* [!DNL QPEG]
* Video [!DNL QuickTime 8BPS]
* Video [!DNL QuickTime Animation (RLE)]
...
* [!DNL Telegeny VDTZ]
* [!DNL Theora]
* Video [!DNL Tiertex Limited SEQ]
* [!DNL TrueMotion 1.0]
* [!DNL TrueMotion 2.0]
* [!DNL UCOD-ClearVideo]
* Erweiterter Codec [!DNL VDOWave 3]
* [!DNL VDOWave] Codec
...
* [!DNL ProRes 4444] ([!DNL ProRes 422] unterstützt)
* [!DNL HDV 720p60]
* [!DNL Go2Meeting3 (G2M3)]
* [!DNL Go2Meeting4 (G2M4)]
* [!DNL ER AAC LD] (Fehlerresistente, Variante mit geringer Verzögerung von [!DNL AAC])
* [!DNL REDCODE]
