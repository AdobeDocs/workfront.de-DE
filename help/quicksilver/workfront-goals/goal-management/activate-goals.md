...
title: Ziele in Adobe Workfront aktivieren
...
Informationen zum Erstellen eines Ziels finden Sie unter [Ziele in Adobe Workfront erstellen](../../workfront-goals/goal-management/create-goals.md).
