...
title: Aktualisieren des Zielfortschritts in Adobe Workfront Goals
description: Sie müssen Ihre Ziele regelmäßig überprüfen und ihren Fortschritt aktualisieren, um sicherzustellen, dass sie nicht zurückbleiben oder Gefahr laufen, nicht erreicht zu werden.
author: Alina
...
# Aktualisieren des Zielfortschritts in Adobe Workfront Goals

<!-- Audited for P&P only: 10/2025-->

Sie müssen Ihre Ziele regelmäßig überprüfen und ihren Fortschritt aktualisieren, um sicherzustellen, dass sie nicht zurückbleiben oder Gefahr laufen, nicht erreicht zu werden.
...
Sie müssen über ein aktives Ziel verfügen, bevor Sie beginnen können.

Sie können den Fortschritt bei Zielen, die Entwürfe, inaktiv oder geschlossen sind, nicht aktualisieren.

## Überlegungen zum Aktualisieren von Zielen

Beachten Sie beim Aktualisieren des Fortschritts bei -Zielen Folgendes:
...
* Workfront Goals berechnet automatisch den Fortschritt eines Ziels, wenn Sie den Fortschritt seiner Fortschrittsanzeigen aktualisieren.
  ...
  >[!TIP]
  >
  >Der Fortschritt eines Ziels kann nicht direkt aktualisiert werden. Sie müssen den Fortschritt der Fortschrittsindikatoren des Ziels (Aktivitäten, Ergebnisse, verbundene Projekte) aktualisieren, was wiederum den Fortschritt des Ziels aktualisiert. Um den Projektfortschritt zu aktualisieren, müssen Sie die Aufgaben im Projekt aktualisieren.
   ...
   * Informationen dazu, wie Workfront Goals den Fortschritt für ein Ziel berechnet, finden Sie unter [Übersicht über den Zielfortschritt und die Bedingung in Adobe Workfront Goals](../../workfront-goals/goal-management/calculate-goal-progress.md).
...
* Wenn Sie oder eine andere Person zum ersten Mal den Fortschritt eines Ergebnisses oder einer Aktivität für ein Ziel aktualisieren, ändert sich der Zielfortschritt von „Neue Ziele“ und Workfront beginnt mit der Aufzeichnung des Fortschritts und des Fortschrittsstatus-Updates für das Ziel.
...
So aktualisieren Sie den Fortschritt bei Zielen:

1. Klicken Sie auf **Hauptmenü**-Symbol ![Hauptmenüsymbol](assets/lines-main-menu.png) > **Ziele** in der oberen rechten Ecke.

   <!--
    Add this when Shell is available to all: or (if available), click the **Main Menu** icon ![Main menu icon](../goal-review-and-workfront-goals-sections/assets/three-line-main-menu-icon.png) in the upper-left corner)
   -->

   Dadurch wird die Liste der Ziele geöffnet. Alle Ziele, auf die Sie Zugriff haben, werden standardmäßig angezeigt.

   Alternativ können Sie im linken Bedienfeld auf Zielausrichtung klicken.
...
1. Klicken Sie **linken Bereich** Fortschrittsanzeigen“.
   ...
   Die Liste Fortschrittsanzeigen zeigt alle Fortschrittsanzeigen für das ausgewählte Ziel an.

   >[!NOTE]
   >
   >  * Sie können nur Ergebnisse und Aktivitäten aktualisieren.
   >  * Sie müssen die Fortschrittsindikatoren von untergeordneten Zielen aktualisieren, um den Fortschritt bei den untergeordneten Zielen anzuzeigen.
   >  * Sie müssen die Aufgaben in den verbundenen Projekten aktualisieren, um den Fortschritt der Projekte anzuzeigen.
   >   
   >    Der Fortschritt der untergeordneten Ziele und der Fortschritt der Projekte wiederum steuern den Fortschritt des ausgewählten Ziels an.


1. Um den Fortschritt eines Ergebnisses oder einer Aktivität zu aktualisieren, klicken Sie auf den Wert in der Spalte **Tatsächlicher Fortschritt** des Ergebnisses oder der Aktivität und geben Sie eine Zahl ein, um ihren Wert zu aktualisieren. Drücken Sie dann die Eingabetaste.

   ![Tatsächlicher Fortschritt](assets/actual-progress-result-updating-highlighted-unshimmed.png)
