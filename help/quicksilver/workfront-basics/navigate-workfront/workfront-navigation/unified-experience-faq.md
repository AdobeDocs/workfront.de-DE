...
title: Adobe Unified Experience für FAQ
...
Nur Kunden, die die [!DNL Adobe Business Platform] / [!DNL Adobe Admin Console] kann auf [!DNL Adobe Unified Experience]. Kunden, die noch nicht migriert wurden, sehen die [!DNL Workfront only] Erlebnis ohne die Möglichkeit, zwischen [!DNL Adobe] Anwendungen.
...
Bestehende Kunden werden kontaktiert, um Migrationen zu planen. Die Mitarbeiter des Migrationsteams führen die Kunden durch den Prozess und beraten Sie bei [!DNL Admin Console] und Links zur Dokumentation bereitstellen, die erforderlich sind, um den Umstieg so einfach und unkompliziert wie möglich zu gestalten.
...
* [[!DNL Adobe Business Platform] and [!DNL Admin Console] FAQs](https://experienceleague.adobe.com/docs/customer-one/using/workfront/faq.html)
...
Einmal [!DNL Workfront] wird als [!DNL Admin Console] -Anwendung verwenden, sollten Sie nichts anderes tun müssen für [!DNL Workfront] , um die vorhandene SSO-Einrichtung zu nutzen, für die Sie [!DNL Adobe Assets].
...
Die Anmelde-URL ändert sich. Die alte URL leitet jedoch zur neuen Anmelde-URL um, daher sollten Sie Ihre Benutzer umschulen, wohin sie gehen sollen.
...
**Gibt es eine Zeit, in der die Umleitungen deaktiviert sind? Oder können wir immer my.company.workfront.com eingeben?**

Sie können immer benutzerdefinierte URLs verwenden. Nachdem Sie auf einen dieser Links geklickt haben, werden Sie zu [!DNL Workfront] und eine andere URL anzeigen. Es ist jedoch besser [!DNL experience] , um sich bei &quot;experience.adobe.com&quot;anzumelden, und Lesezeichen-Links von [!DNL Experience Cloud]. Weniger Umleitung entspricht weniger Verzögerung/Ladezeit.
...
**Werden wir zu [!DNL Experience Cloud] global oder können wir für bestimmte Nutzer auswählen (nicht alle unsere Adobe-Produkte)?**
...
**Ändert sich die Anmeldung für [!DNL Workfront] Mobilbenutzer?**
