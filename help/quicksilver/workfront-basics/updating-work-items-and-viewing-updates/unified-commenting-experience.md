...
Informationen darüber, welche Objekte den Abschnitt &quot;Aktualisierungen&quot;enthalten, finden Sie unter [Übersicht über die Updates-Registerkarte](../../workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md).

Obwohl derzeit nur in Adobe Workfont-Zielen implementiert, wird dieses neue Erlebnis schließlich dazu führen, dass Kommentare in Adobe Workfront und darüber hinaus in der gesamten Adobe Experience Cloud vereinheitlicht werden.
