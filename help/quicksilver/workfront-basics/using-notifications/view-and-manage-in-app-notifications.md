...
1. Klicken Sie auf das nummerierte Symbol ![](assets/notifications-icon-jewel.jpg) in der oberen rechten Ecke von [!DNL Workfront], um Ihre Benachrichtigungsliste zu öffnen.
   ...
   * Benachrichtigungen bezüglich Mitteilungen werden durch das Symbol [!UICONTROL Mitteilungen] gekennzeichnet. ![](assets/announcement.png)
...
1. Klicken Sie auf die Benachrichtigung, die Sie anzeigen möchten:
   ...
   * Wenn die von Ihnen angeklickte Benachrichtigung für eine Mitteilung ![](assets/announcement.png) bestimmt wird, wird die Seite **[!UICONTROL Mitteilungen]** mit einer Liste aller Mitteilungen angezeigt. Die Mitteilung, auf die Sie geklickt haben, wird links und rechts angezeigt.
