   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>Ihnen übermittelte Genehmigungen. </p> <p>Weitere Informationen zur Genehmigung von Elementen finden Sie unter <a href="../../../review-and-approve-work/manage-approvals/approving-work.md" class="MCXref xref">Genehmigen von </a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
