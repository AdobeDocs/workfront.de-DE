...
Die [!UICONTROL Arbeitsliste] Mit Filter können Sie Ihren Fokus auf bestimmte Arbeitselemente beschränken.

Die folgenden Beispiele zeigen, wie Sie Elemente filtern können, die Sie auf der Startseite anzeigen:
...
>[!NOTE]
>
>Alle Arbeitselemente, die hinzugefügt werden [!UICONTROL Meine Priorität] sind nur für Sie sichtbar und niemand kann die Arbeit für Sie priorisieren.

Weitere Informationen zur Verwendung von [!UICONTROL Meine Priorität], siehe [Priorisieren Sie die Arbeit im [!UICONTROL Startseite] area](../../../workfront-basics/using-home/using-the-home-area/prioritize-work-in-home.md).
...
Verfolgen Sie die Stunden, die Sie an einzelnen Arbeitselementen gearbeitet haben. Sie können einen allgemeinen Stundentyp auswählen, z. B. [!UICONTROL Task Time]oder Sie können einen projektspezifischen Stundentyp auswählen, der von Ihrem [!DNL Workfront] Administrator.

Weitere Informationen zur Protokollzeit finden Sie unter [!UICONTROL Startseite] -Bereich, siehe Abschnitt [Startseite](../../../timesheets/create-and-manage-timesheets/log-time.md#home) im Artikel [Protokollzeit](../../../timesheets/create-and-manage-timesheets/log-time.md).
