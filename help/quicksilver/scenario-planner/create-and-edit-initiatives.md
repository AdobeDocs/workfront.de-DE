...
<source xml:lang="en-US"><ph id="1" ctype="x-IMAGE">![</ph>Move initiative on timeline<ph id="2" ctype="x-IMAGE">](assets/move-initiative-back-and-forth-on-the-timeline-350x71.png)</ph></source>
...
<source xml:lang="en-US"><ph id="1" ctype="x-IMAGE">![</ph>Today indicator<ph id="2" ctype="x-IMAGE">](assets/today-indicator-350x160.png)</ph></source>
...
<source xml:lang="en-US"><ph id="1" ctype="x-IMAGE">![</ph>Initiative details panel<ph id="2" ctype="x-IMAGE">](assets/initiative-details-panel-multiple-months-350x626.png)</ph></source>
<target xml:lang="en-XX"><ph id="1" ctype="x-IMAGE">![</ph>Bedienfeld „Initiativen-Details“<ph id="2" ctype="x-IMAGE">](assets/initiative-details-panel-multiple-months-350x626.png)</ph></target>
</trans-unit>
...
<target xml:lang="en-XX"><bpt id="1" ctype="x-span">&lt;span></bpt>Je nachdem, ob der Plan für die Verwendung von FTEs oder Stunden eingerichtet wurde, <ept id="1">&lt;/span></ept> die Anzahl der für diese Initiative benötigten Aufgabengebiete für jeden <ept id="2">&lt;/span>&lt;/span></ept><bpt id="4" ctype="x-span">&lt;span></bpt> in FTE <span><span> Stunden pro Monat in die Initiative aufgenommen</span>. <bpt id="5" ctype="x-span">&lt;span></bpt>Die ersten drei Monate der Initiative werden standardmäßig angezeigt.<ept id="5">&lt;/span></ept></target>
</trans-unit>
...
<source xml:lang="en-US">(Optional) Hover over the name of a job role, then click the <ph id="1" ctype="x-STRONG_EMPHASIS">**[!UICONTROL </ph>trash can icon<ph id="3" ctype="x-LINK_REF">]**</ph> <ph id="5" ctype="x-IMAGE">![</ph>Delete icon<ph id="6" ctype="x-IMAGE">](assets/delete.png)</ph> to remove it from the initiative.</source>
<target xml:lang="en-XX">(Optional) Bewegen Sie den Mauszeiger über den Namen eines Aufgabengebiets und klicken Sie dann auf das <ph id="1" ctype="x-STRONG_EMPHASIS">**[!UICONTROL </ph>Papierkorbsymbol<ph id="3" ctype="x-LINK_REF">]**</ph> <ph id="5" ctype="x-IMAGE">![</ph>Löschsymbol<ph id="6" ctype="x-IMAGE">](assets/delete.png)</ph>, um es aus der Initiative zu entfernen.</target>
</trans-unit>
