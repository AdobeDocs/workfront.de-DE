...
Sie können die agile Funktionalität für Ihr Projekt ohne die administrativen Herausforderungen nutzen, die normalerweise mit agilen Vorgehensweisen einhergehen (z. B. Verwaltung des Team-Rückstands, Erstellung von Iterationen usw.). Weitere Informationen finden Sie unter [Verwalten Sie ein Projekt im [!UICONTROL Agile] Ansicht](../../manage-work/projects/manage-projects/manage-projects-in-agile-view.md).
