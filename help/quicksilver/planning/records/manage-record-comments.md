...
# Verwalten von Kommentaren zu Einträgen
...
1. Fügen Sie **@** hinzu, gefolgt vom Namen eines Benutzers oder Teams, um sie in der Aktualisierung zu taggen. Weitere Informationen finden Sie im Abschnitt [Überlegungen zum Kommentieren eines Datensatzes](#considerations-about-commenting-on-a-record) in diesem Artikel.
...
1. Klicken Sie **Senden**, um den Kommentar aufzuzeichnen.
   ...
   Jeder, der über Anzeigeberechtigungen für den Datensatztyp verfügt, kann in der Tabellenansicht **Datensatzes, dem** Kommentar hinzugefügt haben, einen Indikator „Neuer Kommentar sehen.
...
## Überblick über den Abschnitt „Verlauf“
