...
<tr>
   ...
   ODER
   <li> Tragen Sie Berechtigungen oder höhere Berechtigungen zu einem Arbeitsbereich und einem Datensatztyp bei und verwalten Sie Berechtigungen zu einem Datensatz, um Datensätze zu verbinden oder zu trennen</a></li></ul> 
