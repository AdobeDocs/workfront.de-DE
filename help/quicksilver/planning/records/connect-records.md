...
>[!IMPORTANT]
>
>Sie müssen über eine Adobe Experience Manager-Lizenz verfügen und die Workfront-Instanz Ihres Unternehmens muss in die Adobe Business Platform oder die Adobe Admin Console integriert sein, damit Sie Workfront-Planungsdatensätze mit Adobe Experience Manager verbinden können.
>
...
1. (Bedingt) Nachdem Sie den ausgewählten Datensatztyp mit Experience Manager-Objekten verbunden haben, wechseln Sie zum verbundenen Feld eines Datensatzes und klicken Sie entweder auf das Feld oder klicken Sie auf **Verbinden**, um dem Datensatz Experience Manager-Objekte hinzuzufügen, und klicken Sie dann auf das Symbol **+**.
   ...
   >[!TIP]
   >
   >  Sie können auf das Symbol **+** im Feld Verknüpftes Objekt auf der Detailseite des Datensatzes klicken, um Assets mit dem Datensatz zu verbinden.
