...
<tr>
   ...
   <td>
   <p>Zeigen Sie Berechtigungen oder höhere Berechtigungen für einen Workspace-<!--<span class="preview">and record type</span>--> an, wenn Sie ein Workfront-Benutzer sind</p> 
  </td>
  </tr>
<tr>
...
>[!NOTE]
>
>Nach den monatlichen Releases in der Produktion sind die in diesem Abschnitt beschriebenen Funktionen auch in der Produktionsumgebung für Kunden verfügbar, die schnelle Releases aktiviert haben.
