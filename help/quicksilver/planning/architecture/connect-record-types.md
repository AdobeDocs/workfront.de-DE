...
>[!IMPORTANT]
>
>Wenn Sie Planning-Datensatztypen mit Objekttypen aus anderen Anwendungen verbinden, müssen Sie auch über eine Lizenz und ein Konto für diese Anwendungen verfügen.
...
1. Nach einem Datensatztyp suchen oder einen der folgenden Typen auswählen:
   ...
   * Ein Datensatztyp aus einem anderen Arbeitsbereich, der für die Verbindung von anderen Arbeitsbereichen konfiguriert wurde.
     ...
     >[!TIP]
     >
     >Sie können die folgende Tastaturkombination verwenden, um das globale Suchfeld von einer beliebigen Workfront-Planungsseite aus zu öffnen und nach Datensatztypen zu suchen:
     >
     >* STRG+K für Windows
     >* ⌘+K für Mac
     >
   ...
   * **Experience Manager** aus dem Abschnitt **Adobe-**, um eine Verbindung zu AEM Assets oder Inhaltsfragmenten herzustellen.

     ![AEM Assets-Verbindungsauswahl](assets/aem-assets-connection-selection-041326.png)
...
1. (Bedingt) Wenn Sie eine Verbindung zu Experience Manager herstellen möchten, wählen Sie ein Repository aus dem Dropdown-Menü **Experience Manager** im Abschnitt **Verknüpfen von Assets aus dem folgenden Repository** aus. Dies ist ein Pflichtfeld. In diesem Feld werden nur Repositorys angezeigt, auf die Sie in Experience Manager Zugriff haben.
