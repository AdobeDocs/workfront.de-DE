---
title: Adobe Workfront - Planung der Release-Aktivität für 2024
description: Adobe Workfront-Planungsfunktionen stehen derzeit allen Kunden zur Verfügung. Sie müssen zusätzlich zu einer Workfront-Lizenz eine Workfront Planning-Lizenz erwerben, um auf diese Funktionen zugreifen zu können.
author: Alina
...
# Adobe Workfront - Planung der Release-Aktivität für 2024
...
In diesem Artikel werden die Funktionen aufgelistet, die während der frühen Zugriffsphase 2024 für Workfront Planning veröffentlicht wurden.
...
Weitere für die Workfront-Planung veröffentlichte Funktionen finden Sie in den folgenden Artikeln:

* [Adobe Workfront-Planungs-Release-Aktivität für 2023](/help/quicksilver/planning/general/release-activity-archives-2023.md) für Funktionen, die während der Beta-Version 2023 veröffentlicht wurden.
* [Adobe Workfront-Planungs-Release-Aktivität: Artikelindex](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md) für Funktionen, die derzeit für die Workfront-Planung veröffentlicht wurden, nachdem diese am 28. August 2024 allgemein verfügbar gemacht wurde.

## Veröffentlichungszeitplan für die Workfront-Planung

Die folgende Tabelle zeigt den Zeitplan der Veröffentlichung von Workfront Planning, beginnend mit der Betaverfügbarkeit im Jahr 2023:
...
Workfront Planning steht allen Kunden zur Verfügung, die zusätzlich zu ihrer Workfront-Lizenz eine Workfront Planning-Lizenz erworben haben. Weitere Informationen zum Kauf von Workfront Planning erhalten Sie von Ihrem Kundenbetreuer.

Informationen zu Funktionen, die nach dem 28. August 2024 für die Workfront-Planung veröffentlicht wurden, finden Sie unter [Adobe Workfront Planning release activity: article index](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md).

### Die Workfront-Planung ist jetzt in der Vorschau verfügbar

Vorschau: 28. August 2024

Mit der Veröffentlichung von Workfront Planning zur allgemeinen Verfügbarkeit sind die Workfront-Planungsfunktionen jetzt in der Vorschau-Umgebung enthalten.

### Neue Adobe Workfront-Planungspakete und Objektbeschränkungen

Vorschau und Produktion: 28. August 2024

Wir haben neue Einschränkungen für Workfront Planning-Objekte implementiert, die den beiden folgenden Packages entsprechen:

* Die Workfront-Planung bietet Ihnen Folgendes:

   * Unbegrenzte Arbeitsbereiche

   * 25.000 Datensätze pro Arbeitsbereich

   * 500.000 Datensätze für Ihre Instanz

* Mit Workfront Planning Plus haben Sie folgende Möglichkeiten:

   * Unbegrenzte Arbeitsbereiche

   * 500.000 Datensätze pro Arbeitsbereich

   * 2 Millionen Datensätze für Ihre Instanz.

Weitere Informationen finden Sie unter [Übersicht über die Objektbegrenzung bei der Adobe Workfront-Planung](/help/quicksilver/planning/general/limitations-overview.md).

### Aktivieren von Workfront-Planbenachrichtigungen für Zugriffsanfragen
...
### Format für Formelfeldwerte definieren

Vorschau und Produktion: 28. August 2024

Als Workspace-Manager können Sie jetzt das Format für die in einem Formelfeld angezeigten Werte definieren. Sie können aus den folgenden Formaten wählen:
...
### Echtzeit-Präsenz-Indikatoren in einer Datensatzansicht

Vorschau und Produktion: 28. August 2024

Um zu verstehen, welche Informationen von anderen Benutzern bei der Bearbeitung einer Ansicht bearbeitet werden, haben wir für diesen Bereich der Workfront-Planung Echtzeitpräsenzindikatoren eingeführt.

Das von einem anderen Benutzer bearbeitete Feld wird jetzt in der Tabellenansicht hervorgehoben, und die Avatare anderer Benutzer sind für Sie in der oberen rechten Ecke aller Ansichten sichtbar.
...
### Erstellen von Datensätzen durch Senden einer Anforderung

Vorschau: 21. August 2024

Produktion: 28. August 2024

Sie können jetzt Datensätze erstellen, indem Sie eine Anfrage an ein Anforderungsformular senden, das mit einem Datensatztyp verknüpft ist.

Dieses Update beinhaltet die folgenden Funktionen:
...
Mit der Veröffentlichung der öffentlichen API von Workfront Planning können Sie jetzt auf Planungsdatensätze in externen Feldern in benutzerdefinierten Workfront-Formularen verweisen.
...
### Neues Menü &quot;Einstellungen&quot;in der Kalenderansicht

Vorschau und Produktion: 28. August 2024

Es gibt eine neue Option Einstellungen , mit der Sie das Erscheinungsbild der Datensatzbalken in der Kalenderansicht personalisieren können. Sie können Folgendes tun:

* Datum und Uhrzeit der Datensätze aktualisieren

* Aktualisieren des Balkenstils

* Ändern Sie die Farbe der Datensatzbalken oder ihrer Gruppierungen so, dass sie einer der folgenden Werte entsprechen:
...
Weitere Informationen zum Workfront Planning AI Assistant finden Sie unter [Übersicht über den Adobe Workfront Planning AI Assistant - Übersicht](/help/quicksilver/planning/general/planning-ai-assistant-overview.md).
...
### Wichtige Seitenverbesserungen für die Workfront-Planung

Produktion: 20. August 2024

Vorschau: zu bestimmen

Die Hauptseite des Planungsbereichs wurde wie folgt verbessert:

* Für Systemadministratoren wurden die nicht erstellten Arbeitsbereiche von der Registerkarte &quot;Andere Arbeitsbereiche&quot;in die Registerkarte &quot;Arbeitsbereiche, in denen ich mich befinde&quot; verschoben. Die Registerkarte &quot;Meine Arbeitsbereiche&quot;wurde entfernt.

* Für jede Workspace-Karte wurde ein Menü &quot;Mehr&quot;hinzugefügt, um das Bearbeiten oder Löschen des Arbeitsbereichs auf der Hauptseite zu vereinfachen.

* Es wurden die Links &quot;Alle anzeigen&quot;und &quot;Weniger anzeigen&quot;hinzugefügt, um die Anzahl der Arbeitsbereiche zu steuern, die auf der Hauptseite angezeigt werden. Wenn mehr als zwei Zeilen mit Workspace-Karten auf der Hauptseite aufgelistet sind, wird der Link Alle anzeigen angezeigt, damit Sie alle Arbeitsbereiche nur bei Bedarf anzeigen können.
...
### Datensatztypen über mehrere Arbeitsbereiche hinweg verbinden
...
Systemadministratoren können jetzt Datensatztypen so konfigurieren, dass sie von anderen Arbeitsbereichen aus verbunden werden. Danach kann ein Workspace-Manager von einem festgelegten Arbeitsbereich oder von allen Arbeitsbereichen im System aus eine Verbindung zu diesen Datensatztypen herstellen.

Vor dieser Verbesserung konnten Sie nur Datensatztypen, die zum selben Arbeitsbereich gehörten, sowie Objektarten aus anderen Anwendungen verbinden.
...
### Anzeige verbundener Datensätze in der Timeline-Ansicht mithilfe der Aufschlüsselungsfunktion

Produktion: 22. August 2024

Vorschau: zu bestimmen

Als Manager der Timeline-Ansicht können Sie jetzt die Beziehungen zwischen verbundenen Datensätzen anzeigen, indem Sie Datensätze in visuellen Hierarchien in der Timeline-Ansicht aufschlüsseln.

Wenn Sie beispielsweise Kampagnen in der Timeline-Ansicht anzeigen, die mit Produkten verknüpft sind und Produkte mit Projekten verknüpft sind, können Sie jetzt Produkte unter Kampagnen und Projekte unter den jeweiligen Produkten anzeigen.

Auf diese Weise können Sie innerhalb derselben Timeline-Ansicht nahtlos durch mehrere Ebenen von Beziehungen navigieren.

Dies ist keine tatsächliche Hierarchie (kein Objekt ist höher als ein anderes). Es handelt sich dabei um eine visuelle Hierarchie, in der verbundene Datensatztypen in einer Timeline-Ansicht angezeigt werden.

Sie können bis zu fünf Ebenen von Datensatztypen in derselben Timeline für einen Datensatz anzeigen.
...
### Neue Registerkarte Verbindungen im Bereich mit Datensatzdetails

Produktion: 22. August 2024

Vorschau: zu bestimmen

Eine neue Registerkarte wurde zur Datensatzvorschau und zu den Seitenbereichen hinzugefügt. Wenn Sie nun in einer Ansicht auf den Datensatznamen klicken, werden die folgenden Registerkarten in der Vorschau des Datensatzes und auf der Datensatzseite angezeigt:

* **Details**: Zeigt alle Datensatzfelder, Miniaturen und Titelbilder an. Sie können Felder auf der Registerkarte Details bearbeiten.

* **Verbindungen**: Zeigt alle Datensätze oder Objekttypen und die zugehörigen Datensätze oder Objekte an. Über den Tab Verbindungen können weitere Datensätze hinzugefügt werden.

Weitere Informationen finden Sie unter [Datensätze verbinden](/help/quicksilver/planning/records/connect-records.md).

### Erstellen von Datensätzen, Projekten und Portfolios während der Verbindung
...
Wenn Sie beispielsweise Workfront Planning-Kampagnen mit Workfront-Projekten verbinden und feststellen, dass ein bestimmtes Projekt nicht vorhanden ist, können Sie es im Feld &quot;Verknüpfter Datensatz&quot;als neues Projekt hinzufügen. Das Projekt wird dann zu Workfront hinzugefügt. Neu hinzugefügte Datensätze werden ihren jeweiligen Datensatztypseiten in der Tabellenansicht hinzugefügt.

Derzeit können Sie beim Verbinden von Datensätzen Folgendes erstellen:
...
Sie können jetzt die Detailseite eines Datensatzes oder die Vorschau in ein Word-Dokument (.docx) exportieren.

Weitere Informationen finden Sie unter [Details eines Datensatzes exportieren](/help/quicksilver/planning/records/export-the-record-page.md).

### Optionen zum Verbindungstyp hinzufügen

Produktion: 22. August 2024
Vorschau: zu bestimmen

Wenn Sie jetzt eine Verbindung zwischen zwei Datensatztypen konfigurieren, können Sie festlegen, ob Benutzer einzelne oder mehrere Datensätze in jedem der Datensatztypen der Verbindung verbinden können. Dadurch wird sichergestellt, dass Sie die Workflows Ihres Teams zuverlässig entwerfen und sicherstellen können, dass Benutzer nur die erwarteten Informationen entsprechend ihren Prozessen auswählen.

Sie können jetzt aus den folgenden Verbindungstypen auswählen, wenn Sie zwei Datensatztypen verknüpfen:

* Viele zu viele. Wenn Sie diesen Verbindungstyp auswählen, können Sie ihn nach dem Speichern nicht mehr ändern.
* Eins-zu-viele
* Eins-zu-eins
* Viele zu eins.
...
* Wenn Datensatztypen mit Experience Manager-Assets verbunden werden
* Wenn Sie Datensatztypen verbinden, die nicht zum selben Arbeitsbereich gehören

Weitere Informationen finden Sie unter [Übersicht über die Verbindungstypen](/help/quicksilver/planning/architecture/connect-record-types-overview.md).

## Woche vom 12. August 2024

### AI-Assistent wurde vorübergehend entfernt

Produktion: 12. August 2024
Vorschau: zu bestimmen

Der Workfront AI-Assistent wurde vorübergehend entfernt und steht zu einem späteren Zeitpunkt zur Verfügung. Weitere Informationen zum AI-Assistenten finden Sie unter [Übersicht über den Adobe Workfront Planning AI Assistant](/help/quicksilver/planning/general/planning-ai-assistant-overview.md).

### Den zuletzt angezeigten Zeitrahmen in der Timeline-Ansicht beibehalten

Produktion: 14. August 2024

Vorschau: zu bestimmen

Wenn Sie jetzt eine Timeline-Ansicht öffnen und zu einem Datum in der Vergangenheit oder Zukunft scrollen, bleibt das ausgewählte Datum nach der Aktualisierung der Seite erhalten. Vor dieser Verbesserung wurde auf der Seite das aktuelle Datum angezeigt.
...
### Öffentliche Freigabe von Workfront-Planungsansichten

Produktion: 2. August 2024

Vorschau: zu bestimmen

Um nahtlos mit externen Stakeholdern zusammenzuarbeiten, können Sie jetzt Datensatzansichten mit anderen von außerhalb Ihres Unternehmens teilen. Sie können einen öffentlichen Link für die Ansicht freigeben, auf die andere Zugriff haben sollen.

Dieses Update beinhaltet die folgenden Funktionen:

* Geben Sie die Ansicht einer Seite vom Typ Datensatz mit einem öffentlichen Link frei, der an einem bestimmten Datum abläuft.

* Der freigegebene Link ist für einen begrenzten Zeitraum von jedem außerhalb Ihres Unternehmens zugänglich, entsprechend dem Ablaufdatum. Zum Anzeigen der freigegebenen Ansicht ist keine Anmeldung erforderlich.
...
### Öffnen Sie das verbundene Objekt direkt in Workfront

Produktion: 9. Juli 2024

Vorschau: zu bestimmen

Beim Zugriff auf Workfront-Objekte, die mit Datensätzen in der Workfront-Planung verbunden sind, wurde ein Schritt entfernt.

Wenn Sie nun im verknüpften Planungsdatensatz auf den Namen eines Workfront-Objekts klicken, öffnen Sie die Workfront-Objektseite. Vor dieser Verbesserung wurde eine schreibgeschützte Workfront-Planungsseite für das verbundene Workfront-Objekt geöffnet, von der aus Sie weiter zur Workfront-Objektseite navigieren können.

Weitere Informationen finden Sie unter [Datensätze verbinden](/help/quicksilver/planning/records/connect-records.md).

### Nur Benutzer mit einer Lizenz vom Typ Standard oder Plan können Ansichten erstellen

Produktion: 11. Juli 2024

Vorschau: zu bestimmen

Wir haben geändert, welche Arten von Benutzern Ansichten erstellen können. Jetzt können nur Benutzer mit einer Lizenz vom Typ Standard oder Plan Ansichten erstellen. Alle anderen Benutzer haben schreibgeschützten Zugriff auf Ansichten, die für sie freigegeben sind. Vor dieser Aktualisierung konnten Benutzer mit Light- und Worker-Lizenz Ansichten erstellen.
...
Sie können Datensätze nun in jeder Ansicht sortieren und gruppieren, indem Sie Suchfelder mit mehreren Werten verwenden, die nicht zusammengefasst sind. Vor dieser Verbesserung konnten Sie nur nach Suchfeldern sortieren und gruppieren, die zusammengefasst wurden.
...
* Die Timeline wird basierend auf dem ersten Datumswert erstellt.
...
Um Ihr Erlebnis in der Datensatztabellenansicht zu verbessern und zu beschleunigen, haben wir die Möglichkeit hinzugefügt, ein neues Feld zwischen zwei Spalten hinzuzufügen, indem wir es rechts oder links von einer existierenden einfügen.
...
Wir haben das Erscheinungsbild der Detailseite der Datensätze aktualisiert. Im Rahmen dieser Aktualisierung wurden die Feldsymbole entfernt.

Weitere Informationen finden Sie unter [Datensätze bearbeiten](/help/quicksilver/planning/records/edit-records.md).

### Aktualisierte Arbeitsbereichsvorlagen

Produktion: 17. Juni 2024

Vorschau: zu bestimmen

Das Erscheinungsbild und das Feld der Workspace-Vorlagenkarten wurden in der Workfront-Planung aktualisiert.

Dieses Update umfasst die folgenden Verbesserungen:

* Die Datensatztypen, die zu den einzelnen Vorlagen gehören, werden als Karten angezeigt.

* Die Marketing-Verwaltungsvorlage wurde entfernt. Wir haben die folgenden Vorlagen für die Marketing-Verwaltung hinzugefügt. Je nach Komplexität Ihrer Workflows wird empfohlen, die entsprechende Vorlage zu verwenden:
...
### Neues Erlebnis beim Hinzufügen einer Miniaturansicht oder eines Titelbilds zu einem Datensatz
...
* Sie können eine Bildergalerie durchsuchen, um ein Bild für das Titelbild oder für die Miniaturansicht eines Datensatzes auszuwählen. Vor dieser Verbesserung konnten Sie nur Ihre eigene Bilddatei hochladen.
...
Der Titel der Detailseite eines Datensatzes zeigt das primäre Feld eines Datensatzes an. Vor dieser Aktualisierung wurde im Titel der Seite Details eines Datensatzes der Name des Datensatzes angezeigt. Sie können den Titel auf der Detailseite inline bearbeiten, es sei denn, das primäre Feld ist ein Feld vom Typ Formel .
...
### Link &quot;Mehr anzeigen/weniger anzeigen&quot;in den verbundenen Datensatzfeldern hinzufügen
...
### Bis zu 4-stufiger Verweis für Datensatzabfragefelder

Produktion: 12. Juni 2024

Vorschau: zu bestimmen

Sie können jetzt auf Felder verweisen, die bis zu vier Ebenen vom Datensatz entfernt sind, wenn Sie eine der folgenden Aktionen durchführen:
...
### Neue Landingpage für die Workfront-Planung

Produktion: 7. Juni 2024

Vorschau: zu bestimmen

Nachdem Sie im Hauptmenü auf Planung geklickt haben, stellen wir eine neue Landingpage für die Workfront-Planung vor.
...
* Wenn Sie Workfront-Administrator sind, werden die folgenden Registerkarten angezeigt:
   ...
   * Meine Arbeitsbereiche: Zeigt nur die von Ihnen erstellten Arbeitsbereiche an.

   * Andere Arbeitsbereiche: Zeigt Arbeitsbereiche an, die Sie erstellt haben oder die für Sie freigegeben wurden.

* Links zur Dokumentation und zu Veröffentlichungsaktivitäten für die Workfront-Planung

* Erste Schritte-Tutorial für die Workfront-Planung
...
### Neues Onboarding-Erlebnis für die Workfront-Planung

Produktion: 7. Juni 2024

Vorschau: zu bestimmen

Wenn neue Benutzer zum ersten Mal auf die Workfront-Planung zugreifen, werden sie jetzt durch ein selbstbestimmtes Onboarding-Tutorial begrüßt, das sie durch einfache Aufgaben und die Definition der Hauptkonzepte der Lösung führt.

Sie können den Onboarding-Prozess durchlaufen, die Aufgaben abschließen oder minimieren und später erneut aufrufen.

## Woche vom 27. Mai 2024

### Einführung in den UNIQUE-Datenaggregations-Operator für Suchfelder

Produktion: 27. Mai 2024

Vorschau: zu bestimmen

Beim Aggregieren von Suchfeldwerten wurde der UNIQUE -Operator hinzugefügt.

Der UNIQUE-Operator entfernt Duplikate aus den Suchfeldwerten und zeigt nur einen eindeutigen Wert an. Wenn Sie beispielsweise mehrere verbundene Datensätze hinzufügen und die Werte eines Lookup-Felds zwischen mehreren Datensätzen identisch sind, zeigt Workfront nur einen der Werte im Suchfeld des ursprünglichen Datensatzes an.

Der UNIQUE-Operator ist für alle Feldtypen mit Ausnahme der folgenden verfügbar:
...
Das Erscheinungsbild des Symbols für den Planungsbereich im Hauptmenü wurde aktualisiert. Weitere Informationen finden Sie unter [Übersicht über die Adobe Workfront-Planung](/help/quicksilver/planning/general/planning-overview.md).
...
### Verbinden von Workfront-Planungsprotokollen mit Workfront-Objekten im Bereich &quot;Planung&quot;
...
Einen Überblick über die Adobe Workfront-Planung finden Sie unter [Übersicht über die Adobe Workfront-Planung](/help/quicksilver/planning/general/planning-overview.md).
...
Sie können jetzt Informationen in der Kalenderansicht filtern. Weitere Informationen finden Sie unter [Kalenderansicht verwalten](/help/quicksilver/planning/views/manage-the-calendar-view.md).
...
Um mit allen anderen Systembereichen konsistent zu sein und in der Lage zu sein, jede Ansicht zu verwalten und zu steuern, die Ihnen als Systemadministrator zur Verfügung steht, verfügen Sie jetzt über Verwaltungsberechtigungen für alle Ansichten, die für Sie auf der Seite mit dem Datensatztyp freigegeben sind. Vor dieser Verbesserung hatten Ansichtsersteller Ihnen möglicherweise die Berechtigung zum Anzeigen oder Verwalten der Ansicht erteilt. Wenn die Ansicht nun für Sie freigegeben ist und Sie Systemadministrator sind, verfügen Sie standardmäßig über die Berechtigung &quot;Verwalten&quot;für die Ansicht.
...
* Contribute: Benutzer können Datensätze im für sie freigegebenen Arbeitsbereich erstellen, bearbeiten oder löschen.  Sie können keine für sie freigegebenen Datensatztypen oder Arbeitsbereiche erstellen oder bearbeiten.
