...
# Bearbeiten von Einstellungen für Felder
...
* Sie können die Konfiguration der folgenden Feldelemente bearbeiten, nachdem Sie das Feld gespeichert haben:
   ...
   * Die Optionen eines Einzelauswahl- oder Mehrfachauswahl-Felds <!--<span class="preview">and their default choices</span>-->.
...
1. Fügen Sie das Einzel- oder Mehrfachauswahlfeld, dem Sie eine Auswahl hinzufügen möchten, in der Tabellenansicht als neue Spalte hinzu.
