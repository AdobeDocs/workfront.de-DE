...
Weitere Informationen zum Verwalten der aktuellen Arbeit und der Planung für die künftige Arbeit mit Enhanced Analytics finden Sie unter [Verbesserte Lernpfade für Analysen](https://one.workfront.com/s/enhanced-analytics-program).
...
* Bitten Sie Ihren Workfront-Administrator, Ihrer Layoutvorlage erweiterte Analysen hinzuzufügen.
  ...
  Weitere Informationen finden Sie unter [Erweiterte Analyse: Hinzufügen von Analysen zu Layoutvorlagen](https://one.workfront.com/s/managed-content-videos/enhanced-analytics-adding-analytics-to-layout-templates-MCH7URDSIXRREHHHF7TRTYYP2LTE).
...
* Sie verfügen über Anzeigeberechtigungen für bestimmte Aufgaben und/oder Projekte.
  ...
  Informationen zum Anfordern von zusätzlichem Zugriff finden Sie unter [Anfordern des Zugriffs auf Objekte](../workfront-basics/grant-and-request-access-to-objects/request-access.md).
...
* Geplante Stunden
  ...
  >Weitere Informationen finden Sie im Abschnitt [Ansicht der Dauer](#duration-view) in diesem Artikel.
...
* Arbeitstage:
  ...
  >[!NOTE]
  >
  >8 Stunden ist die Standardnummer für **Typische Stunden pro Arbeitstag**. Ein Adobe Workfront-Administrator kann die Einstellung **Normalzeit pro Arbeitstag** unter **Einrichtung** > **Projekteinstellungen** > **Projekte** > **Zeitpläne** aktualisieren.\
...
Informationen zur geplanten Dauer finden Sie unter [Überblick über die Projektdauer](../manage-work/projects/planning-a-project/project-duration.md).
...
| **Enter** | Öffnen Sie das Kalender-Widget, löschen Sie einen vorhandenen Filter, öffnen Sie die Filteroptionen hinzufügen, aktivieren/deaktivieren Sie die Filterwerte, wenden Sie einen erstellten Filter an, öffnen Sie die Exportoptionen für jede Visualisierung, öffnen Sie die Dropdown-Menüs für die Dropdown-Liste der Dropdown-Menüs für die Dropdown-Liste, Aufgaben während des Fluges und Projekt-Treemap-Visualisierungen |
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td><a href="../enhanced-analytics/use-enhanced-analytics-filters.md" class="MCXref xref">Filter in Enhanced Analytics anwenden</a> </td> 
  ...
  <tr> 
   <td><a href="../enhanced-analytics/understand-enhanced-analytics-kpis.md" class="MCXref xref">Erweiterte Analyse-KPIs verstehen</a> </td> 
  ...
  <tr> 
   ...
   <td> <p>Die Visualisierung <b>Flugplan</b> zeigt Ihnen, dass sich die Bedingung während der Lebensdauer eines Projekts geändert hat. Durch die Interaktion mit der Visualisierung erhalten Sie weitere Details zu bestimmten Daten. Wenn Sie ein Projekt auswählen, werden die Niederlassung und Aufgaben in den Flugvisualisierungen geöffnet.</p> </td> 
  </tr> 
  <tr> 
   <td><a href="../enhanced-analytics/burndown-overview.md" class="MCXref xref">Anzeigen der Aufschlüsselungsvisualisierung in der erweiterten Analyse</a> </td> 
   <td> <p>Die Visualisierung <b>Aufschlüsselung</b> zeigt die geplante Geschwindigkeit eines Projekts in Bezug auf die tatsächliche aufgewendete Zeit an. Durch die Interaktion mit der Visualisierung erhalten Sie weitere Details zur Bedingung des Projekts an einem bestimmten Datum.</p> </td> 
  </tr> 
  <tr> 
   <td><a href="../enhanced-analytics/tasks-in-flight-overview.md" class="MCXref xref">Anzeigen der Aufgaben in der Visualisierung des Fluges in Enhanced Analytics</a> </td> 
   <td> <p>Die Visualisierung <b>Aufgaben in Flug</b> zeigt Ihnen den Status jeder Aufgabe innerhalb eines Projekts. Durch die Interaktion mit der Visualisierung können Sie schnell und einfach Änderungen an einer Aufgabe vornehmen.</p> </td> 
  </tr> 
  <tr> 
   <td><a href="../enhanced-analytics/project-activity-overview.md" class="MCXref xref">Anzeigen der Visualisierung der Projektaktivität in Enhanced Analytics</a> </td> 
   <td> <p>Die Visualisierung <b>Projektaktivität</b> zeigt Ihnen eine Heatmap, die angibt, wann Benutzer einem Projekt zugewiesen sind, das sich bei Workfront angemeldet hat, den Aufgabenstatus in diesem Projekt geändert und Aufgaben in diesem Projekt abgeschlossen haben. Durch die Interaktion mit der Visualisierung können Sie diese Details für jeden Benutzer anzeigen. Sie können auch bestimmte Daten für diese Aktionen sowie die Anzahl der durchgeführten Aktionen anzeigen.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Die Visualisierung <b>Aktivität nach Team</b> zeigt Ihnen eine Heatmap, die angibt, wann sich Benutzer eines Startseiten-Teams bei Workfront angemeldet haben, den Status einer Aufgabe geändert und eine Aufgabe abgeschlossen haben. Durch die Interaktion mit der Visualisierung können Sie diese Details für jeden einzelnen Benutzer anzeigen. Sie können auch bestimmte Daten für diese Aktionen sowie die Anzahl der durchgeführten Aktionen anzeigen.</p> </td> 
  </tr> 
