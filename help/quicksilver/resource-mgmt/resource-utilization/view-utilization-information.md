  ...
  <tr> 
   ...
   <td> <p>Zugriff auf Folgendes anzeigen oder höher:</p> 
    <ul> 
     ...
     <li> <p>Programme</p> </li> 
     <li> <p>Finanzdaten, die den Zugriff auf die Ansicht von Kostensätzen und die Ansicht „Allgemeine Finanzen“ enthalten, wenn Sie Informationen nach Kosten anzeigen möchten</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
