...
1. Beginnen Sie mit der Eingabe des Namens eines Benutzers, den Sie im **Suchen in diesem Ressourcen-Pool** -Feld.\
   Oder\
...
1. Klicken Sie auf das Symbol &quot;x&quot;auf Benutzerebene, um einen Benutzer aus dem Ressourcen-Pool zu entfernen. Sie werden aus allen Listen entfernt, in denen sie angezeigt werden.\
   Oder\
   Um alle mit einer Auftragsrolle, Gruppe, Gruppe oder Firma verknüpften Benutzer zu entfernen, klicken Sie auf **Entfernen** auf der Ebene der Job-Rolle, der Gruppe, des Teams oder des Unternehmens. Dadurch werden alle mit dieser Auftragsrolle, Gruppe, Gruppe oder Firma verknüpften Benutzer aus dem Ressourcen-Pool entfernt.
