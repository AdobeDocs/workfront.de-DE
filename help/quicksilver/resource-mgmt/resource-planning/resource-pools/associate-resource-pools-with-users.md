...
1. Aktivieren Sie das Kontrollkästchen neben dem Namen eines Benutzers auf der Liste und klicken Sie dann auf **Bearbeiten**.
...
1. Geben Sie den Namen eines Ressourcenpools, den Sie mit dem Benutzer verknüpfen möchten, in das Feld **Ressourcenpools** ein und wählen Sie ihn dann aus der Liste aus.\
   ...
   ![Ressourcenpool zu Benutzer hinzufügen](assets/add-resource-pool-to-user.png)
