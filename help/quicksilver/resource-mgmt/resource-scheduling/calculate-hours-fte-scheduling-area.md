...
title: Konfigurieren der Berechnung der Ressourcenstunde und der FTE-Verfügbarkeit durch Workfront für den Planungsbereich
description: Der Adobe Workfront-Administrator bestimmt, wie Workfront die Ressourcenverfügbarkeit und Benutzerzuordnung auf Systemebene (unter Berücksichtigung der Stunden und der FTE-Verfügbarkeit) berechnet, wenn er Voreinstellungen für das Resource Management konfiguriert.
author: Alina
...
# Konfigurieren der Berechnung der Ressourcenstunde und der FTE-Verfügbarkeit durch Workfront für den Planungsbereich
...
Der Adobe Workfront-Administrator bestimmt, wie Workfront die Ressourcenverfügbarkeit und Benutzerzuordnung auf Systemebene (unter Berücksichtigung der Stunden und der FTE-Verfügbarkeit) berechnet, wenn er Voreinstellungen für das Resource Management konfiguriert.
...
* Wenn es Workfront gestattet, Ressourcen automatisch zuzuweisen, wie im folgenden Artikel beschrieben:

   * [Nicht zugewiesene Aufgaben und Probleme manuell in den Planungsbereichen zuweisen](../../resource-mgmt/resource-scheduling/manually-assign-items-scheduling-areas.md).
...
* Bei der Anzeige von Zuordnungsindikatoren, wie im folgenden Artikel beschrieben:

   * Der Abschnitt &quot;Zuweisungsindikatoren&quot;im Artikel  [Verwalten von Benutzerzuweisungen in den Planungsbereichen](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
