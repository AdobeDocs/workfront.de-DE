...
title: Installieren und Öffnen von  [!DNL Adobe Workfront for design and video]
...
1. Löschen Sie den Ordner, in dem die Domain für das Plug-in gespeichert ist.
   ...
   >[!TIP]
   >
   >Wechseln Sie in einer Mac zur Suche, drücken Sie **Befehlstaste+Umschalt+G**, navigieren Sie zu `~/Library/Application Support/Workfront` und löschen Sie dann den Ordner **Workfront**.
