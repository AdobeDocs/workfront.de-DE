...
## Installieren Sie die [!DNL Adobe Workfront for XD] plugin
...
1. Wann [!DNL Adobe Workfront for XD] in den Suchergebnissen angezeigt, klicken Sie auf **[!UICONTROL Get]**.
