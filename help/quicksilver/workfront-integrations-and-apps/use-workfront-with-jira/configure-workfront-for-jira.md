...
Durch Konfiguration [!DNL Workfront for Jira] Sie können:

* Definieren Sie die zu erstellenden Trigger [!DNL Jira] Elemente, wenn [!DNL Workfront] -Elemente erstellt werden.
...
1. Anmelden [!DNL Jira] as a [!DNL Jira] Administrator.
1. Klicken **[!UICONTROL Einstellungen]** im Hauptteil [!DNL Jira] Menü.
1. Klicken **[!UICONTROL Add-ons]** Klicken Sie auf **[!UICONTROL Verwalten von Add-ons]**.
...
1. Wählen Sie die **[!UICONTROL Trigger]** zur Konfiguration der automatischen Erstellung von [!DNL Jira] Elemente als neue [!DNL Workfront] -Elemente erstellt werden.

   Weitere Informationen zum Einrichten von Triggern für Workfront finden Sie unter [!DNL Jira] Workflow, siehe [Konfigurieren von Triggern für die automatische Verknüpfung von Elementen zwischen [!DNL Jira] und [!DNL Workfront]](#configure-triggers-for-automatically-linking-items-between-jira-and-workfront).
...
1. Wählen Sie die **[!UICONTROL Einrichtung]** Registerkarte zur Konfiguration der Synchronisierung von Feldern zwischen verknüpften Feldern [!DNL Jira] und [!DNL Workfront] Elemente.
   ...
   >[!NOTE]
   >
   >Nachdem Sie die Trigger und die Synchronisation der Felder zwischen den beiden Anwendungen definiert haben, können alle [!DNL Workfront] Benutzer, die Aufgaben oder Probleme erstellen können, können möglicherweise Trigger auf die Erstellung eines Elements in [!DNL Jira]. Der Benutzer kann ein Element erstellen, wenn die Kriterien für das Element, das er erstellt, mit den Triggern in [!DNL Jira], auch wenn der Benutzer über keine [!DNL Jira] Lizenz. Außerdem können [!DNL Jira] Der Benutzer kann sofort mit der Arbeit an [!DNL Jira] -Element und deren Aktualisierungen sind sichtbar in [!DNL Workfront], ohne dass sie [!DNL Workfront] Lizenz. Jegliche Aktualisierungen in [!DNL Workfront] sind auch auf der [!DNL Jira] Elemente.
...
* Die Integration ist unidirektional: Sie können nur Elemente in Triggern erstellen [!DNL Workfront] automatisch in [!DNL Jira]. Es ist nicht möglich, Elemente Trigger, die Sie in [!DNL Jira] automatisch in [!DNL Workfront].
...
1. Anmelden [!DNL Jira] als Systemadministrator.
1. Klicken **[!UICONTROL Einstellungen]** im Hauptteil [!DNL Jira] Menü.
...
1. Im **[!UICONTROL [!DNL Jira]Projekt]** ein, beginnen Sie mit der Eingabe des Namens eines [!DNL Jira] und klicken Sie dann auf , um es auszuwählen, wenn es in der Liste angezeigt wird.
   ...
   Wenn die [!DNL Jira] -Problem erstellt wurde, wird es in das hier angegebene Projekt eingefügt.

1. Wählen Sie eine **I[!UICONTROL Sicherungstyp]** aus dem Dropdown-Menü.

   Dies zeigt den in [!DNL Jira] wenn die Bedingungen dieses Triggers erfüllt sind, basierend auf Ihren Einstellungen für dieses spezifische Projekt in [!DNL Jira].
...
1. Anmelden [!DNL Jira] als Jira-Administrator.
1. Klicken **[!UICONTROL Einstellungen]** im Hauptteil [!DNL Jira] Menü.
1. Klicken **[!UICONTROL Add-ons]**, dann **[!UICONTROL Verwalten von Add-ons]**.
...
1. Im **[!UICONTROL Synchronisieren von Jira mit Workfront]** auswählen Sie die Felder, die Sie aktualisieren möchten in [!DNL Jira] wenn sie in Workfront aktualisiert werden.
   ...
   1. Wählen Sie aus, um eines der folgenden Felder zu synchronisieren [!DNL Workfront] nach [!DNL Jira]:
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>Die Beschreibung einer Aufgabe oder eines Problems in [!DNL Workfront] wird zur Beschreibung des Problems, mit dem es verknüpft ist [!DNL Jira].</td>
        </tr>
        <tr>
         ...
         <td><p>Dokumente, die an eine Aufgabe oder ein Problem in [!DNL Workfront] sind auch mit der Frage verbunden, mit der sie in Jira verbunden ist. Neue Dokumentversionen von [!DNL Workfront] werden als separate Dokumente zu Jira hinzugefügt und mit <i>_v&lt;version number=""&gt;</i> um die nummerierte Version in Workfront anzugeben. </p><p>Wenn beispielsweise der Name eines Dokuments in [!DNL Workfront] is <strong>Hauptanzeige</strong>und fügen Sie ihr eine neue Version hinzu in [!DNL Workfront], wird die neue Version in [!DNL Jira] als neues Dokument mit dem Namen <strong>Main Ad_v2</strong>.</p><p>Wichtig: <p>Beachten Sie beim Synchronisieren von Dokumenten Folgendes:</p>
           <ul>
            ...
            <li><p>Um einen Testversand aus einem Dokument zu erstellen, müssen Sie den Testversand in [!DNL Workfront]. </p><p>Weitere Informationen zur Erstellung eines Testversands finden Sie unter <a href="../../review-and-approve-work/proofing/creating-proofs-within-workfront/generate-proof-for-a-document.md#create" class="MCXref xref">Erstellen eines Testversands für ein vorhandenes Dokument </a>in <a href="../../review-and-approve-work/proofing/creating-proofs-within-workfront/generate-proof-for-a-document.md" class="MCXref xref">Erstellen eines Testversands für ein Dokument</a>.<br></p></li>
           </ul></p></td>
        </tr>
        <tr>
         <td role="rowheader">[!UICONTROL Geplantes Abschlussdatum]</td>
         <td><p>Das geplante [!UICONTROL Abschlussdatum] einer Aufgabe oder eines Problems in [!DNL Workfront] wird zum [!UICONTROL Fälligkeitsdatum] des Problems, mit dem es verknüpft ist in [!DNL Jira].</p><p>Hinweis: Stellen Sie sicher, dass <strong>[!UICONTROL Fälligkeitsdatum]</strong> on [!DNL Jira] Probleme, damit dieser Wert synchronisiert werden kann.</p></td>
        </tr>
       </tbody>
      </table>
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        <tr>
         ...
         <td>Die von Ihnen angegebenen Felder werden immer zwischen den verknüpften [!DNL Workfront] und [!DNL Jira] Elemente, wenn die Felder in aktualisiert werden [!DNL Jira]. </td>
        </tr>
        <tr>
...
1. Im **[!UICONTROL SONSTIGE]** auswählen, welche zusätzlichen Felder zwischen verknüpften Elementen aktualisiert werden sollen.
   ...
   1. Wählen Sie eine Option aus, um zu bestimmen, ob die angegebenen Felder **[!UICONTROL Immer]** oder **[!UICONTROL Nie]** aktualisieren [!DNL Jira] oder [!DNL Workfront] wenn sie geändert werden.
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        <tr>
         ...
         <td><p>Zeigt die [!DNL Workfront] Benutzerdefinierte Daten eines Elements im [!DNL Workfront] rechts.</p><p>Hinweis: Die Abschnitte Benutzerdefiniertes Formular werden im [!DNL Workfront] rechter Bereich mit der Zugriffsebene der [!DNL Workfront] Systemadministrator.</p></td>
        </tr>
        <tr>
        ...
        <tr>
         <td role="rowheader">[!UICONTROL Aktualisierung im [!DNL Workfront] Registerkarte "Aktualisierungen"zu Änderungen am Fälligkeitsdatum in [!DNL Jira]]</td>
        ...
        <tr>
         <td role="rowheader">[!UICONTROL Benutzer automatisch erstellen in [!DNL Workfront] wenn die [!DNL Jira] Der Benutzer verfügt nicht über eine [!DNL Workfront] account]</td>
...
### Elemente können nicht in erstellt werden [!DNL Jira] aufgrund von Trigger-Feldern, die mit &quot;[!UICONTROL konnte nicht gefunden werden]&quot;

#### Problem

Wenn ein Fehler bei der [!DNL Workfront for Jira] Anwendung, [!DNL Workfront] deaktiviert die Trigger zur Vermeidung weiterer Komplikationen. Wenn diese Trigger deaktiviert sind, werden sie als[!UICONTROL konnte nicht gefunden werden]&quot;.
...
* Deaktivierung der Synchronisierung von [!DNL Workfront]Voraussichtlicher Abschlussdatum in der Workfront &quot;[!UICONTROL Einrichtung]&quot; page
