...
description: Link [!DNL Jira] Probleme bei [!DNL Adobe Workfront] Aufgaben oder Probleme verwenden, können Ihre Benutzer Elemente in einer Anwendung aktualisieren und das Gegenstück zu diesem Element wird auch für die Benutzer aktualisiert, die in der zweiten Anwendung arbeiten.
author: Becky
...
Link [!DNL Jira] Probleme bei [!DNL Adobe Workfront] Aufgaben oder Probleme verwenden, können Ihre Benutzer Elemente in einer Anwendung aktualisieren und das Gegenstück zu diesem Element wird auch für die Benutzer aktualisiert, die in der zweiten Anwendung arbeiten.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!UICONTROL Problemname]</p> <p>Ein Kommentar zur Namensänderung wird der <strong>[!DNL Workfront]</strong> des [!DNL Jira] Problem. </p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL Problem oder Aufgabenbeschreibung]</td> 
   <td> <p> [!UICONTROL Problembeschreibung]</p> <p>Ein Kommentar zur aktualisierten Beschreibung wird der <strong>[!DNL Workfront]</strong> des [!DNL Jira] Problem.<br></p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>[!UICONTROL Attachments]</p> <p>Ein Kommentar zu den hochgeladenen Anlagen wird der <strong>[!DNL Workfront]</strong> des [!DNL Jira] Problem.<br></p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Ein Kommentar zur Änderung des [!UICONTROL Fälligkeitsdatums] in [!DNL Jira] wird der Registerkarte [!UICONTROL Updates] im Abschnitt [!DNL Workfront] Problem oder Aufgabe. </p> <p>Hinweis: Es werden keine Datumsänderungen am [!DNL Workfront] Problem oder Aufgabe. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Kommentare werden zur Registerkarte [!UICONTROL Updates] im [!DNL Workfront] Problem oder Aufgabe, wenn die <strong>[!UICONTROL Kommentare]</strong> im Bereich [!UICONTROL SYNCHRONISIEREN VON JIRA ZU WORKFRONT] der Registerkarte [!UICONTROL Setup] auf <strong>[!UICONTROL Immer]</strong>.</p> <p>Weitere Informationen zum Konfigurieren von Workfront-Einstellungen finden Sie unter [!DNL Jira], siehe <a href="../../workfront-integrations-and-apps/use-workfront-with-jira/configure-workfront-for-jira.md">Konfiguration [!DNL Workfront for Jira]</a>.</p> <p>Informationen zur Kommentierung von Elementen aus verknüpften [!DNL Jira] Probleme, siehe <a href="#comment-from-a-linked-jira-issue" class="MCXref xref">Kommentar aus einem Link [!DNL Jira] Problem</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Erweitern Sie die **[!UICONTROL Mehr]** Menü und klicken Sie **[!UICONTROL Protokollarbeit]**.
...
1. Fügen Sie weiterhin Informationen zu Ihrem Zeiteintrag hinzu, einschließlich einer **[!UICONTROL Arbeitsbeschreibung]** Klicken Sie auf **[!UICONTROL Protokoll]**.\
   Die Zeit wird zum **[!UICONTROL Arbeitsprotokoll]** des [!DNL Jira] -Element sowie der [!DNL Workfront] -Element.\
...
Sie können die Zeit nur auf die verknüpfte [!DNL Workfront] -Element aus [!DNL Jira] -Problem, ohne dieses Mal auf [!DNL Jira] Problem.
...
Wenn Sie einen Kommentar zu einer [!DNL Jira] -Element aus [!DNL Workfront] rechter Bereich in [!DNL Jira], wird der Kommentar auch zum [!UICONTROL Updates] des verknüpften Elements in Workfront.
