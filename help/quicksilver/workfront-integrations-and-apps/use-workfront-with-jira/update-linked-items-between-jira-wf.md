...
Sie können die Zeit aus dem [!DNL Jira] Problem nur für das verknüpfte [!DNL Workfront]-Element protokollieren, ohne diese Zeit für das [!DNL Jira] Problem aufzuzeichnen.
