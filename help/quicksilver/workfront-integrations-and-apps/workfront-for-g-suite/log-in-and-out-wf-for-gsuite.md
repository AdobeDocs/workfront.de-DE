...
title: Anmelden und Abmelden  [!DNL Adobe Workfront]  Google Workspace
description: In diesem Artikel wird beschrieben, wie Sie sich bei der  [!DNL Adobe Workfront for] Google Workspace-Integration anmelden oder daraus entfernen.
author: Becky
...
# Anmelden und Abmelden [!DNL Adobe Workfront for Google Workspace]
...
Bevor Sie sich bei [!DNL Workfront for Google Workspace] anmelden oder abmelden können, müssen Sie
...
1. Klicken Sie **[!UICONTROL Add]** on [!DNL Workfront for Google Workspace] auf „Anmelden“.
1. Geben Sie Ihre [!DNL Workfront] Domain-Adresse ein, z. B. *companyname.my.workfront.com*.
1. Befolgen Sie die Anweisungen, um sich bei [!DNL Workfront] anzumelden.

   >[!NOTE]
   >
   >* [!DNL Workfront] stellt mithilfe von OAuth 2.0 eine Verbindung zu [!DNL Google Workspace] her, einem sicheren Standard, der von den meisten Web-basierten Integrationen für die Authentifizierung und Autorisierung von Benutzern verwendet wird.
