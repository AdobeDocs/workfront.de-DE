...
Bevor Sie über [!DNL Google Workspace] auf [!UICONTROL Startseite]-Inhalte zugreifen können, müssen Sie
...
1. Klicken Sie im Bereich **[!UICONTROL Sortieren nach]** auf den Erweiterungspfeil ![](assets/dropdown-arrow.png) dann auf eine Option, um anzugeben, wie Sie Ihre Arbeitselemente gruppieren möchten, damit Sie die gewünschte finden können.
...
1. Klicken Sie auf den Erweiterungspfeil ![](assets/dropdown-arrow.png) die Gruppierung, die Sie anzeigen möchten.
   ...
   * ![](assets/document-icon.png) **Genehmigungen** zeigen den Namen des Anforderers, den Dokumentnamen und das Übermittlungsdatum an.
