...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[Beliebig, Pro, Unternehmen, Unternehmen] oder höher</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Adobe Workfront-Lizenz*</td> 
   <td> <p>[Anfrage, Überprüfung, Arbeit, Plan] oder höher</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Produkt</td> 
   <td>[Spezifische Produktinformationen angeben. Entfernen Sie diese Zeile, wenn die Funktion in Workfront vorhanden ist.]</td> 
  </tr> 
  <tr> 
   <td role="rowheader">Konfigurationen der Zugriffsebene*</td> 
   <td> <p>[Fügen Sie ggf. Konfigurationen der Zugriffsebene ein] <!--
  ...
  <tr> 
   ...
   <td> <p>[Erforderliche Berechtigungen einfügen und Objekt angeben] <!--
      <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
        Example: View access or higher on Documents 
      </MadCap:conditionalText>
     --></p> <p>Informationen zum Anfordern zusätzlicher Zugriffsberechtigungen finden Sie unter <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Anfordern von Zugriffsberechtigungen für Objekte </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
