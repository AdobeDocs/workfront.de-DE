...
* Produktankündigungen {#product-announcements}
   ...
   * Produktversionen {#product-releases}
      ...
      * Version Q1 2025 {#release-25-q1}
         ...
         * [2025 Q1 Administrator-Verbesserungen](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md)<!--* [2025 Q1 Boards enhancements](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-boards-enhancements.md)-->
         * [Verbesserungen der Dokumentenverwaltung in Q1 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-document-mgmt-enhancements.md)
         * [Verbesserungen für Q1 2025 - Startseite](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md)
         * [Verbesserungen bei Testsendungen in Q1 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-proofing-enhancements.md)
         * [Verbesserungen für Bericht und Dashboard im ersten Quartal 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-report-and-dashboard-enhancements.md)
         * [Weitere Verbesserungen während des Zeitrahmens der Version vom ersten Quartal 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-other-enhancements.md)
      ...
      * Version 4. Quartal 2024 {#release-24-q4}
         ...
         * [Verbesserungen der Dokumentenverwaltung im 4. Quartal 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-document-mgmt-enhancements.md)
         ...
         * [2024 - Verbesserungen für das 4. Quartal - Startseite](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-home-enhancements.md)
...
* Administration und Einrichtung {#administration-and-setup}
   ...
   * Benutzerverwaltung {#add-users}
      ...
      * Funktionsweise neuer Zugriffsebenen {#access-levels}
         ...
         * [Vergleich der Funktionen über Lizenzmodelle hinweg](/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/comparing-old-and-new-license-models.md)
...
* Adobe Workfront-Grundlagen {#basics}
   ...
   * Prioritäten {#priorities}
      ...
      * [Prioritäten: Bevorstehende Versionen](workfront-basics/priorities/priorities-upcoming-releases.md)
      * [Erste Schritte mit Prioritäten](workfront-basics/priorities/get-started-with-priorities.md)
      * [Anzeigen von Projekt- und Aufgabendetails in der Arbeitsliste &quot;Prioritäten&quot;](workfront-basics/priorities/view-task-project-details.md)
      ...
      * [Anpassen der Spalten der Arbeitsliste](/help/quicksilver/workfront-basics/priorities/customize-worklist-columns.md)
   ...
   * Startseite {#home}
      ...
      * Verwenden des Startbereichs {#use-home-area}
         ...
         * [Übersicht über Filter für Startseiten-Widgets](workfront-basics/using-home/using-the-home-area/widget-filter-overview-home.md)
         ...
         * [Erstellen von Arbeitselementen und Projekten aus dem Startbereich](workfront-basics/using-home/using-the-home-area/create-work-items-in-home.md)
...
* Berichterstellung {#reporting}
   ...
   * Workfront Data Connect {#data-lake}
      ...
      * [Leserkonto oder Verbindung für Snowflake erstellen](reports-and-dashboards/data-lake/create-a-reader-account.md)
...
* Überprüfen und Genehmigen von Arbeiten {#review-and-approve-work}
   ...
   * Asset- und Dokumentüberprüfung und -genehmigung {#document-reviews-and-approvals}
      ...
      * Asset- und Dokumentgenehmigungen einrichten und verwalten {#manage-asset-review-and-approval}
         ...
         * [Eine neue Dokumentversion hochladen und eine Genehmigung anfordern](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/upload-new-doc-version.md)
...
* Adobe Workfront-Planung {#adobe-workfront-planning}
   ...
   * Allgemeine Informationen zur Adobe Workfront-Planung {#adobe-workfront-planning-general-information}
      ...
      * [Best Practices für die Planung von Adobe Workfront](planning/general/planning-best-practices.md)
   ...
   * Adobe Workfront-Planungsprotokolle {#adobe-workfront-planning-records}
      ...
      * [Gelöschte Datensätze wiederherstellen](planning/records/restore-deleted-records.md)
      ...
      * [Erstellen von Objekten mit der Workfront-Planungs-Datensatzautomatisierung](/help/quicksilver/planning/records/create-wf-objects-using-planning-automations.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Erste Schritte mit Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      ...
      * [Arbeiten mit großen Dateien in Fusion](/help/quicksilver/workfront-fusion/get-started/fusion-large-files.md)
   ...
   * Workfront Fusion Apps und ihre Module {#fusion-apps-and-modules}
      ...
      * [Microsoft Dynamics 365-Module - Finanzen und Betrieb](workfront-fusion/apps-and-their-modules/dynamics-finance-operations-modules.md)
...
* [Übersicht über die Version des ersten Quartals 2025 - Test](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/release-overview-test.md)
