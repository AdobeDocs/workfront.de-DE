...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Zugriff auf das mit der Genehmigung verknüpfte Objekt anzeigen oder höher </p> <p>Informationen zum Anfordern von zusätzlichem Zugriff finden Sie unter <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Zugriff auf Objekte anfordern </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Klicken Sie auf **Projekt** Validierung in der Arbeitsliste.
...
Wenn Sie sich an eine Aufgabenvalidierung erinnern, kehrt die Aufgabe zum Status zurück, in dem sie sich vor dem Beginn des Genehmigungsprozesses befand.
...
1. Klicken Sie auf **Aufgabe** Validierung in der Arbeitsliste.
...
1. Klicken Sie auf **Problem** Validierung in der Arbeitsliste.
...
1. Klicken Sie auf **Datenblatt** Validierung in der Arbeitsliste.
...
1. Klicken Sie auf **Zugriffsanfrage** Validierung in der Arbeitsliste.
