...
1. (Bedingt) Führen Sie einen der folgenden Schritte aus:
   ...
   * So aktualisieren Sie die vorhandene Genehmigungsdelegierung: Ändern Sie die angezeigten Informationen und klicken Sie auf **Speichern**.

   * So stoppen Sie die bestehende Delegation: Klicken **Zuweisung beenden** Klicken Sie auf **Zuweisung beenden** zur Bestätigung.
