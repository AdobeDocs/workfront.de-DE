...
title: Herunterladen eines Testversands im Testversand-Viewer
description: Sie können Dateien von einem vorhandenen Testversand herunterladen. Kommentare und andere Informationen zum Testversand sind nicht im Download enthalten.
author: Courtney
...
Sie können Dateien von einem vorhandenen Testversand herunterladen. Kommentare und andere Informationen zum Testversand sind nicht im Download enthalten.
...
1. Klicken Sie in der Symbolleiste links neben dem Testversand-Viewer auf die Schaltfläche **Download** .\
   ![Proofing_viewer_toolbar_button_-_download.png](assets/proofing-viewer-toolbar-button---download.png)

1. Navigieren Sie zum Speicherort im Dateisystem, in den Sie den Testversand herunterladen möchten, und klicken Sie dann auf **Speichern**.
