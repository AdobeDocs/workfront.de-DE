...
1. Klicken Sie in der rechten unteren Ecke des Testversand-Viewers auf die **Einstellungen** Symbol.
...
1. Klicken Sie auf **Play** -Schaltfläche im Video, um die neue Geschwindigkeit zu testen.

## Video-Bild-für-Bild anzeigen

Für einen detaillierteren Blick auf den Videotest können Sie das Video von Bild zu Bild manuell überprüfen.

1. Wechseln Sie zum Projekt, zur Aufgabe oder zum Problem, das/das das Dokument enthält, und wählen Sie dann **Dokumente**.
1. Suchen Sie den gewünschten Testversand und klicken Sie auf **Offener Testversand**.

1. Klicken Sie unten im Testversand-Viewer auf das **Weiterleiten** und **Zurück** Pfeile, um das Video von Bild zu Bild zu überprüfen.
...
1. Halten Sie in der rechten unteren Ecke des Testversand-Viewers den Mauszeiger über die **Lautstärke** und ziehen Sie dann den Schieberegler, um eine neue Lautstärke auszuwählen.

   ![](assets/phq-viewer-volume.png)

   Oder

   Klicken Sie auf **Lautstärke** zum Stummschalten und Aufheben der Lautstärke.
