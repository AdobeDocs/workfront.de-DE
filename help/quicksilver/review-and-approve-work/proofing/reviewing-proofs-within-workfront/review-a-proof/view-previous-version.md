...
title: Anzeigen früherer Testversand-Versionen im Testversand-Viewer
description: Sie können eine frühere Version eines Testversands anzeigen, sofern vorhanden. Frühere Versionen sind standardmäßig gesperrt. Sie können keine Kommentare hinzufügen oder eine Entscheidung in einer gesperrten Version ändern.
author: Courtney
...
1. (Optional) Um die Version zu entsperren, wenn Sie möchten, dass Benutzer Kommentare hinzufügen oder eine Entscheidung ändern können, klicken Sie, sofern Sie dazu berechtigt sind, im linken Bereich auf das Symbol **Entsperren** und dann auf **Ja, entsperren**. Weitere Informationen finden Sie unter [Sperren oder Entsperren eines Testversands](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/lock-or-unlock-proof.md).
