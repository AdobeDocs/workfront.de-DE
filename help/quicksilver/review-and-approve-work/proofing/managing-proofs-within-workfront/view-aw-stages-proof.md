...
title: Anzeigen von Phasen eines automatisierten Workflows für einen Korrekturabzug
...
# Anzeigen von Phasen eines automatisierten Workflows für einen Korrekturabzug
...
1. Bewegen Sie in einer Dokumentliste, die das Dokument enthält, den Mauszeiger über die Zeile, die das Dokument enthält, und klicken Sie dann auf **Proofing-Workflow**.
   ...
   ![sbw-padlock-icon.png](assets/sbw-padlock-icon.png) Gesperrtes Stadium
