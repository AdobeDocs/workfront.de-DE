...
title: Anzeigen aktiver Bühnen auf einem Testversand
description: Sie können die aktuellen aktiven Phasen auf einem Testversand anzeigen, der einen automatisierten Workflow enthält.
author: Courtney
...
1. Bewegen Sie den Mauszeiger über das Dokument, das den Testversand enthält, den Sie anzeigen möchten, und wählen Sie dann **Testversand-Workflow** aus, um die Testsendungen anzuzeigen.
