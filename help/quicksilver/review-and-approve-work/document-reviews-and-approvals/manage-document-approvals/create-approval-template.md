...
1. Füllen Sie die Details für Schritt 1 von Pfad 1 aus:
   ...
   <tr class="preview">
   <td><span class="preview"><strong>Personen oder Teams in der Vorschau hinzufügen (optional)</strong></span></td>
    <td><span class="preview">Beginnen Sie mit der Eingabe eines Benutzernamens, Teams oder einer E-Mail-Adresse. Die Teilnehmer sind in Vorlagen optional. Sie können sie hinzufügen, wenn die Vorlage auf ein Dokument angewendet wird.<br>
