...
* [Aktualisierte App für iOS und Android (Anfang August 2017)](updated-mobile-app.md)
...
* [Kundinnen und Kunden mit den Clustern 1, 2 und 3 müssen alle IP-Blöcke der Zulassungsliste aktualisieren, um die Blockierung von Adobe Workfront-Services zu verhindern](clusters-1-3-update-whitelist.md)
* [Benutzerdefiniertes SMTP als Option für ausgehende E-Mails entfernen](remove-custom-smtp.md)
