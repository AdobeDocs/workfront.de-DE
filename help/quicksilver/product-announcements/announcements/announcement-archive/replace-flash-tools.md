...
Weitere Informationen zu Ersatzwerkzeugen finden Sie unter [Alte Flash-basierte Tools und deren Ersatz](#legacy-flash-based-tools-and-their-replacements) in diesem Artikel.
...
<table style="table-layout:auto"> 
 ...
 <thead> 
  <tr> 
   <th> <p><strong>Ältere Tools</strong> </p> </th> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p><strong>Ressourcenpool</strong> </p> <p>Neue Ressourcen-Pools sind eine Sammlung von Benutzern, die gleichzeitig für die Fertigstellung des Projekts benötigt werden. Workfront ist sich auch bewusst, dass spezialisierte Benutzer in bestimmten Fällen getrennt arbeiten müssen. Aus diesem Grund können Sie jetzt Benutzer anstelle von Jobrollen einplanen. </p> Die Vorteile des Ressourcen-Pools gegenüber den alten Ressourcen-Pools umfassen Folgendes: 
    <ul>
  ...
  <tr> 
   ...
   <td> <p><strong>Nutzungsbericht</strong> </p> <p>Der integrierte Nutzungsbericht zeigt geplante, budgetierte und tatsächliche Stunden, Kosten und Umsatz nebeneinander an. </p> <p>Informationen zur Verwendung des Nutzungsberichts finden Sie unter <a href="../../../resource-mgmt/resource-utilization/view-utilization-information.md" class="MCXref xref">Informationen zur Ressourcenauslastung anzeigen </a>. </p> 
    <div> 
     ...
     <p>Weitere Informationen zu den geplanten Stunden finden Sie unter <a href="../../../workfront-basics/navigate-workfront/workfront-navigation/workfront-terminology-glossary.md" class="MCXref xref">Glossar der Adobe Workfront-Terminologie</a>.</p> 
     <p>Informationen zum Erstellen eines Berichts finden Sie unter <a href="../../../reports-and-dashboards/reports/creating-and-managing-reports/create-custom-report.md" class="MCXref xref">Benutzerdefinierten Bericht erstellen</a>.</p> 
