...
Auf dieser Seite finden Sie Informationen zu den Funktionen, die in der Version vom vierten Quartal 2023 enthalten sind. Diese Verbesserungen werden in den folgenden Versionen enthalten sein:
...
Das Webinar zur Version 23.10 wird am 5. Oktober 2023 stattfinden. Sie können [Melden Sie sich hier für das Webinar an](https://webinars.on24.com/adobe_workfront/whatsnewin2310?partnerref=releasenotes).
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-oct-2.md" class="MCXref xref" xrefformat="{para}">Berechnete Felder in benutzerdefinierten Formularen können jetzt den Platzhalter $$USER verwenden</a><span style="color: #ff0000;"> Neu in der Vorschau!</span></p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-sept-11.md" class="MCXref xref" xrefformat="{para}">Änderungen an der Arbeitsverfolgung in der neuen Startseite </a> </p>
                        <p>[!BADGE In Produktion für schnelle Veröffentlichung ]{type=Positive}</p>
