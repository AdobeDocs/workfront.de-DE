     ...
     <tr>
        <td>
            ...
            <ul>
                ...
                <li>Die Option „Arbeit, die ich mir selbst zuweise, an meiner Registerkarte „Arbeiten“ unter „Voreinstellungen“ senden wurde in „Aufgabenstatus automatisch auf „In Bearbeitung“ setzen, wenn Aufgaben selbst zugewiesen werden“ umbenannt, um den Zweck widerzuspiegeln.</li>
            </ul>
        </td>
        <td>Freitag, 28. August 2025</td>
...
<table style="table-layout:auto">
  ...
  <tr>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-document-and-proof.md" class="MCXref xref" xrefformat="{para}">Neue Proofing-Integration für Adobe Express</a><p></p>
            <p>Wir freuen uns, eine neue Integration zwischen Adobe Express und Workfront Proof bekannt geben zu können.</p>
            <ul>
            <li>Optimierung der Zusammenarbeit zwischen Kreativ-, Rechts- und Compliance-Teams, um die Zeit bis zur Veröffentlichung zu verkürzen und gleichzeitig die Aufsicht zu wahren</li>
...
<table style="table-layout:auto">
  <tbody>
   <tr>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-home.md" class="MCXref xref" xrefformat="{para}">Aktualisierungen des Widgets „Meine Anfragen“ auf der Startseite</a><p></p>
            <p>Um Workfront und Workfront Planning nahtloser zu gestalten, haben wir das Widget „Meine Anfragen“ auf der Startseite neu gestaltet. Das neue Widget bietet die folgenden Änderungen:
            <ul>
                <li>Verbessertes Layout und Organisation von Anfrageinformationen</li>
                <li>Verbesserte Filter- und Sortieroptionen</li>
                <li>Integration mit Workfront Planning für bessere Übersicht über die Ressourcenzuweisung</li>
            </ul>
            </p>
