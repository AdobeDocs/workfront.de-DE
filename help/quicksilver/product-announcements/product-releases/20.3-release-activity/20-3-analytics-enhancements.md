...
## Erweiterte Analyse ist da!

Erweiterte Analyse ist jetzt in Workfront verfügbar. Diese Funktion bietet Ihnen einen allgemeinen Überblick über Ihre Arbeit mit Visualisierungen, die Ihnen Folgendes zeigen:

* Was bei einem Projekt passiert ist
* Welche Projekte stehen im Mittelpunkt?
* Der Zustand Ihrer In-Flight-Projekte
* Welche Ereignisse haben den Projektabschluss nach den Fristen verlängert?
* Gibt an, ob die Arbeit angemessen verteilt wird
