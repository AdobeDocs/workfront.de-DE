...
* [Verbesserungen bei Prioritäten](#priorities-enhancements)
...
* [Verbesserungen beim Aktualisierungsverlauf](#update-stream-enhancements)
...
### Verbesserungen bei Prioritäten
...
<tbody>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            Aktuelle Informationen zur Arbeit in „Prioritäten“</a></p>
            [!BADGE In Production &#x200B;]{type=Informative}
...
<tr>
    ...
    <tr>
        <td>
            ...
            [!BADGE In Production &#x200B;]{type=Informative}
            <p>Wir haben den Desktop Viewer mit der neuesten Electron-Version 33.3.0 aktualisiert, die Chromium-130.0.6723.152 verwendet. </p>
            <p>Neueste Version: 2.1.44 </p>
        </td>
        <td>
            <p><b>Verfügbar zu diesen Daten:</b></p>
            <ul>
...
### Verbesserungen beim Aktualisierungsverlauf
...
Informationen zu den Wartungs-Updates, die im ersten Quartal 2025 durchgeführt wurden, finden Sie unter [Wartungs-Updates für Workfront](https://experienceleague.adobe.com/de/docs/workfront-known-issues/releases/current-updates).
