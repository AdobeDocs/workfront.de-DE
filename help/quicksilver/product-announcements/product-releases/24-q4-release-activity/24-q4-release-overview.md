---
title: Versionsüberblick für das vierte Quartal 2024
description: Diese Seite enthält Informationen zur Funktionalität, die in der Version vom vierten Quartal 2024 enthalten ist. Diese Verbesserungen werden voraussichtlich im Lauf des Quartals in der Produktionsumgebung zur Verfügung gestellt.
author: Courtney
...
# Versionsüberblick für das vierte Quartal 2024

Diese Seite enthält Informationen zu den Funktionen, die in der Version für das vierte Quartal 2024 enthalten sind. Diese Verbesserungen werden voraussichtlich im Lauf des Quartals in der Produktionsumgebung zur Verfügung gestellt.

<span class="preview">Funktionen außerhalb des Zyklus (diejenigen, die vor dem Veröffentlichungsdatum des vierten Quartals 2024 in die Produktion aufgenommen wurden) sind gelb hervorgehoben.</span>

>[!IMPORTANT]
>
>Die Version 23.3 enthielt die Option, Ihr Unternehmen auf monatliche Versionen umzustellen. Daher hat Workfront das Nummerierungsschema von Releases geändert, um sowohl die monatlichen als auch die vierteljährlichen Release-Tracks zu berücksichtigen. Die erste Zahl bezeichnet das Jahr und die zweite Zahl den Monat der Veröffentlichung. Beispiel: Die Version für April 2024 lautet wie 24.4.
>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    [!BADGE In Produktion ]{type=informative}
                    <p>Um die Möglichkeiten der Funktionen zur Umgebungsförderung zu erweitern, haben wir die Möglichkeit hinzugefügt, Zugriffsebenen einzubeziehen. Jetzt können Sie eine Zugriffsebene in einer Sandbox-Umgebung konfigurieren und diese Zugriffsebene dann auf Ihre Produktionsumgebung heraufstufen.</p>
                </td>
                <td><p><b>Verfügbar ab folgenden Terminen:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Freitag, 17. Oktober 2024</p>
                        </li>
                        <li>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Mittwoch, 1. Oktober 2024</p>
                        </li>
                        <li>
                            <p>Produktionsversion für alle Kunden: Mit der Version 24.10 (17. Oktober 2024)</p>
                        </li>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Freitag, 29. August 2024</p>
                        </li>
                        <li>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p><s>Geplante Veröffentlichung: Dienstag, 12. August 2024</s></p>
                        </li>
                        <li>
                            <p>Produktion für schnelle Veröffentlichung: N/A</p>
                        </li>
                        <li>
                            <p>Produktionsfreigabe für alle Kunden: N/A</p>
                        </li>
                    </ul>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar ab folgenden Terminen:</b></p>
                    <ul>
                        <li>
                            <p><s>Geplante Veröffentlichung: Freitag, 3. Oktober 2024</s></p>
                        </li>
                        <li>
                            <p>Produktionsversion für alle Kunden: Mit der Version 24.10 (17. Oktober 2024)</p>
                        </li>
            ...
            <tr>
                <td>
                    ...
                    [!BADGE In Production ]{type=Informative}
                    <p>Sie können jetzt schnell Reviewer und genehmigende Personen aus früheren Dokumentversionen hinzufügen.</p>
                </td>
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Freitag, 3. Oktober 2024</p>
                        </li>
                        <li>
                            <p>Produktionsversion für alle Kunden: Mit der Version 24.10 (17. Oktober 2024)</p>
                        </li>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Freitag, 10. Oktober 2024</p>
                        </li>
                        <li>
            ...
            <tr>
                <td>
                    <a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-home-enhancements.md">Einführung von Prioritäten: ein einfacheres, optimiertes und intuitives Workfront-Erlebnis für Aufgabeneigentümer</a></p>
                    [!BADGE In Production ]{type=Informative}
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Mittwoch, 6. August 2024</p>
                        </li>
                        <li>
    ...
    <col style="width: 50%;" />
        <tbody>
            ...
            <tr>
                ...
                <p><i>Diese Funktion wurde aus Preview und Fast Release Production entfernt.</i></p>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    [!BADGE In Produktion für schnelle Veröffentlichung ]{type=positiv}
                    <p>Wir haben den Algorithmus geändert, den Workfront zur Berechnung verwendet, und schlagen Smart-Zuweisungen für Tasks vor. Der neue Algorithmus wird in den folgenden Bereichen in Workfront angewendet, denen Sie einen Vorgang zuweisen: Vorgangslisten, der Bereich Zuweisungen in der Vorgangskopfzeile, die Startseite und das Übersichtsfenster.</p>
                </td>
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Donnerstag, 2. Oktober 2024</p>
                        </li>
                        <li>
            ...
            <tr>
                ...
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Samstag, 30. August 2024</p>
                        </li>
                        <li>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <ul>
                        <li>Zusammenfassen von Arbeitsaufgaben und Dokumenten, um schnell ein allgemeines Verständnis von Aufgaben, Projekten und Elementen zu erlangen</li>
                        <li>Bereitstellen von Informationen aus der Experience League-Dokumentation, Einbinden von Anweisungen und Referenzmaterial in Workfront und Verknüpfen mit einer ausführlicheren Dokumentation.</li>
                        <li>Erstellen und Verfeinern von Formeln für berechnete benutzerdefinierte Formularfelder, Generieren von Formeln aus Textaufforderungen oder Suchen von Fehlern in vorhandenen Formeln.</li>
                        </ul>
                        <p>Ihr Workfront-Administrator kann den AI Assistant für Ihr Unternehmen aktivieren oder deaktivieren. Der AI Assistant ist für Instanzen mit den Abos Select, Prime und Ultimate verfügbar.</p>
                    </td>
                <td><p><b>Verfügbar zu diesen Daten:</b></p>
                    <ul>
                        <li>
                            <p>Geplante Veröffentlichung: Donnerstag, 28. August 2024</p>
                        </li>
                        <li>
