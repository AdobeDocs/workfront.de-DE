...
Weitere Informationen zum Adobe Workfront-Veröffentlichungsplan finden Sie unter [Adobe Workfront-Veröffentlichungszeitplan und -prozess](../../product-announcements/product-releases/workfront-release-schedule.md).

Informationen dazu, wie Sie Ihre Organisation bei der reibungslosen Anpassung an neue Versionen unterstützen, finden Sie unter [Versionshinweise](../../product-announcements/product-releases/release-readiness.md).
  ...
  <tr data-mc-conditions=""> 
   <td> <p>Versionen 2024</p> 
    ...
    <li> <p><a href="/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-release-overview.md" class="MCXref xref" xrefformat="{para}">Übersicht über die Version des ersten Quartals 2024</a> </p> </li>
      <li> <p><a href="/help/quicksilver/product-announcements/product-releases/24-q1-release-activity/24-q1-release-overview.md" class="MCXref xref" xrefformat="{para}">Übersicht über die Version 2024 im zweiten Quartal</a> </p> </li>
   <td> <ul>    <li> <p><a href="/help/quicksilver/product-announcements/product-releases/24-q2-release-activity/24-q2-release-overview.md" class="MCXref xref" xrefformat="{para}">Adobe Workfront Fusion-Release-Aktivität</a> </p> </li> </ul>   </td> 
  <tr data-mc-conditions=""> 
  ...
  <tr> 
   <td> <p>Versionen 2021</p> 
    <ul> 
     ...
     <li> <p><a href="../../product-announcements/product-releases/21.1-release-activity/21-1-release-overview.md" class="MCXref xref" xrefformat="{para}">Übersicht über die Version 21.1</a> </p> </li> 
    </ul> </td> 
   <td> 
    <ul> 
