...
>|----|----|
>| <ul><li>26.2 (12. Februar 2026)</li><li>26.3 (12. März 2026)</li><li>26.4 (15. April 2026)</li></ul> | <ul><li>26.4 (16. April 2026)</li></ul> |
>
>Beachten Sie, dass Benutzer, die den Zeitplan für die schnelle Veröffentlichung im letzten Quartal (in diesem Quartal 26.4) verwenden, die Veröffentlichung einen Tag früher erhalten (15. April 2026).
>
...
* [Dokumentverbesserungen](#document-enhancements)
* [Verbesserungen bei Unternehmensabläufen](#enterprise-operations-enhancements)
* [Verbesserungen bei Projekten](#project-enhancements)
* [Verbesserungen beim Reporting](#reporting-enhancements)
* [Anfordern von Verbesserungen](#requesting-enhancements)
...
### Verbesserungen bei Unternehmensabläufen
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-enterprise-operations-enhancements.md" class="MCXref xref" xrefformat="{para}">Enterprise Operations-Funktionen jetzt in Adobe Workfront verfügbar</a><p></p>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-enterprise-operations-enhancements.md" class="MCXref xref" xrefformat="{para}">Lücken bei den effektiven Datumssätzen sind zulässig</a><p></p>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">Aktualisiertes Erlebnis bei der </a> von einzelnen oder Massenzuweisungen von Aufgaben<p>[!BADGE Außerplanmäßig]{type=Neutral}</p><p> Der Abschnitt „Zuweisungen“ im Feld „Aufgaben bearbeiten“ wurde aktualisiert, wenn einzelne Aufgaben bearbeitet oder stapelweise bearbeitet wurden. </p>
        </td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">Adobe Unified Experience ist jetzt für mehr Workfront-Organisationen verfügbar</a><p></p>
...
### Workfront Planning Trial ist jetzt verfügbar

[!BADGE Aus Zeitplan]{type=Neutral}

>[!NOTE]
>
>* Vorschau und Produktion für alle: 2. März 2026
>* Sie müssen die in Ihrer Umgebung verfügbare Testvereinbarung akzeptieren, bevor Sie auf die Umgebung für die Planning-Testversion zugreifen können.
>* Sie müssen die Adobe AI Agent-Vereinbarung nicht unterzeichnen, um Planning Designer während des Testzeitraums verwenden zu können.

Die Testversion von Workfront Planning ist jetzt für alle Kundinnen und Kunden von Workfront verfügbar.

Die kostenlose Testversion bietet Workfront-Kunden ab dem 2. März 2026 eine 60-tägige Prime-Lizenz für den Zugriff auf Workfront Planning. Die Testphase endet am 1. Mai 2026.
...
* Planning Designer - ein KI-gestützter Assistent, der Ihnen beim Erstellen der gewünschten Umgebung helfen kann
