...
Vor dieser Änderung können Sie die WIP-Beschränkung nur im Bereich Teameinstellungen aktualisieren.
...
Die Arbeitsliste im Startbereich enthält folgende Verbesserungen:
...
* Ändern Sie die Größe der Arbeitsliste per Drag &amp; Drop. Sie können die Größe der Arbeitsliste ändern, um bis zu die Hälfte des Bildschirms zu verbrauchen. Die von Ihnen festgelegte Größe wird beibehalten, wenn Sie das nächste Mal auf Home zugreifen.
