...
* [Neue Ressourcen zu Ereignisanmeldungen hinzugefügt](#new-resources-added-to-event-subscriptions)
...
Vor dieser Änderung konnten Sie die Gesamtzahl der geplanten und verfügbaren Stunden für Benutzer und Stellenrollen nur in separaten Spalten anzeigen.
...
Weitere Informationen zur Anzeige von Informationen in der Gantt-Grafik finden Sie unter [Konfigurieren der Anzeige von Informationen im Gantt-Diagramm](../../../../manage-work/gantt-chart/use-the-gantt-chart/configure-info-on-gantt-chart.md).
