...
Weitere Informationen finden Sie unter [Prüfprotokolle](../../../administration-and-setup/add-users/create-and-manage-users/audit-logs.md).

Diese Funktion ist jetzt im Lernpfad [Administratorgrundlagen für das neue Workfront-Erlebnis, Teil 2: Projekt-Setup](https://one.workfront.com/s/learningpath3/administrator-fundamentals-in-the-new-workfront-experience-part-1-project-workfl-MCTBVZ3Q3J5RHNLIPPZPFSQRLKUY) auf Workfront One enthalten.
...
Weitere Informationen zu den Voreinstellungen für Timesheets und Stunden finden Sie unter [Konfigurieren von Voreinstellungen für Zeitblätter und Stunden](../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md).
...
Weitere Informationen zum Bereich &quot;Gruppen&quot;finden Sie unter [Verwalten von Gruppen](../../../administration-and-setup/manage-groups/manage-groups.md).
...
Weitere Informationen zum Einrichtungsbereich finden Sie unter [Administration und Einrichtung](../../../administration-and-setup/administration-and-setup.md).
...
Weitere Informationen finden Sie unter [Erstellen, Bearbeiten und Zuweisen von Zeitleistenprofilen](../../../timesheets/create-and-manage-timesheets/create-timesheet-profiles.md).

Informationen zur Option &quot;Timesheets und Stunden&quot;auf einer Zugriffsebene finden Sie unter [Gewähren von Benutzern administrativen Zugriff auf bestimmte Bereiche](../../../administration-and-setup/add-users/configure-and-grant-access/grant-users-admin-access-certain-areas.md).
...
Diese Funktion ist jetzt im Lernpfad [Administrator-Grundlagen des neuen Workfront-Erlebnisses, Teil 3: Control and Interface Experience](https://one.workfront.com/s/learningpath3/administrator-fundamentals-control-and-interface-experience-MCNCSSMXLPDFEERGVEM4EWL2I4LI) in Workfront One enthalten.
...
Weitere Informationen finden Sie unter [Anzeigen aller Berichte, die ein bestimmtes benutzerdefiniertes Feld oder Widget verwenden](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/view-all-reports-that-use-a-particular-custom-field.md).
