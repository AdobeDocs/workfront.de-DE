...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 27. April 2021<br></p> <p>Produktionsversion: 27. April 2021</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-admin-enhancements.md#new" class="MCXref xref" xrefformat="{para}">Neu für Gruppenadministratoren: Profile für Gruppenarbeitszeittabellen zuweisen</a> </p> <p>Jetzt ist es einfacher, Arbeitszeittabellen-Profile für eine Gruppe zu verwalten, die Sie verwalten. Sie können nicht nur Arbeitszeittabellen-Profile erstellen, sondern diese auch Ihren Gruppen oder einzelnen Mitgliedern Ihrer Gruppen zuweisen. Dies gilt auch, wenn die Option Arbeitszeittabellen und Stunden in Ihrer Zugriffsebene nicht aktiviert ist.</p> <p>Bisher war die Aktivierung der Option Arbeitszeittabellen und Stunden erforderlich, um Arbeitszeittabellen-Profile zuzuweisen. Dies ist jedoch möglicherweise nicht für jeden Gruppenadministrator ideal, da dadurch der Zugriff auf alle Arbeitszeittabellen- und Stundeninformationen im System angezeigt und bearbeitet werden kann. Wenn Sie diese Zugriffsebene nicht benötigen, können Sie jetzt Arbeitszeittabellen-Profile für Ihre Gruppen verwalten.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-admin-enhancements.md#for7" class="MCXref xref" xrefformat="{para}">Für Administratoren: Legen Sie den Filter, die Ansicht und die Gruppierung fest, die Benutzende in Objektlisten sehen</a><span class="uitext" style="color: #dc143c;"></span> </p> <p>Mithilfe einer Layout-Vorlage können Sie jetzt in der neuen Workfront-Version die Standardfilter, -ansichten und -gruppierungen festlegen, die Benutzenden in Objektlisten in ganz Workfront angezeigt werden.</p> <p>Anstatt das Filterlisten-Steuerelement beispielsweise auf „Alle“ zu setzen, können Sie es in „Mein Home-Team“ ändern. Auf diese Weise werden immer dann, wenn ein(e) Benutzende(r) eine Liste von Objekten aufruft, nur die dem Team des/r Benutzenden zugeordneten Objekte einbezogen.</p> <p>Zuvor konnten diese Standardwerte nicht angepasst werden, daher wurden sie immer als „Alle“ für Filter, „Standard für Ansichten“ und „Nichts für Gruppierungen“ festgelegt. Ein zusätzlicher Bonus der neuen Funktionalität besteht darin, dass Sie diese drei Einstellungen vor Ihren Benutzern ausblenden können, wenn sie sie nicht benötigen.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 11. März 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-admin-enhancements.md#new4" class="MCXref xref" xrefformat="{para}">Neu für Admins: Einfaches Auflisten der Berichte, die derzeit ein benutzerdefiniertes Feld verwenden</a> </p> <p>Wenn Sie ein benutzerdefiniertes Feld bearbeiten oder löschen müssen, das möglicherweise bereits in einigen Workfront-Berichten implementiert ist, müssen Sie unbedingt beurteilen, ob diese Berichte angepasst werden müssen, damit sie nach der Änderung weiterhin ordnungsgemäß funktionieren. Mit der neuen Ansicht Auswirkung auf benutzerdefinierte Felder im Bereich Benutzerdefinierte Forms im Setup können Sie jetzt einfach feststellen, welche Berichte das Feld verwenden.</p> <p>Ohne diese Ansicht mussten Sie einen Bericht ausführen, um herauszufinden, welche benutzerdefinierten Felder in Berichten verwendet wurden. Dies war schwierig und mühsam, wenn Ihr Unternehmen viele benutzerdefinierte Felder verwendet.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-admin-enhancements.md#for8" class="MCXref xref" xrefformat="{para}">Für Gruppenadministratoren: Anzeigen und Verwalten einer Gruppe und ihrer Objekte an einem Ort</a> </p> <p>Jetzt ist es einfacher, eine Gruppe zu verwalten, wenn Sie eine Gruppe im Bereich Gruppen unter „Setup“ anzeigen. Mit dem neuen Menü Mehr können Sie die Gruppe schnell bearbeiten, kopieren oder löschen, ohne zur Seite Gruppen zurückzukehren.</p> <p>Sie können auch die Layout-Vorlagen, Zeitpläne, Arbeitszeittabellen-Profile und Untergruppenmitglieder Ihrer Gruppe auf der Seite der Gruppe anzeigen und mit ihnen arbeiten. Dadurch müssen Sie nicht mehr auf die verschiedenen Setup-Seiten für diese Objekte gehen, um sie für Ihre Gruppe zu verwalten. Außerdem wird die Liste der Objekte Ihrer Gruppe von der Liste der anderen Gruppen im System getrennt.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 18. Februar 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-admin-enhancements.md#new2" class="MCXref xref" xrefformat="{para}">Neu für Admins: Weitere Textformatierungsoptionen in benutzerdefinierten Formularfeldern verfügbar</a> </p> <p>Wenn Benutzer benutzerdefinierte Formularfelder eingeben, die eine Formatierung ermöglichen, können sie den Text jetzt mit Aufzählungszeichen, Nummerierungen, Hyperlinks und Blockanführungszeichen sowie fett, kursiv und unterstrichen organisieren.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 18. Februar 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#new5" class="MCXref xref" xrefformat="{para}">Neue Schaltflächen in der Kopfzeile „Projekte“ verfügbar</a> </p> <p>Damit Sie die Liste der Projekte auf der Seite „Projekte“ schnell filtern können, gibt es zwei neue Schaltflächen in der Kopfzeile, mit denen Sie die Filter „Projekte, an denen ich mitarbeite“ oder „Projekte, an denen ich mitarbeite“ schnell anwenden können.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 29. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#new4" class="MCXref xref" xrefformat="{para}">Feld „Neues Problem bearbeiten</a> </p> <p>Im Zuge der Aktualisierung des Erscheinungsbilds des neuen Workfront-Erlebnisses haben wir das Feld „Problem bearbeiten“ neu gestaltet. Sie können das neue Feld „Problem bearbeiten“ über ein einzelnes Problem oder beim Bearbeiten eines einzelnen Problems über eine Liste aufrufen.</p> <p>Neben einem aktualisierten Look-and-Feel wurden auch verschiedene andere Änderungen vorgenommen.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 22. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#new3" class="MCXref xref" xrefformat="{para}">Neue Benutzeroberfläche zum Erstellen und Bearbeiten wiederkehrender Aufgaben</a> </p> <p>Im Rahmen der Neugestaltung der Felder Neu und Aufgabe bearbeiten haben wir die Möglichkeit hinzugefügt, eine neue Aufgabe als wiederkehrende Aufgabe festzulegen und das übergeordnete Element einer wiederkehrenden Aufgabe zu bearbeiten. Diese Funktion war nicht in der Neugestaltung des Felds „Neue Aufgabe“ und „Aufgabe bearbeiten“ enthalten, die zuvor veröffentlicht wurde.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 22. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#move" class="MCXref xref" xrefformat="{para}">Verschieben oder Löschen einer Story oder eines Problems aus dem Scrum-Board</a> </p> <p>Sie können jetzt eine Story oder ein Problem aus Ihrem Scrum-Board verschieben, indem Sie auf das Mehr -Symbol auf einer Story oder Problemkarte klicken und Verschieben nach auswählen. Wenn Sie zukünftige Iterationen definiert haben, können Sie das Element in eine andere Iteration verschieben. Sie können das Element auch in den Rückstand Ihres Teams verschieben.</p> <p>Sie haben auch die Möglichkeit, eine Story oder ein Problem direkt aus Ihrem Scrum-Board zu löschen, indem Sie auf das Mehr -Symbol auf einer Karte klicken und Löschen auswählen. Wenn Sie eine Story oder ein Problem löschen, wird diese für 30 Tage in den Papierkorb verschoben und kann nur vom Systemadministrator wiederhergestellt werden.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 22. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#relocate" class="MCXref xref" xrefformat="{para}">Die Schaltflächen „Speichern“ und „Abbrechen“ für die Felder „Bearbeiten“ und „Neues Objekt“ wurden verschoben</a> </p> <p>Basierend auf dem Feedback von Benutzern wurden die Schaltflächen Speichern und Abbrechen in die linke untere Ecke der Felder Objekt bearbeiten und Neues Objekt für Projekte und Aufgaben verschoben. </p> <p>Vor dieser Verbesserung befanden sich diese Schaltflächen in der oberen rechten Ecke dieser Felder.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 8. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 18. März 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#the" class="MCXref xref" xrefformat="{para}">Der Primäre Kontakt einer Anfrage ist jetzt im Bereich Projektdetails sichtbar</a> </p> <p>Beim Konvertieren eines Problems in ein Projekt wird der Anforderer des Problems an das Projekt übertragen und im Feld „Urheber des konvertierten Problems“ angezeigt. Dieses Feld können Sie im Bereich Projektdetails sowie in Projektberichten und -listen einsehen. Diese Informationen sind auch für Aufgaben sichtbar, nur in Berichten und Listen.</p> <p>Sie müssen dieses Feld in Ihrer Layout-Vorlage aktivieren, damit Sie es in der neuen Workfront-Version für Projekte anzeigen können.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 25. Februar 2021<br></p> <p>Produktionsversion: 10. März 2021</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-project-enhancements.md#view" class="MCXref xref" xrefformat="{para}">Informationen zu einer Gruppe anzeigen, die Sie einem Portfolio, Programm oder Team zuweisen möchten</a> </p> <p>Wenn Sie eine Gruppe einem Portfolio, Programm oder Team zuweisen, haben wir es Ihnen erleichtert, sicherzustellen, dass Sie die richtige Gruppe haben. Sie können auf das Informationssymbol neben dem Namen der Gruppe klicken, um eine QuickInfo mit der Hierarchie der darüber liegenden Gruppen sowie den Administratoren der Gruppe anzuzeigen. Je nach den für die Gruppe konfigurierten Details werden möglicherweise auch der Business Leader und die Beschreibung der Gruppe angezeigt.</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-requests-enhancements.md#control" class="MCXref xref" xrefformat="{para}">Steuern Sie, welche Art von Zuweisungen Sie bei einer neuen Anfrage vornehmen</a> </p> <p>Wir haben die Funktionsweise des Felds „Arbeitsaufträge“ beim Erstellen einer neuen Anfrage geändert, um Konsistenz zu gewährleisten und immer dasselbe Feld anzuzeigen, unabhängig davon, welche Arten von Arbeitsaufträgen Benutzende eingeben können.</p> <p>Wenn Sie beim Einrichten einer Anfrage-Warteschlange die Felder Zugewiesen an, Aufgabengebiet oder Team aktivieren, sehen Anfordernde dasselbe Feld Zuweisungen , das alle oder einen dieser drei Zuweisungstypen aufnehmen kann.</p> <p>Im Feld Arbeitsaufträge wird angegeben, welche Arten von Arbeitsaufträgen zulässig sind. Wenn Sie beispielsweise die Felder Zugewiesen an und Team beim Einrichten der Anfrage-Warteschlange aktiviert haben, werden Sie aufgefordert, Personen oder Teams zu durchsuchen anstatt nach Personen, Rollen oder Teams zu suchen.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 8. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-requests-enhancements.md#improvem" class="MCXref xref" xrefformat="{para}">Verbesserungen beim Erstellen von Anfragen und Verwalten von Entwürfen</a> </p> <p>Während wir Ihr Feedback zur Erstellung von Anfragen in die neue Workfront-Version integrieren, haben wir den Workflow für neue Anfragen mehrfach verbessert. Dazu gehören die Schaltfläche Schließen beim Erstellen einer neuen Anfrage, mit der die Anfrage beendet werden kann, ohne den Entwurf und andere Verbesserungen zu verlieren.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 8. April 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-requests-enhancements.md#improvem2" class="MCXref xref" xrefformat="{para}">Verbesserungen am Anforderungs-Workflow</a> </p> <p>Während wir Ihr Feedback weiterhin anhören und integrieren, haben wir einige Verbesserungen am neuen Anforderungs-Workflow hinzugefügt, um Ihre Interaktion mit Workfront einfacher und intuitiver zu gestalten. Sie können jetzt beim Erstellen einer Anfrage-Warteschlange u. a. auswählen, wo der Abschnitt Dokumente zum Hochladen von Dateien platziert werden soll!</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 25. März 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-requests-enhancements.md#open" class="MCXref xref" xrefformat="{para}">Öffnen Sie das Bedienfeld Zusammenfassung im Abschnitt Gesendet im Bereich Anfragen </a> </p> <p>Um die Konsistenz Ihres Erlebnisses in allen Bereichen von Workfront zu gewährleisten, haben wir das Symbol Zusammenfassung öffnen zum Abschnitt Gesendet im Bereich Anfragen hinzugefügt. Jetzt können Sie das Bedienfeld Zusammenfassung für gesendete Probleme öffnen und weitere Informationen zu den Problemen anzeigen, sie zuweisen oder ein Dokument oder einen Kommentar hinzufügen.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 18. März 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-requests-enhancements.md#bring" class="MCXref xref" xrefformat="{para}">Gelöschte neue Problemfelder in ein neues Anfrageformular zurückbringen</a> </p> <p>Mit der Neugestaltung des Formulars für neue Anfragen, die mit der vorherigen Version gestartet wurde, haben wir verhindert, dass mehrere Felder aus dem Bereich Neue Problemfelder im Abschnitt „Details zur Projektwarteschlange“ beim Senden einer neuen Anfrage angezeigt werden. Nachdem wir Ihr Feedback integriert haben, haben wir beschlossen, die Felder zurückzubringen, damit sie alle im neuen Anfrageformular angezeigt werden können. </p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 25. Februar 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-integration-enhancements.md#search" class="MCXref xref" xrefformat="{para}">Suchen nach Ordnern in Dokumentintegrationen</a> </p> <p>Um Ihnen die Navigation in Ihren Dokumentenintegrationen zu erleichtern, haben wir die Suche nach Ordnern ermöglicht. Wenn Sie jetzt einen Begriff in die Suchleiste eingeben, gibt Workfront Dokumente, Ordner und Unterordner zurück, die den Suchbegriff im Namen enthalten.</p> <p>Zuvor konnten Unterordner nur durch Öffnen der übergeordneten Ordner gefunden werden.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 25. März 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-integration-enhancements.md#enhanced" class="MCXref xref" xrefformat="{para}">Verbesserte Sicherheit beim Hochladen von Dateien auf das Google-Laufwerk</a> </p> <p>Die Google Drive-Integration unterstützt jetzt neue Google-Sicherheitsprotokolle. </p> <p>Beim Verknüpfen mit, Hochladen oder Erstellen von Dateien auf dem Google-Laufwerk über den Abschnitt Dokumente eines Workfront-Objekts greift Workfront jetzt über die Dateiauswahl von Google auf Ihre Google-Dateien zu. Dadurch wird der Zugriff und die Sichtbarkeit von Workfront nur auf die Google-Dateien beschränkt, die Sie mit Workfront verknüpfen.</p> <p>Zuvor wurde auf Dateien über ein Dateidialogfeld zugegriffen, das auf Workfront basiert.</p> </td> 
   <td><strong>Verfügbar zu diesen Daten:</strong> <p>Beta-Vorschau-Version: 11. März 2021<br></p> <p>Produktionsversion: Mit Version 21.2</p> <p><strong>In diesen Umgebungen verfügbar:</strong> </p> <p>Das neue Adobe Workfront-Erlebnis </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-other-enhancements.md#blueprin" class="MCXref xref" xrefformat="{para}">Blueprints-Betaversion jetzt in der Vorschau verfügbar</a> </p> <p>Blueprints bieten grundlegende Bausteine, mit denen Sie ein Work-Management-System erstellen können, das mit Ihnen wächst. Systemadministratoren können den Blueprint-Katalog durchsuchen und einsatzbereite Projektvorlagen installieren.</p> </td> 
