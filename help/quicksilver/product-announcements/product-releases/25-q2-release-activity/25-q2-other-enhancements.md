...
## Aktualisieren auf die neue Ereignisabonnementversion mit Versionsaktualisierungsendpunkten

>[!NOTE]
>
>Produktion für alle Kunden: 6. März 2025

Workfront verfügt jetzt über Versionen von Ereignisabonnements. Die neue Version bewirkt keine Änderung der Workfront-API, sondern der Ereignisabonnementfunktion.
...
Informationen zu den Endpunkten, mit denen ein Ereignisabonnement zwischen Versionen aktualisiert oder heruntergestuft wird, finden Sie im Abschnitt [Ereignisabonnement-Versionierung](/help/quicksilver/wf-api/general/event-subs-api.md#event-subscription-versioning) im Artikel Ereignisabonnement-API.
