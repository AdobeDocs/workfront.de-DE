---
title: Verbesserungen bei Dokumenten für das dritte Quartal 2026
description: Verbesserungen bei Dokumenten für das dritte Quartal 2026
author: Courtney
...
* Verwenden Sie dieselbe Nachricht für jedes Stadium oder eine andere Nachricht pro Stadium.
* Nachrichten können bis zu 500 Zeichen lang sein.
...
Dies ist sowohl im Bereich für veraltete Dokumente (Workfront-Speicher) als auch im Bereich für neue Dokumente (Adobe-Cloud-Speicher) verfügbar.
...
## Anzeigen von Experience Manager Assets- und Genehmigungsstatus-Badges im Bereich Dokumente
...
* Ein Badge, das angibt, ob die Datei an Adobe Experience Manager Assets gesendet wurde, einschließlich eines direkten Links zum Asset in Experience Manager
* Ein Badge, das den aktuellen Genehmigungsstatus des Assets anzeigt

Weitere Informationen zum Senden von Assets an Experience Manager Assets finden Sie unter [Verwenden von Adobe Experience Manager mit der Frame.io-Integration](/help/quicksilver/review-and-approve-work/native-integrations/frame-io/use-aem-with-frame.md).
