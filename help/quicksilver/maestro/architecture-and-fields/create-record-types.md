...
Informationen zum Erstellen von Taxonomien finden Sie unter [Erstellen von Taxonomiedatensatztypen](../architecture-and-fields/create-a-taxonomy.md).
...
Informationen zum Erstellen von Arbeitsbereichen finden Sie unter [Erstellen von Arbeitsbereichen](../architecture-and-fields/create-workspaces.md).

Informationen dazu, welche Datensatztypen in den einzelnen Vorlagen enthalten sind, finden Sie unter [Liste der Workspace-Vorlagen](../architecture-and-fields/workspace-templates.md).
...
Weitere Informationen zu Taxonomien finden Sie unter [Erstellen einer Taxonomie](../architecture-and-fields/create-a-taxonomy.md).
...
1. (Optional) Klicken Sie auf die **+** rechts oben in der Tabelle, um dem Datensatztyp weitere Felder hinzuzufügen. Weitere Informationen finden Sie unter [Felder erstellen](../architecture-and-fields/create-fields.md).
