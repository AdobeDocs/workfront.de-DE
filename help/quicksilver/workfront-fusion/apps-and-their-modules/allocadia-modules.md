...
description: In einer [!DNL Adobe Workfront Fusion] können Sie Workflows automatisieren, die Allocadia verwenden, und sie mit mehreren Anwendungen und Diensten von Drittanbietern verbinden.
author: Becky
...
In einer [!DNL Adobe Workfront Fusion] können Sie Workflows automatisieren, die [!DNL Allocadia], und stellen Sie eine Verbindung zu mehreren Drittanbieteranwendungen und -diensten her.
...
Verwendung [!DNL Allocadia] -Module, müssen Sie über eine [!DNL Allocadia] -Konto.

## Verbinden [!DNL Allocadia] nach [!DNL Workfront Fusion]

Sie können eine Verbindung zu Ihrem [!DNL Allocadia] direkt in einer [!DNL Allocadia] -Modul.

1. In jeder [!DNL Allocadia] Modul, klicken Sie auf **[!UICONTROL Hinzufügen]** neben dem [!UICONTROL Verbindung] -Feld.
...
Bei der Konfiguration [!DNL Allocadia] Module, [!DNL Workfront Fusion] zeigt die unten aufgeführten Felder an. Zusätzlich zu diesen [!DNL Allocadia] -Felder können abhängig von Faktoren wie Ihrer Zugriffsebene in der App oder im Dienst angezeigt werden. Ein fett hervorgehobener Titel in einem Modul zeigt ein erforderliches Feld an.
...
#### [!UICONTROL Aufzeichnen von Aufnahmen]
...
<table style="table-layout:auto"> <table style="table-layout:auto"> <col> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Anweisungen zum Verbinden Ihres Allocadia-Kontos mit [!DNL Workfront Fusion], siehe <a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">[!UICONTROL Zuordnung] zu Workfront Fusion</a> in diesem Artikel.</p> </td> 
  </tr> 
  <tr> 
...
Mit diesem Aktionsmodul können Sie einen benutzerdefinierten authentifizierten Aufruf an die [!DNL Allocadia] API. Auf diese Weise können Sie eine Datenflussautomatisierung erstellen, die von der anderen nicht durchgeführt werden kann [!DNL Allocadia] Module.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Anweisungen zum Verbinden der [!DNL Allocadia] Konto [!DNL Workfront Fusion], siehe <a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">Verbinden [!DNL Allocadia] nach [!DNL Workfront Fusion]</a> in diesem Artikel.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL URL]</td> 
   <td>Geben Sie einen Pfad relativ zu ein <code>https://api-na.allocadia.com/{version}</code> oder <code>https://api-eu.allocadia.com/{version}</code>.</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Wählen Sie den Typ [!DNL Allocadia] notieren, dass das Modul gelesen werden soll.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Eindeutige Eingabe oder Zuordnung [!DNL Allocadia] Kennung des Datensatzes, den das Modul lesen soll.</td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie den Typ der Entität aus, die Sie löschen möchten.</p> 
    <ul> 
     ...
     <li> <p><strong>[!UICONTROL Prognos-Tags]</strong> </p> <p>Wählen Sie das Budget aus, aus dem Sie einen Datensatz löschen möchten, und geben Sie dann die Tag-ID ein.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Verbindung]</p> </td> 
   <td> <p>Anweisungen zum Verbinden Ihres [!UICONTROL Allocadia]-Kontos mit [!DNL Workfront Fusion], siehe <a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">Verbinden [!DNL Allocadia] nach [!DNL Workfront Fusion]</a> in diesem Artikel.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Entitätstyp]</td> 
   <td>Wählen Sie den Typ [!DNL Allocadia] notieren, dass das Modul aktualisiert werden soll. Je nach ausgewähltem Entitätstyp werden andere Felder angezeigt.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Budgets]</td> 
...
Dieses Suchmodul sucht nach Datensätzen in einem Objekt in [!DNL Allocadia] die mit der angegebenen Suchabfrage übereinstimmen.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Entitätstyp]</td> 
   <td>Wählen Sie den Typ [!DNL Allocadia] -Datensatz, nach dem das -Modul suchen soll. </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Budgets]</td> 
  ...
  <tr> 
   ...
   <td>Wählen Sie das Feld aus, nach dem Sie suchen möchten, wählen Sie den Vorgang aus und geben Sie den zu suchenden Wert ein oder ordnen Sie ihn zu. Sie können [!DNL AND] oder [!DNL OR] Regeln , um Ihre Suche weiter zu filtern.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Ausgaben]</td> 
   <td> <p>Wählen Sie die Felder aus, die Sie in die Ausgabe des Moduls aufnehmen möchten. Die verfügbaren Felder hängen vom ausgewählten Entitätstyp ab.</p> </td> 
