...
# [!UICONTROL HTTP] >[!UICONTROL Einfache Genehmigungsanfrage stellen] Modul
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Wählen Sie den Schlüssel aus, der Ihre grundlegenden Authentifizierungsberechtigungen enthält, oder klicken Sie auf <strong>[!UICONTROL Hinzufügen]</strong> , um Ihre Anmeldedaten einem neuen Schlüssel hinzuzufügen. </p> <p>Hinweis: Sie können weitere Anmeldedaten hinzufügen, um mühelos zwischen den einzelnen Verbindungen zu wechseln.</p> </td> 
  </tr> 
  <tr> 
