...
description: Mit dem [!DNL Adobe Acrobat Sign] -Module, können Sie eine [!DNL Adobe Workfront Fusion] Szenario basierend auf Ereignissen in Ihrer [!DNL Adobe] Acrobat Sign-Konto, Erstellung, Lesen oder Aktualisieren von Verträgen und anderen Datensätzen, Suche nach Datensätzen anhand von von Ihnen festgelegten Kriterien und Hochladen von Dokumenten.
author: Becky
...
Mit dem [!DNL Adobe Acrobat Sign] -Module, können Sie eine [!DNL Adobe Workfront Fusion] Szenario basierend auf Ereignissen in Ihrer [!DNL Adobe Acrobat Sign] Konten, erstellen, lesen oder aktualisieren Sie Vereinbarungen und andere Datensätze, suchen Sie nach Datensätzen anhand von von Ihnen festgelegten Kriterien und laden Sie Dokumente hoch.
...
## [!DNL Adobe Acrobat Sign] Empfehlungen zur Verwendung von Connectoren

Die [!DNL Adobe Sign ]App führt die Automatisierung von eSignature-Geschäftsprozessen in [!DNL Fusion] viel einfacher und leistungsfähiger.

Neue Benutzer in [!DNL Adobe Sign] sollte einige der Zwänge im Zusammenhang mit der Aktualisierung von Vereinbarungen genau beachten. Vereinbarungen werden in der Regel nicht geändert, wenn sie einmal begonnen wurden. Wir empfehlen neuen Benutzern von [!DNL Adobe Sign] Konzentration auf die Erstellung neuer Vereinbarungen mithilfe des Moduls zur Erstellung von Vereinbarungen. Dies wird [!DNL Fusion] Automatisierungen einfacher und besser mit [!DNL Adobe Sign].

[!DNL Adobe Sign] Vereinbarungen brauchen ein Feld, mit dem sie arbeiten können. Es gibt verschiedene Möglichkeiten, dies zu tun. Am einfachsten und gängigsten ist jedoch das Hochladen eines Verlaufsdokuments und das anschließende Zuordnen dieses Dokuments zu Ihrer Vereinbarung.

![](assets/adobe-sign-recommendations-350x168.png)

## [!DNL Adobe Acrobat Sign] Module und ihre Felder

Bei der Konfiguration [!DNL Adobe Acrobat Sign] Module, [!DNL Workfront Fusion] zeigt die unten aufgeführten Felder an. Zusätzlich zu diesen [!DNL Adobe Acrobat Sign] -Felder können abhängig von Faktoren wie Ihrer Zugriffsebene in der App oder im Dienst angezeigt werden. Ein fett hervorgehobener Titel in einem Modul zeigt ein erforderliches Feld an.
...
+++ **[!UICONTROL Vereinbarungen beobachten]**
...
<td>Anweisungen zum Verbinden der [!DNL Adobe Acrobat Sign] Konto [!DNL Workfront Fusion], siehe <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref">Erstellen Sie eine Verbindung zu [!DNL Adobe Workfront Fusion] - Grundlegende Anweisungen</a></td>  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Wählen Sie den Webhook aus, den Sie verwenden möchten, oder klicken Sie auf <b>[!UICONTROL Hinzufügen]</b> und füllen Sie folgende Felder aus.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Verbindung]</td> 
   <td> <p>Anweisungen zum Verbinden der [!DNL Adobe Acrobat Sign] Konto [!DNL Workfront Fusion], siehe <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref">Erstellen Sie eine Verbindung zu [!DNL Adobe Workfront Fusion] - Grundlegende Anweisungen</a></p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Wählen Sie die [!DNL Adobe Sign] -Ereignisse, die das Modul überwachen soll.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Diese Einstellung funktioniert nur für Admin-Konten</p> <p>Klicken Sie für jede E-Mail-Adresse, an die Sie Problembenachrichtigungs-E-Mails senden möchten, auf <b>[!UICONTROL Hinzufügen]</b> und geben Sie die E-Mail-Adresse ein.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Bedingte Parameter der [!UICONTROL Vereinbarung]</td> 
   <td>Wenn Sie bedingte Parameter hinzufügen möchten, wählen Sie <b>[!UICONTROL Ja]</b> Wählen Sie für den Datensatztyp, dem Sie Parameter hinzufügen möchten, die Option <b>[!UICONTROL Ja]</b> auf allen Parametern, die aktiviert werden sollen.</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL Verbindung]</td> 
   <td>Anweisungen zum Verbinden der [!DNL Adobe Acrobat Sign] Konto [!DNL Workfront Fusion], siehe <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref">Erstellen Sie eine Verbindung zu [!DNL Adobe Workfront Fusion] - Grundlegende Anweisungen</a></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Record Type]</td> 
   <td> <p>Wählen Sie den zu erstellenden Datensatztyp aus.</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Vorlagenname der Bibliothek]</b> </p> <p>Geben Sie den Namen der Bibliotheksvorlage ein oder ordnen Sie ihn zu</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Vorlagentyp der Bibliothek]</b> </p> <p>Klicken Sie für jeden Bibliotheksvorlagentyp, den Sie verwenden möchten, auf <b>[!UICONTROL Element hinzufügen]</b> und wählen Sie den Vorlagentyp aus.</p> </li> 
     <li> <p><b>[!UICONTROL Letztes Ereignisdatum]</b> </p> <p>Geben Sie das letzte Datum ein, an dem ein Ereignis im Bibliotheksdokument aufgetreten ist.</p> <p>Eine Liste der unterstützten Datums- und Uhrzeitformate finden Sie unter <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref">Typenkonvertierung in [!DNL Adobe Workfront Fusion]</a>.</p> </li> 
     <li> <p><b>[!UICONTROL Dokumentstatus]</b> </p> <p>Wählen Sie den Status des Bibliotheksdokuments aus.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Konto-ID]</b> </p> <p>Geben Sie die eindeutige Kennung der [!DNL Adobe Acrobat Sign] -Konto, das mit diesem Benutzer verknüpft ist.</p> </li> 
     ...
     <li> <p><b>Primäre Gruppenkennung</b> </p> <p>Geben Sie die Gruppe ein, der der neue Benutzer hinzugefügt wird. Wenn nichts eingegeben wird, wird der Benutzer der Standardgruppe für das Konto hinzugefügt.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Webformularstatus]</b> </p> <p>Wählen Sie den Status aus, in dem das neue Webformular erstellt werden soll.</p> </li> 
     <li> <p><b>[!UICONTROL Webformularteilnehmerset info]</b> </p> 
      <ul> 
       <li> <p><b>[!UICONTROL Mitgliederinfo]</b> </p> <p>Klicken Sie für jedes Mitglied, das Sie zum Teilnehmersatz hinzufügen möchten, auf <b>[!UICONTROL Element hinzufügen]</b>. </p> 
        <ul> 
         <li> <p><b>[!UICONTROL Email]</b> </p> <p>Lassen Sie diese Option leer.</p> </li> 
         <li> <p><b>[!UICONTROL Sicherheitsoption]</b> </p> <p>Wenn Sie eine Sicherheitsoption für die Authentifizierung dieses Benutzers hinzufügen möchten, wählen Sie <b>[!UICONTROL Ja]</b>, wählen Sie dann die Sicherheitsoption aus und füllen Sie alle erforderlichen Felder aus.</p> </li> 
        </ul> </li> 
       <li> <p><b>[!UICONTROL Rolle]</b> </p> <p>Wählen Sie die Rolle aus. Alle Mitglieder dieses Teilnehmersatzes teilen die Rolle.</p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Webformular mit zusätzlichen Teilnehmern legt Infos fest]</b> </p> 
      <ul> 
       <li> <p><b>[!UICONTROL Mitgliederinfo]</b> </p> <p>Klicken Sie für jedes Mitglied, das Sie zum Teilnehmersatz hinzufügen möchten, auf <b>[!UICONTROL Element hinzufügen]</b>.</p> 
        <ul> 
         <li> <p><b>[!UICONTROL Email]</b> </p> <p>Lassen Sie diese Option leer.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Informationen zu Authentifizierungsfehlern]</b> </p> <p>Wenn Sie eine Fehler- oder Fehlerseite für Ihre Benutzer bereitstellen möchten, wählen Sie <b>[!UICONTROL Ja]</b>und füllen Sie dann die folgenden Felder aus:</p> 
      <ul> 
     ...
     <li> <p><b>[!UICONTROL CC info]</b> </p> <p>Klicken Sie für jede E-Mail-Adresse, an die Sie eine E-Mail erhalten möchten, wenn die endgültige Vereinbarung über das Webformular unterzeichnet wird, auf <b>[!UICONTROL Element hinzufügen]</b> und geben Sie die E-Mail-Adresse ein.</p> </li> 
     <li> <p><b>[!UICONTROL Abschlussinformationen]</b> </p> <p style="font-style: normal;">Wenn Sie eine Erfolgsseite für Ihre Benutzer bereitstellen möchten, wählen Sie <b>[!UICONTROL Ja]</b>und füllen Sie dann die folgenden Felder aus:</p> 
      <ul> 
     ...
     <li> <p><b>[!UICONTROL Letztes Ereignisdatum]</b> </p> <p>Geben Sie das Datum ein, an dem das letzte Ereignis im Webformular aufgetreten ist. Format verwenden <code>yyyy-MM-dd'T'HH:mm:ssZ</code>.</p> </li> 
     <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie das Gebietsschema des Benutzers ein. Dadurch wird die Sprache der Benutzeroberfläche bestimmt. </p> </li> 
     ...
     <li> <p><b>[!UICONTROL Validierungsinformationen]</b> </p> <p>Wenn Ihr Konto für die Dokumentüberprüfung eingerichtet ist und die Option, pro Vereinbarung zu aktivieren, können Sie diese Option aktivieren, um diese Vereinbarung zu verwerfen.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>Es wird empfohlen, das Dokument hochzuladen, um es als Verlaufsdokument zu signieren, und es dann dem [!UICONTROL Zu sendende Datei] im Feld [!UICONTROL Vereinbarung erstellen] -Modul. Ein Beispiel finden Sie unter &quot;Dokument hochladen&quot;in diesem Artikel.
...
<td>Anweisungen zum Verbinden der [!DNL Adobe Acrobat Sign] Konto [!DNL Workfront Fusion], siehe <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref">Erstellen Sie eine Verbindung zu [!DNL Adobe Workfront Fusion] - Grundlegende Anweisungen</a></td>  </tr> 
  ...
  <tr> 
   ...
   <td> <p>Klicken Sie für jedes Element, das Sie in die Vereinbarung aufnehmen möchten, auf <b>[!UICONTROL Element hinzufügen]</b> und füllen Sie folgende Felder aus:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Dateityp]</b> </p> 
      <ul> 
       <li> <p><b>[!UICONTROL Document]</b> </p> <p>Füllen Sie die folgenden Felder aus:</p> 
        <ul> 
         <li> <p><b>[!UICONTROL Erstellungsdatum]</b> </p> <p>Datum der Dokumenterstellung im Format eingeben oder zuordnen <code>yyyy-MM-dd'T'HH:mm:ssZ</code>. Beispiel: <code>2016-02-25T18:46:19Z</code> steht für UTC-Zeit.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Klicken Sie für jeden Teilnehmer-Satz, den Sie hinzufügen möchten, auf <b>[!UICONTROL Element hinzufügen]</b> und füllen Sie folgende Felder aus.</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Member]</b> </p> <p>Klicken Sie für jede Person, die Sie zum Teilnehmersatz hinzufügen möchten, auf <b>[!UICONTROL Element hinzufügen]</b> und geben Sie die E-Mail-Adresse der Person ein.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie für jeden E-Mail-Typ aus, ob dieser E-Mail-Typ an alle Teilnehmer gesendet wird oder nicht.</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL In-Flight-E-Mails]</b> </p> <p>Wird gesendet, wenn diese Vereinbarung delegiert oder ersetzt wird.</p> </li> 
     <li> <p><b>[!UICONTROL Einleitungs-E-Mails]</b> </p> <p>Senden Sie eine E-Mail, wenn diese Vereinbarung erstellt wird oder eine entsprechende Aktion angefordert wird.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Ernennung]</b> </p> <p>Geben Sie einen geplanten Zeitpunkt und einen Termin für die Ernennung ein oder ordnen Sie ihn zu, um diese Vereinbarung zu notieren.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie aus, ob die Unterzeichner nach Unterzeichnung der Vereinbarung zu einer Erfolgsseite weitergeleitet werden sollen. Wenn Sie <b>[!UICONTROL Ja]</b>, füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Umleitungsverzögerung]</b> </p> <p>Geben Sie eine Zahl ein oder ordnen Sie sie zu, die die Anzahl der Sekunden darstellt, bevor der Unterzeichner zur Erfolgsseite weitergeleitet wird. Wenn dieser Wert größer als 0 ist, sieht der Benutzer zunächst den Standard [!DNL Adobe Sign] Erfolgsmeldung angezeigt, und nach einer Verzögerung werden Sie zu Ihrer Erfolgsseite weitergeleitet.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie das sekundäre Kennwort ein oder ordnen Sie es zu, das zum Schützen des PDF-Dokuments verwendet wird. </p> <p>Wichtig: [!DNL Adobe Sign] wird dieses Kennwort nie freigeben, sodass Sie es separat an alle relevanten Parteien weitergeben müssen.</p> </td> 
  </tr> 
  <tr> 
    ...
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Reminders]</b> </p> <p>Füllen Sie die folgenden Felder aus:</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Häufigkeit der Erinnerung]</b> </p> <p>Legen Sie die Häufigkeit fest, mit der die Erinnerung gesendet werden soll. Wenn keine Häufigkeit angegeben wird, wird die Erinnerung einmal gesendet.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Ansichten]</b> </p> <p>Füllen Sie die folgenden Felder aus</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Benutzer für automatische Anmeldung]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um den Benutzer automatisch an die zurückgegebene URL anzumelden.</p> </li> 
       <li> <p><b>Übergeordneter Frame von [!UICONTROL]</b> </p> <p>Geben Sie eine kommagetrennte Liste der URLs der übergeordneten Domäne ein oder ordnen Sie sie zu, in denen die zurückgegebenen URLs gespeichert werden können. Wenn leer gelassen, wird die [!DNL Adobe Acrobat Sign] Seiten sind im iframe nicht sichtbar.</p> </li> 
       <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie die Sprache ein, in der Sie die Ansicht erstellen möchten. </p> </li> 
       <li> <p><b>[!UICONTROL Kein Chrome-Flag]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um die eingebettete Seite ohne Navigationskopfzeile oder Fußzeile anzuzeigen.</p> </li> 
       <li> <p><b>[!UICONTROL Kann Dateien bearbeiten]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> wenn Sie möchten, dass der Abschnitt zum Hochladen von Dateien bearbeitet wird, indem Sie Dateien hinzufügen oder entfernen. Dies ist kein Zugriffskontrollmechanismus. Der Standardwert ist [!UICONTROL Ja].</p> </li> 
       <li> <p><b>[!UICONTROL Bibliotheksdokument]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , wenn Sie möchten, dass Links für Bibliotheksdokumente sichtbar sind. Der Standardwert ist [!UICONTROL Ja].</p> </li> 
       <li> <p><b>[!UICONTROL Lokale Datei]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , wenn die Schaltfläche zum Hochladen einer lokalen Datei angezeigt werden soll. Der Standardwert ist [!UICONTROL Ja].</p> </li> 
       <li> <p><b>[!UICONTROL Web Connectors]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , wenn Sie möchten, dass die Links Dokumente aus Web-Quellen anhängen. Die Standardeinstellung ist "Ja".</p> </li> 
       <li> <p><b>[!UICONTROL Ist Vorschau ausgewählt]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um die Seite "Erstellen"auf den Bearbeitungsmodus zu setzen.</p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Mitgliederanteil]</b> </p> <p>Klicken Sie für jedes Mitglied, für das Sie die Vereinbarung freigeben möchten, auf <b>[!UICONTROL Element hinzufügen]</b> und geben Sie die E-Mail-Adresse des Mitglieds sowie eine Nachricht an dieses Mitglied ein.</p> </li> 
     <li> <p>[!UICONTROL Teilnehmersatz delegieren]</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Mitgliederinfo]</b> </p> <p>Klicken Sie für jedes Mitglied, das Sie hinzufügen möchten, auf [!UICONTROL Element hinzufügen] und geben Sie die E-Mail-Adresse und Telefoninformationen für das Mitglied ein.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Benutzer für automatische Anmeldung]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um den Benutzer automatisch an die zurückgegebene URL anzumelden.</p> </li> 
     <li> <p><b>[!UICONTROL Frame parent]</b> </p> <p>Geben Sie eine kommagetrennte Liste der URLs der übergeordneten Domäne ein oder ordnen Sie sie zu, in denen die zurückgegebenen URLs gespeichert werden können. Wenn leer gelassen, wird die [!DNL Adobe Acrobat Sign] Seiten sind im iframe nicht sichtbar.</p> </li> 
     <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie die Sprache ein, in der Sie die Ansicht erstellen möchten. </p> </li> 
     <li> <p><b>[!UICONTROL Kein Chrome-Flag]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um die eingebettete Seite ohne Navigationskopfzeile oder Fußzeile anzuzeigen.</p> </li> 
     <li> <p><b>[!UICONTROL Konfiguration der Sendeansicht]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> Wenn Sie die Ansicht [!UICONTROL Senden] konfigurieren möchten, füllen Sie die folgenden Felder aus.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Name des Vertrags]</b> </p> <p>Geben Sie den Vertragsnamen für das Bibliotheksdokument auf der Seite "Erstellen"ein oder ordnen Sie ihn zu.</p> </li> 
       <li> <p><b>[!UICONTROL Kann Dateien bearbeiten]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> wenn Sie möchten, dass der Abschnitt zum Hochladen von Dateien bearbeitet wird, indem Sie Dateien hinzufügen oder entfernen. Dies ist kein Zugriffskontrollmechanismus. Der Standardwert ist [!UICONTROL Ja].</p> </li> 
       <li> <p><b>[!UICONTROL Lokale Datei]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , wenn Sie möchten, dass Links für Bibliotheksdokumente sichtbar sind. Der Standardwert ist [!UICONTROL Ja].</p> </li> 
       <li> <p><b>[!UICONTROL Web Connectors]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , wenn Sie möchten, dass die Links Dokumente aus Web-Quellen anhängen. Der Standardwert ist [!UICONTROL Ja].</p> </li> 
       <li> <p><b>Ist die Vorschau ausgewählt</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um die Seite "Erstellen"auf den Bearbeitungsmodus zu setzen.</p> </li> 
      </ul> <p> </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Benutzer für automatische Anmeldung]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um den Benutzer automatisch anzumelden. Auswählen <b>[!UICONTROL Nein]</b> , um Anmeldeinformationen zu benötigen. Der Standardwert ist [!UICONTROL No].</p> </li> 
     <li> <p><b>[!UICONTROL Frame parent]</b> </p> <p>Geben Sie eine kommagetrennte Liste der URLs der übergeordneten Domäne ein oder ordnen Sie sie zu, in denen die zurückgegebenen URLs gespeichert werden können. Wenn leer gelassen, wird die [!DNL Adobe Acrobat Sign] Seiten sind im iframe nicht sichtbar.</p> </li> 
     <li> <p><b>Keine Chrome-Markierung</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um die eingebettete Seite ohne Navigationskopfzeile oder Fußzeile anzuzeigen.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
    ...
    <ul> 
     <li> <p>[!UICONTROL Ansichten]</p> <p>Füllen Sie die folgenden Felder aus.</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie die Sprache ein, in der Sie die Ansicht erstellen möchten. </p> </li> 
       <li> <p><b>[!UICONTROL Kein Chrome-Flag]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um die eingebettete Seite ohne Navigationskopfzeile oder Fußzeile anzuzeigen.</p> </li> 
       <li> <p>[!UICONTROL Konfiguration der personalisierten Signaturansicht]</p> <p>Wenn Sie eine personalisierte Signaturansicht konfigurieren möchten, wählen Sie <b>[!UICONTROL Ja]</b> und füllen Sie folgende Felder aus:</p> 
        <ul> 
         <li> <p><b>[!UICONTROL Email]</b> </p> <p>Geben Sie die E-Mail-Adresse der Person ein, die das neu erstellte Webformular erhält.</p> </li> 
         <li> <p><b>[!UICONTROL Kommentar]</b> </p> <p>Geben Sie einen Kommentar ein, in dem beschrieben wird, wie der API-Aufrufer die Identität des Unterzeichners ermittelt hat. Diese Informationen werden im [!DNL Adobe Acrobat Sign] Audit-Protokoll.</p> </li> 
         <li> <p><b>[!UICONTROL Ablauf]</b> </p> <p>Geben Sie ein Ablaufdatum für die Personalisierung dieses Webformulars ein. </p> <p>Eine Liste der unterstützten Datums- und Uhrzeitformate finden Sie unter <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref" data-mc-variable-override="">Typenkonvertierung in [!DNL Adobe Workfront Fusion]</a>.</p> </li> 
         <li> <p><b>[!UICONTROL Wiederverwendbar]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , wenn der vorgesehene Unterzeichner das Formular mehrmals unterschreiben kann.</p> </li> 
        </ul> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Mitgliederanteil]</b> </p> <p>Klicken Sie für jedes Mitglied, für das Sie die Vereinbarung freigeben möchten, auf <b>[!UICONTROL Element hinzufügen]</b> und geben Sie die E-Mail-Adresse des Mitglieds sowie eine Nachricht an dieses Mitglied ein.</p> </li> 
    </ul> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie einen Pfad relativ zu ein <code>https://api.[region].adobesign.com/api/rest/v6/</code></p> <p>Hinweis: Die Liste der verfügbaren Endpunkte finden Sie im Abschnitt [!DNL Adobe Sign] API-Referenz.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Externe ID]</td> 
   <td>Geben Sie die externe ID ein oder ordnen Sie sie zu (eine ID, die außerhalb von [!DNL Adobe Acrobat Sign]) für die Vereinbarungen, die Sie zurückgeben möchten.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie eine kommagetrennte Liste der URLs der übergeordneten Domäne ein oder ordnen Sie sie zu, in denen die zurückgegebenen URLs gespeichert werden können. Wenn leer gelassen, wird die [!DNL Adobe Acrobat Sign] Seiten sind im iframe nicht sichtbar.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Geben Sie die Kennung des Datensatzes ein, den Sie abrufen möchten, oder ordnen Sie sie zu.</td> 
  </tr> 
 </tbody> 
</table>
...
>* Einige Updates stellen erforderliche Felder bereit. Achten Sie bei der Konfiguration der Aktualisierung darauf, alle erforderlichen Felder auszufüllen. Erforderliche Felder sind fett gedruckt in [!DNL Workfront Fusion] Module.
>
  ...
  <tr> 
   ...
   <td> <p>Geben Sie Informationen in bestimmte Felder basierend auf dem Datensatztyp und den zugehörigen Feldern ein.</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Bibliotheksdokument]</b> </p> <p>Wählen Sie die zu aktualisierenden Felder aus und füllen Sie dann die ausgewählten Felder aus:</p> 
      <ul> 
...
+++ **[!UICONTROL Zugehörige Datensätze aktualisieren]**
      ...
      <ul> 
       <li> <p><b>[!UICONTROL Group info list]</b> </p> <p>Füllen Sie die folgenden Felder aus</p> 
        <ul> 
         ...
         <li> <p><b>[!UICONTROL Is group admin]</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um diesen Benutzer zu einem Gruppenadministrator zu machen.</p> </li> 
         <li> <p><b>Ist primäre Gruppe</b> </p> <p>Auswählen <b>[!UICONTROL Ja]</b> , um diese Gruppe auf die primäre Gruppe des Benutzers zu aktualisieren.</p> </li> 
         <li> <p><b>[!UICONTROL Erstellungsdatum]</b> </p> <p>Geben Sie das Datum ein, an dem die Gruppe erstellt wurde.</p> <p>Eine Liste der unterstützten Datums- und Uhrzeitformate finden Sie unter <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref" data-mc-variable-override="">Typerzwingung in [!UICONTROL Adobe Workfront Fusion]</a>.</p> </li> 
         <li> <p><b>[!UICONTROL Name]</b> </p> <p>Geben Sie den Namen der Gruppe ein oder ordnen Sie ihn zu.</p> </li> 
         <li> <p><b>[!UICONTROL Dokumenterstellung sichtbar]</b> </p> <p>Diese Einstellungen bestimmen, ob der Benutzer Bibliotheksdokumente erstellen kann</p> 
          <ul> 
           <li> <p>[!UICONTROL Wert]</p> <p>Zulassen</p> </li> 
           <li> <p>[!UICONTROL Vererbt]</p> <p>Gruppeneinstellung übernehmen aus Gruppe oder Konto</p> </li> 
          </ul> </li> 
         <li> <p><b>[!UICONTROL Auf Workflows beschränktes Senden]</b> </p> <p>Diese Einstellungen bestimmen, ob der Benutzer Vereinbarungen nur mithilfe von Workflows erstellen kann.</p> 
          <ul> 
           <li> <p>[!UICONTROL Wert]</p> <p>Zulassen</p> </li> 
           <li> <p>[!UICONTROL Vererbt]</p> <p>Gruppeneinstellung übernehmen aus Gruppe oder Konto</p> </li> 
          </ul> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Geben Sie den MIME-Typ der Originaldatei ein. MIME-Typen (Multizweck Internet Mail Extension) sind Bezeichnungen, mit denen Software verschiedene Arten von im Internet freigegebenen Daten identifizieren kann. Webserver und Browser verwenden den MIME-Typ, um zu bestimmen, was mit einer Datei gemacht werden soll. Beispiel: eine Datei mit dem MIME-Typ <code>text/html</code> wird in einem Browser anders verarbeitet als in einer Datei mit dem MIME-Typ. <code>image/jpeg</code>.</td> 
  </tr> 
 </tbody> 
</table>

**Beispiel:** In diesem Workflow wird das zu signierende Dokument (zuvor aus Workfront heruntergeladen) als Übergangsdokument hochgeladen.

![](assets/sign-example-1-350x308.png)

Die [!UICONTROL Dokument hochladen] -Modul gibt dem Dokument ein [!DNL Adobe Acrobat Sign] ID, die in späteren Modulen referenziert werden kann. Bei der Erstellung der Vereinbarung wird die ID des hochgeladenen Dokuments in der [!UICONTROL Zu sendende Dateien] -Feld.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Suchen Sie in den Vertragsmetadaten nach Text. </p> 
    <ul> 
     <li> <p><b>[!UICONTROL Text suchen]</b> </p> <p>Geben Sie Text ein, den Sie in den Vertragsmetadaten finden möchten. Jedes Wort wird als separates Textelement behandelt. </p> </li> 
     <li> <p><b>[!UICONTROL Text in suchen]</b> </p> <p>Wählen Sie die Metadatenfelder aus, in denen Sie Text finden möchten. Wenn Sie nichts auswählen, durchsucht das Modul alle Metadaten.</p> </li> 
    </ul> <p>Das Modul gibt eine Vereinbarung zurück, die den eingegebenen Text in einem der ausgewählten Felder enthält. Beispiel: Wenn Sie "Frühjahrskampagne"eingeben und die Optionen Titel und Hinweis auswählen, werden alle Vereinbarungen mit den Wörtern "Frühling"oder "Kampagne"in Titel oder Hinweis zurückgegeben.</p> <p>Weitere Informationen zum Suchen von Feldern finden Sie unter [!DNL Adobe Acrobat Sign], siehe "Funktionsweise der Textsuche"in <a href="https://helpx.adobe.com/sign/using/adobesign-search-users-agreements.html#HowSearchWorks">[!DNL Adobe Sign] Suche - Funktionsweise</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Erstellungsdatum]</td> 
   <td>Datum auswählen. Das Modul gibt nur Datensätze zurück, für die das erstellte Datum diesen Kriterien entspricht.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Ablaufdatum]</td> 
   <td>Datum auswählen. Das Modul gibt nur Datensätze zurück, für die das Ablaufdatum diesen Kriterien entspricht.</td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p role="rowheader">[!UICONTROL Änderungsdatum]</p> </td> 
   <td>Datum auswählen. Das Modul gibt nur Datensätze zurück, für die das geänderte Datum diesen Kriterien entspricht.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Externe ID]</td> 
   <td> <p> Externe ID ist eine vom Absender zugewiesene ID der Vereinbarung, die in beliebiger Form, in der Regel aber in Form von "&lt;groupid&gt;:&lt;id&gt;".</p> <p>Klicken Sie für jede externe ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Hinzufügen]</b> und geben Sie die externe ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Gruppen-ID]</td> 
