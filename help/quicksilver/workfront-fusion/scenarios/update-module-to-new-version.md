...
title: Aktualisieren eines Moduls auf eine neue Version in einem [!DNL Adobe Workfront Fusion] szenario
...
# Aktualisieren eines Moduls auf eine neue Version in einem [!DNL Adobe Workfront Fusion]-Szenario
...
1. Klicken Sie auf das Symbol **Aktualisierungsmodul** ![Aktualisierungssymbol](assets/upgrade-icon.png) des Moduls, das Sie auf eine neue Version aktualisieren möchten.
1. Klicken Sie auf **Neue Module anzeigen**.
