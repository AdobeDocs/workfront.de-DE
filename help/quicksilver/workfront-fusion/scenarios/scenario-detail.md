...
title: Szenario-Details in [!DNL Adobe Workfront Fusion]
...
# Szenario-Details in [!DNL Adobe Workfront Fusion]
...
>
>* [Szenariodetails - Übersicht](https://experienceleague.adobe.com/docs/workfront-fusion/using/get-started-with-fusion/navigate-workfront-fusion/scenario-details.html)
>
...
Darüber hinaus erhalten Sie Zugriff auf den [Szenario-Editor in [!DNL Adobe Workfront Fusion]](../../workfront-fusion/scenarios/scenario-editor.md), in dem Sie das Szenario bearbeiten können.
...
<table style="table-layout:auto">  
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[!UICONTROL [!DNL Workfront Fusion] für Arbeitsautomatisierung und -integration] </p><p>[!UICONTROL [!DNL Workfront Fusion] für Arbeitsautomatisierung] </p><p>[!UICONTROL [!DNL Workfront Fusion] für Arbeitsautomatisierung]</p>   </td> 
  </tr> 
  <tr> 
...
1. Auf der angezeigten Seite können Sie die in der folgenden Tabelle aufgelisteten Elemente überprüfen.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL Berichte] (Registerkarte) </td> 
     ...
     <tr> 
      ...
      <td> <p>Öffnen Sie diese Registerkarte, um einen Verlauf des Szenarios anzuzeigen, einschließlich der Bearbeitung des Szenarios. </p> <p>Die Registerkarte [!UICONTROL History] enthält auch den Ausführungsverlauf des Szenarios für jede Ausführung, der Folgendes umfasst:</p> 
       <ul> 
     ...
     <tr> 
      ...
      <td>Klicken Sie auf diese Schaltfläche in der oberen rechten Ecke, um den Szenario-Editor zu öffnen, in dem Sie an Ihrem Szenario arbeiten können.</td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td>In diesem Diagramm können Sie die während der Ausführung des Szenarios verwendete Datenübertragungsmenge und -vorgänge in einem [!UICONTROL LINE]-Diagramm anzeigen.</td> 
     </tr> 
     <tr> 
