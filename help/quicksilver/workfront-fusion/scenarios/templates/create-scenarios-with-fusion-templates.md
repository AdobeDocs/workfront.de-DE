...
title: Erstellen von Szenarien mit [!DNL Adobe Workfront Fusion] Vorlagen
...
# Erstellen von Szenarien mit [!DNL Adobe Workfront Fusion] Vorlagen

[!DNL Adobe Workfront Fusion] Vorlagen ermöglichen es Ihnen, vorhandene Vorlagen zu erstellen und als Ausgangspunkt für Ihre [!DNL Workfront Fusion] zu verwenden.
...
1. Klicken Sie auf **[!UICONTROL Symbol]** Vorlagen![](assets/fusion-template-icon.png) im linken Navigationsbereich.
1. Klicken Sie auf die Registerkarte, die die gewünschte Vorlage enthält (**[!UICONTROL Öffentliche Vorlagen]** oder **[!UICONTROL Teamvorlagen]**).
1. Klicken Sie auf die Vorlage, die Sie verwenden möchten, um mit der Erstellung eines Szenarios zu beginnen. Sie können die Suchfunktion verwenden, um die Vorlage anhand ihres Namens oder des Namens der darin enthaltenen App zu finden.
...
1. Wenn Sie alle für die Vorlage erforderlichen Einstellungen konfiguriert haben, erhalten Sie eine Benachrichtigung, dass Ihre Vorlage startbereit ist, und die Optionen für das Standardszenario werden am unteren Bildschirmrand angezeigt. Sie können jetzt mit dem Erstellen Ihres Szenarios fortfahren.
   ...
   Informationen zum Erstellen eines Szenarios finden Sie unter [Erstellen eines Szenarios in [!DNL Adobe Workfront Fusion]](../../../workfront-fusion/scenarios/create-a-scenario.md).

1. Klicken Sie auf das **[!UICONTROL Speichern]**-Symbol ![](assets/save-icon.png), um Ihr Szenario zu speichern. Das Szenario wird im Szenario-Bereich von Workfront Fusion gespeichert.
